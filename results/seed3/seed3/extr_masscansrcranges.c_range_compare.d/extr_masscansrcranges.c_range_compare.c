...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_lhs0 = 1;
          const void * lhs = (const void *) malloc(_len_lhs0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_lhs0; _i0++) {
            lhs[_i0] = 0;
          }
          int _len_rhs0 = 1;
          const void * rhs = (const void *) malloc(_len_rhs0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_rhs0; _i0++) {
            rhs[_i0] = 0;
          }
          int benchRet = range_compare(lhs,rhs);
          printf("%d\n", benchRet); 
          free(lhs);
          free(rhs);
