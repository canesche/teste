...
/* Type definitions */
struct pxa2xx_spi_master {int dummy; } ;
struct platform_device {int dummy; } ;

/* Variables and functions */

__attribute__((used)) static inline struct pxa2xx_spi_master *
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct pxa2xx_spi_master * benchRet = pxa2xx_spi_init_pdata(pdev);
          printf("%d\n", (*benchRet).dummy);
          free(pdev);
