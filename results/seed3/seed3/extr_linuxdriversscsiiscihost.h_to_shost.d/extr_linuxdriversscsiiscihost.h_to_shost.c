...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ihost0; _i0++) {
              int _len_ihost__i0__sas_ha_core_shost0 = 1;
          ihost[_i0].sas_ha.core.shost = (struct Scsi_Host *) malloc(_len_ihost__i0__sas_ha_core_shost0*sizeof(struct Scsi_Host));
          for(int _j0 = 0; _j0 < _len_ihost__i0__sas_ha_core_shost0; _j0++) {
            ihost[_i0].sas_ha.core.shost->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct Scsi_Host * benchRet = to_shost(ihost);
          printf("%d\n", (*benchRet).dummy);
          free(ihost);
