...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          e[_i0].rand_meth = (const int *) malloc(_len_e__i0__rand_meth0*sizeof(const int));
          for(int _j0 = 0; _j0 < _len_e__i0__rand_meth0; _j0++) {
            e[_i0].rand_meth[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_rand_meth0 = 1;
          const int * rand_meth = (const int *) malloc(_len_rand_meth0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_rand_meth0; _i0++) {
            rand_meth[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ENGINE_set_RAND(e,rand_meth);
          printf("%d\n", benchRet); 
