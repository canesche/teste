...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_httpc0 = 1;
          struct TYPE_13__ * httpc = (struct TYPE_13__ *) malloc(_len_httpc0*sizeof(struct TYPE_13__));
          ...
          httpc[_i0].common.QOS->qos->u.HttpCredentials = (struct TYPE_8__ *) malloc(_len_httpc__i0__common_QOS_qos_u_HttpCredentials0*sizeof(struct TYPE_8__));
          for(int _j0 = 0; _j0 < _len_httpc__i0__common_QOS_qos_u_HttpCredentials0; _j0++) {
            httpc[_i0].common.QOS->qos->u.HttpCredentials->Flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          int benchRet = is_secure(httpc);
          printf("%d\n", benchRet); 
          free(httpc);
