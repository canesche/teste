...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cur0; _i0++) {
            cur[_i0].nd_opt_type = ((-2 * (next_i()%2)) + 1) * next_i();
        cur[_i0].nd_opt_len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_end0 = 1;
          struct nd_opt_hdr * end = (struct nd_opt_hdr *) malloc(_len_end0*sizeof(struct nd_opt_hdr));
          for(int _i0 = 0; _i0 < _len_end0; _i0++) {
            end[_i0].nd_opt_type = ((-2 * (next_i()%2)) + 1) * next_i();
        end[_i0].nd_opt_len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct nd_opt_hdr * benchRet = ndisc_next_option(cur,end);
          printf("%d\n", (*benchRet).nd_opt_type);
          printf("%d\n", (*benchRet).nd_opt_len);
          free(cur);
          free(end);
