...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dispc[_i0].feat->supported_color_modes = (const int **) malloc(_len_dispc__i0__feat_supported_color_modes0*sizeof(const int *));
          for(int _j0 = 0; _j0 < _len_dispc__i0__feat_supported_color_modes0; _j0++) {
            int _len_dispc__i0__feat_supported_color_modes1 = 1;
            dispc[_i0].feat->supported_color_modes[_j0] = (const int *) malloc(_len_dispc__i0__feat_supported_color_modes1*sizeof(const int));
          ...
          const int * benchRet = dispc_ovl_get_color_modes(dispc,plane);
          printf("%d\n", (*benchRet)); 
