...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          const int pitch = 100;
          int _len_t80 = 1;
          const float * t8 = (const float *) malloc(_len_t80*sizeof(const float));
          for(int _i0 = 0; _i0 < _len_t80; _i0++) {
            t8[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          int _len_p0 = 1;
