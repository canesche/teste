...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_U0; _i0++) {
            U[_i0].N = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_U__i0__root0 = 1;
          U[_i0].root = (struct TYPE_4__ *) malloc(_len_U__i0__root0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_U__i0__root0; _j0++) {
            U[_i0].root->delta = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = listree_get_size(U);
          printf("%d\n", benchRet); 
