...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        efx[_i0].tx_channel_offset = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          efx[_i0].channel = (struct efx_channel **) malloc(_len_efx__i0__channel0*sizeof(struct efx_channel *));
          for(int _j0 = 0; _j0 < _len_efx__i0__channel0; _j0++) {
            int _len_efx__i0__channel1 = 1;
            efx[_i0].channel[_j0] = (struct efx_channel *) malloc(_len_efx__i0__channel1*sizeof(struct efx_channel));
