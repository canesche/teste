...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_hwfn__i0__qm_info_qm_vport_params0 = 1;
          p_hwfn[_i0].qm_info.qm_vport_params = (struct TYPE_3__ *) malloc(_len_p_hwfn__i0__qm_info_qm_vport_params0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_p_hwfn__i0__qm_info_qm_vport_params0; _j0++) {
            p_hwfn[_i0].qm_info.qm_vport_params->vport_wfq = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
