...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_host0; _i0++) {
            host[_i0].index = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_host__i0__scb_virt0 = 1;
          host[_i0].scb_virt = (struct orc_scb *) malloc(_len_host__i0__scb_virt0*sizeof(struct orc_scb));
          for(int _j0 = 0; _j0 < _len_host__i0__scb_virt0; _j0++) {
            host[_i0].scb_virt->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct orc_scb * benchRet = __orc_alloc_scb(host);
          printf("%d\n", (*benchRet).dummy);
