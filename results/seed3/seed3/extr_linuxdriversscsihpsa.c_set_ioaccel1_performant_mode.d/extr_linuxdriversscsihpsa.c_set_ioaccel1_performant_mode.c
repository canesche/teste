...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_h0; _i0++) {
              int _len_h__i0__ioaccel1_blockFetchTable0 = 1;
          h[_i0].ioaccel1_blockFetchTable = (int *) malloc(_len_h__i0__ioaccel1_blockFetchTable0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_h__i0__ioaccel1_blockFetchTable0; _j0++) {
            h[_i0].ioaccel1_blockFetchTable[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_h__i0__ioaccel_cmd_pool0 = 1;
          h[_i0].ioaccel_cmd_pool = (struct io_accel1_cmd *) malloc(_len_h__i0__ioaccel_cmd_pool0*sizeof(struct io_accel1_cmd));
          for(int _j0 = 0; _j0 < _len_h__i0__ioaccel_cmd_pool0; _j0++) {
            h[_i0].ioaccel_cmd_pool->ReplyQueue = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_c0 = 1;
        ...
        c[_i0].Header.SGList = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          set_ioaccel1_performant_mode(h,c,reply_queue);
          for(int _aux = 0; _aux < _len_h0; _aux++) {
          free(h[_aux].ioaccel1_blockFetchTable);
          }
          for(int _aux = 0; _aux < _len_h0; _aux++) {
          free(h[_aux].ioaccel_cmd_pool);
          }
          free(h);
          free(c);
