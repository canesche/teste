...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_io0; _i0++) {
              int _len_io__i0__substream0 = 1;
          io[_i0].substream = (struct snd_pcm_substream *) malloc(_len_io__i0__substream0*sizeof(struct snd_pcm_substream));
          for(int _j0 = 0; _j0 < _len_io__i0__substream0; _j0++) {
            io[_i0].substream->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
