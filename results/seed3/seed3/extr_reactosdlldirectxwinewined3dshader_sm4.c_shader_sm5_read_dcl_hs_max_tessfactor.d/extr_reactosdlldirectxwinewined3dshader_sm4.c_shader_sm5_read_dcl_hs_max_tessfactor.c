...
__attribute__((used)) static void shader_sm5_read_dcl_hs_max_tessfactor(struct wined3d_shader_instruction *ins,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ins0; _i0++) {
            ins[_i0].declaration.max_tessellation_factor = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          int _len_tokens0 = 1;
          ...
          shader_sm5_read_dcl_hs_max_tessfactor(ins,opcode,opcode_token,tokens,token_count,priv);
          free(ins);
          free(tokens);
          free(priv);
