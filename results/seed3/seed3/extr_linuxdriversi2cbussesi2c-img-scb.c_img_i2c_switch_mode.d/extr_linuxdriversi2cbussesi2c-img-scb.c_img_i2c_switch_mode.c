...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum img_i2c_mode mode = 0;
          int _len_i2c0 = 1;
          struct img_i2c * i2c = (struct img_i2c *) malloc(_len_i2c0*sizeof(struct img_i2c));
          for(int _i0 = 0; _i0 < _len_i2c0; _i0++) {
            i2c[_i0].mode = ((-2 * (next_i()%2)) + 1) * next_i();
        i2c[_i0].line_status = ((-2 * (next_i()%2)) + 1) * next_i();
        i2c[_i0].int_enable = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          img_i2c_switch_mode(i2c,mode);
          free(i2c);
