...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sb0; _i0++) {
              int _len_sb__i0__s_id0 = 1;
          sb[_i0].s_id = (const char *) malloc(_len_sb__i0__s_id0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_sb__i0__s_id0; _j0++) {
            sb[_i0].s_id[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = hfs_mdb_name(sb);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
