...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_devname0 = 1;
          char * devname = (char *) malloc(_len_devname0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_devname0; _i0++) {
            devname[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_name0 = 1;
          ...
          int benchRet = sanity_check(info,devname,name);
          printf("%d\n", benchRet); 
          free(info);
          free(devname);
          free(name);
