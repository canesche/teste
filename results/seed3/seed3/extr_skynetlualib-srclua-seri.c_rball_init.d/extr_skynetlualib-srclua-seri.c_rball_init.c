...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rb0; _i0++) {
              int _len_rb__i0__buffer0 = 1;
          rb[_i0].buffer = (char *) malloc(_len_rb__i0__buffer0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_rb__i0__buffer0; _j0++) {
            rb[_i0].buffer[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
