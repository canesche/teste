...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_surface0; _i0++) {
            surface[_i0].numSTArrays = ((-2 * (next_i()%2)) + 1) * next_i();
        surface[_i0].numVertexes = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_surface__i0__st0 = 1;
          surface[_i0].st = (int ***) malloc(_len_surface__i0__st0*sizeof(int **));
          for(int _j0 = 0; _j0 < _len_surface__i0__st0; _j0++) {
            int _len_surface__i0__st1 = 1;
            surface[_i0].st[_j0] = (int **) malloc(_len_surface__i0__st1*sizeof(int *));
            for(int _j1 = 0; _j1 < _len_surface__i0__st1; _j1++) {
              int _len_surface__i0__st2 = 1;
              surface[_i0].st[_j0][_j1] = (int *) malloc(_len_surface__i0__st2*sizeof(int));
          ...
          int * benchRet = PicoGetSurfaceST(surface,array,num);
          printf("%d\n", (*benchRet)); 
