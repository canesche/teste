...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int hr = 100;
          int _len_handler0 = 1;
          struct saxdeclhandler * handler = (struct saxdeclhandler *) malloc(_len_handler0*sizeof(struct saxdeclhandler));
          for(int _i0 = 0; _i0 < _len_handler0; _i0++) {
            handler[_i0].ref = ((-2 * (next_i()%2)) + 1) * next_i();
        handler[_i0].qi_hr = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_handler__i0__ISAXDeclHandler_iface_lpVtbl0 = 1;
          handler[_i0].ISAXDeclHandler_iface.lpVtbl = (int *) malloc(_len_handler__i0__ISAXDeclHandler_iface_lpVtbl0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_handler__i0__ISAXDeclHandler_iface_lpVtbl0; _j0++) {
            handler[_i0].ISAXDeclHandler_iface.lpVtbl[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          init_saxdeclhandler(handler,hr);
          free(handler);
