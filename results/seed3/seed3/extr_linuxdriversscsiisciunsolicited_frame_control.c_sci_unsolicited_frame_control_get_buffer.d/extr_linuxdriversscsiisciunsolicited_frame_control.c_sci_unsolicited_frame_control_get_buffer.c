...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          uf_control[_i0].buffers.array = (struct TYPE_3__ *) malloc(_len_uf_control__i0__buffers_array0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_uf_control__i0__buffers_array0; _j0++) {
              }
          }
          int _len_frame_buffer0 = 1;
          void ** frame_buffer = (void **) malloc(_len_frame_buffer0*sizeof(void *));
          for(int _i0 = 0; _i0 < _len_frame_buffer0; _i0++) {
          }
          enum sci_status benchRet = sci_unsolicited_frame_control_get_buffer(uf_control,frame_index,frame_buffer);
          free(uf_control);
          for(int i1 = 0; i1 < _len_frame_buffer0; i1++) {
            int _len_frame_buffer1 = 1;
              }
          free(frame_buffer);
