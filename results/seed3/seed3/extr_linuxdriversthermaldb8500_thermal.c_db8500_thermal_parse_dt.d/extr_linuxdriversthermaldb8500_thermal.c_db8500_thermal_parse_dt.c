...
struct db8500_thsens_platform_data {int dummy; } ;

/* Variables and functions */

__attribute__((used)) static inline struct db8500_thsens_platform_data*
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct db8500_thsens_platform_data * benchRet = db8500_thermal_parse_dt(pdev);
          printf("%d\n", (*benchRet).dummy);
          free(pdev);
