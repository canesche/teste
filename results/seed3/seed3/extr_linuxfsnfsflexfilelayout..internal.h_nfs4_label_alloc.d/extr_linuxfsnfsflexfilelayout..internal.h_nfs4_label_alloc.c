...
__attribute__((used)) static inline struct nfs4_label *nfs4_label_alloc(struct nfs_server *server, gfp_t flags) { return NULL; }
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct nfs4_label * benchRet = nfs4_label_alloc(server,flags);
          printf("%d\n", (*benchRet).dummy);
          free(server);
