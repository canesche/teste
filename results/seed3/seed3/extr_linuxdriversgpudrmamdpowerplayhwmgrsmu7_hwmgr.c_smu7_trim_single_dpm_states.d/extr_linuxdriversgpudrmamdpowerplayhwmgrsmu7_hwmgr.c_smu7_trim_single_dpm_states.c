...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hwmgr0; _i0++) {
            hwmgr[_i0].od_enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dpm_table0 = 1;
          struct smu7_single_dpm_table * dpm_table = (struct smu7_single_dpm_table *) malloc(_len_dpm_table0*sizeof(struct smu7_single_dpm_table));
        ...
        dpm_table[_i0].dpm_levels->enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = smu7_trim_single_dpm_states(hwmgr,dpm_table,low_limit,high_limit);
          printf("%d\n", benchRet); 
          free(hwmgr);
