...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_conf0; _i0++) {
              int _len_conf__i0__data0 = 1;
          conf[_i0].data = (int *) malloc(_len_conf__i0__data0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_conf__i0__data0; _j0++) {
            conf[_i0].data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_conf__i0__meth0 = 1;
          conf[_i0].meth = (int *) malloc(_len_conf__i0__meth0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_conf__i0__meth0; _j0++) {
            conf[_i0].meth[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = def_init_default(conf);
          printf("%d\n", benchRet); 
