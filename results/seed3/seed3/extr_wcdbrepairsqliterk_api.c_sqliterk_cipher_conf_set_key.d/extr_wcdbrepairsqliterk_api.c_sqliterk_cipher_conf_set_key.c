...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_conf0; _i0++) {
            conf[_i0].key_len = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_conf__i0__key0 = 1;
          conf[_i0].key = (const void *) malloc(_len_conf__i0__key0*sizeof(const void));
          for(int _j0 = 0; _j0 < _len_conf__i0__key0; _j0++) {
            conf[_i0].key[_j0] = 0;
          }
          }
          int _len_key0 = 1;
          ...
          sqliterk_cipher_conf_set_key(conf,key,key_len);
          free(conf);
          free(key);
