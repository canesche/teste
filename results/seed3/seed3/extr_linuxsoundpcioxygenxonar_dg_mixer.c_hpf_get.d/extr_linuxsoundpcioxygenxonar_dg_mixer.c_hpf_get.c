...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ctl[_i0].private_data->model_data = (struct dg *) malloc(_len_ctl__i0__private_data_model_data0*sizeof(struct dg));
          for(int _j0 = 0; _j0 < _len_ctl__i0__private_data_model_data0; _j0++) {
              int _len_ctl__i0__private_data_model_data_cs4245_shadow0 = 1;
          ctl[_i0].private_data->model_data->cs4245_shadow = (int *) malloc(_len_ctl__i0__private_data_model_data_cs4245_shadow0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ctl__i0__private_data_model_data_cs4245_shadow0; _j0++) {
            ctl[_i0].private_data->model_data->cs4245_shadow[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
