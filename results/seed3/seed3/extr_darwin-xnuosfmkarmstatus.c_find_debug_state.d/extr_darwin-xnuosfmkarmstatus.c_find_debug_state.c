...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          thread[_i0].machine.DebugData = (int *) malloc(_len_thread__i0__machine_DebugData0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_thread__i0__machine_DebugData0; _j0++) {
            thread[_i0].machine.DebugData[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = find_debug_state(thread);
          printf("%d\n", (*benchRet)); 
          free(thread);
