...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_ctx__i0__W0 = 1;
          ctx[_i0].W = (long *) malloc(_len_ctx__i0__W0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_ctx__i0__W0; _j0++) {
            ctx[_i0].W[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ctx[_i0].sizeLo = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].sizeHi = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].lenW = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          SHA1_Init(ctx);
