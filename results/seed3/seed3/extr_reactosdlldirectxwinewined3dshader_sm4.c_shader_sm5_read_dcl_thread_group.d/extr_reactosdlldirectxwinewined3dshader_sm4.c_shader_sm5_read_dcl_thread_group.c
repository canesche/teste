...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ins0; _i0++) {
            ins[_i0].declaration.thread_group_size.z = ((-2 * (next_i()%2)) + 1) * next_i();
        ins[_i0].declaration.thread_group_size.y = ((-2 * (next_i()%2)) + 1) * next_i();
        ins[_i0].declaration.thread_group_size.x = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_tokens0 = 1;
          ...
          shader_sm5_read_dcl_thread_group(ins,opcode,opcode_token,tokens,token_count,priv);
          free(ins);
          free(tokens);
          free(priv);
