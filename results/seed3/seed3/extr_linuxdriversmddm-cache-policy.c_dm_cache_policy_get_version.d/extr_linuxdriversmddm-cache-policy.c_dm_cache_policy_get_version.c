...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_p__i0__private0; _j0++) {
              int _len_p__i0__private_version0 = 1;
          p[_i0].private->version = (const unsigned int *) malloc(_len_p__i0__private_version0*sizeof(const unsigned int));
          for(int _j0 = 0; _j0 < _len_p__i0__private_version0; _j0++) {
            p[_i0].private->version[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          const unsigned int * benchRet = dm_cache_policy_get_version(p);
          printf("%u\n", (*benchRet)); 
