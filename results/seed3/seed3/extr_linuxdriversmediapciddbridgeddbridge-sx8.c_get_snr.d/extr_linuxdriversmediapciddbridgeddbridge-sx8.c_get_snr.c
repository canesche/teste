...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].dtv_property_cache.cnr.stat = (struct TYPE_8__ *) malloc(_len_fe__i0__dtv_property_cache_cnr_stat0*sizeof(struct TYPE_8__));
          for(int _j0 = 0; _j0 < _len_fe__i0__dtv_property_cache_cnr_stat0; _j0++) {
            fe[_i0].dtv_property_cache.cnr.stat->svalue = ((-2 * (next_i()%2)) + 1) * next_i();
        fe[_i0].dtv_property_cache.cnr.stat->scale = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv0; _j0++) {
            fe[_i0].demodulator_priv->signal_info.dvbs2_signal_info.signal_to_noise = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = get_snr(fe);
          printf("%d\n", benchRet); 
