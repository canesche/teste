...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_s__i0__priv_data_streams0; _j0++) {
              int _len_s__i0__priv_data_streams_buf0 = 1;
          s[_i0].priv_data->streams->buf = (int *) malloc(_len_s__i0__priv_data_streams_buf0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_s__i0__priv_data_streams_buf0; _j0++) {
            s[_i0].priv_data->streams->buf[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        s[_i0].priv_data->streams->pstart = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].priv_data->streams->psize = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].priv_data->streams->pduration = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].priv_data->streams->pflags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = ogm_packet(s,idx);
          printf("%d\n", benchRet); 
