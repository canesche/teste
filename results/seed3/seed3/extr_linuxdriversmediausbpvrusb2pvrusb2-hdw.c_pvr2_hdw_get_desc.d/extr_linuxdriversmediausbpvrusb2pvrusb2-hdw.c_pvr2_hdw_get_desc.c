...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_hdw__i0__hdw_desc0; _j0++) {
              int _len_hdw__i0__hdw_desc_description0 = 1;
          hdw[_i0].hdw_desc->description = (const char *) malloc(_len_hdw__i0__hdw_desc_description0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_hdw__i0__hdw_desc_description0; _j0++) {
            hdw[_i0].hdw_desc->description[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          const char * benchRet = pvr2_hdw_get_desc(hdw);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
