...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          parser[_i0].start = (const char *) malloc(_len_parser__i0__start0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_parser__i0__start0; _j0++) {
            parser[_i0].start[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_parser__i0__token0 = 1;
          parser[_i0].token = (char *) malloc(_len_parser__i0__token0*sizeof(char));
        ...
        parser[_i0].token_len = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_pos0 = 1;
          const char * pos = (const char *) malloc(_len_pos0*sizeof(const char));
