...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_table0 = 1;
          struct cpufreq_frequency_table * table = (struct cpufreq_frequency_table *) malloc(_len_table0*sizeof(struct cpufreq_frequency_table));
          for(int _i0 = 0; _i0 < _len_table0; _i0++) {
            table[_i0].frequency = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = get_table_count(table);
          printf("%d\n", benchRet); 
          free(table);
