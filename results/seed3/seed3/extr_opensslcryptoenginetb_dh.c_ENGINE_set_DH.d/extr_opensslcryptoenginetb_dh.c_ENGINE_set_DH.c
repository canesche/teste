...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          e[_i0].dh_meth = (const int *) malloc(_len_e__i0__dh_meth0*sizeof(const int));
          for(int _j0 = 0; _j0 < _len_e__i0__dh_meth0; _j0++) {
            e[_i0].dh_meth[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_dh_meth0 = 1;
          const int * dh_meth = (const int *) malloc(_len_dh_meth0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_dh_meth0; _i0++) {
            dh_meth[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ENGINE_set_DH(e,dh_meth);
          printf("%d\n", benchRet); 
