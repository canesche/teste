...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].qp_tbl = (int **) malloc(_len_dev__i0__qp_tbl0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_dev__i0__qp_tbl0; _j0++) {
            int _len_dev__i0__qp_tbl1 = 1;
            dev[_i0].qp_tbl[_j0] = (int *) malloc(_len_dev__i0__qp_tbl1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_dev__i0__qp_tbl1; _j1++) {
              dev[_i0].qp_tbl[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          int _len_qp0 = 1;
