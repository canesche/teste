...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int irq = 100;
          int _len_chip0 = 1;
          struct max8925_chip * chip = (struct max8925_chip *) malloc(_len_chip0*sizeof(struct max8925_chip));
          for(int _i0 = 0; _i0 < _len_chip0; _i0++) {
            chip[_i0].irq_base = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct max8925_irq_data * benchRet = irq_to_max8925(chip,irq);
          printf("%d\n", (*benchRet).dummy);
          free(chip);
