...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_table0 = 1;
          struct kvm_sys_reg_target_table * table = (struct kvm_sys_reg_target_table *) malloc(_len_table0*sizeof(struct kvm_sys_reg_target_table));
          for(int _i0 = 0; _i0 < _len_table0; _i0++) {
            table[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          kvm_register_target_sys_reg_table(target,table);
          free(table);
