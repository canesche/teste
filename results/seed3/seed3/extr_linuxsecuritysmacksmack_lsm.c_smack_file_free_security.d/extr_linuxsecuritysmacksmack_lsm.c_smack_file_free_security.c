...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_file0; _i0++) {
              int _len_file__i0__f_security0 = 1;
          file[_i0].f_security = (int *) malloc(_len_file__i0__f_security0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_file__i0__f_security0; _j0++) {
            file[_i0].f_security[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          smack_file_free_security(file);
          for(int _aux = 0; _aux < _len_file0; _aux++) {
          free(file[_aux].f_security);
          }
          free(file);
