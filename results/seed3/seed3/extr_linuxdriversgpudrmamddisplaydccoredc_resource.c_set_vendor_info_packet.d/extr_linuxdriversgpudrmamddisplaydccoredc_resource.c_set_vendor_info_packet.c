...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int _len_info_packet0 = 1;
          struct dc_info_packet * info_packet = (struct dc_info_packet *) malloc(_len_info_packet0*sizeof(struct dc_info_packet));
          for(int _i0 = 0; _i0 < _len_info_packet0; _i0++) {
            info_packet[_i0].valid = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_info_packet__i0__sb0 = 1;
          info_packet[_i0].sb = (int *) malloc(_len_info_packet__i0__sb0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_info_packet__i0__sb0; _j0++) {
            info_packet[_i0].sb[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        info_packet[_i0].hb1 = ((-2 * (next_i()%2)) + 1) * next_i();
        info_packet[_i0].hb2 = ((-2 * (next_i()%2)) + 1) * next_i();
        info_packet[_i0].hb0 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_stream0 = 1;
        ...
        stream[_i0].timing.hdmi_vic = ((-2 * (next_i()%2)) + 1) * next_i();
        stream[_i0].timing.h_total = ((-2 * (next_i()%2)) + 1) * next_i();
        stream[_i0].timing.v_total = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          set_vendor_info_packet(info_packet,stream);
          for(int _aux = 0; _aux < _len_info_packet0; _aux++) {
          free(info_packet[_aux].sb);
          }
          free(info_packet);
          free(stream);
