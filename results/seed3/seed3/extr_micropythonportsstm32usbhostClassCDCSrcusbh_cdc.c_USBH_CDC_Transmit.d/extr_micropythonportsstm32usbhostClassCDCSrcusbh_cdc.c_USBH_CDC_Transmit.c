...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        phost[_i0].pActiveClass->pData->data_tx_state = ((-2 * (next_i()%2)) + 1) * next_i();
        phost[_i0].pActiveClass->pData->TxDataLength = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_phost__i0__pActiveClass_pData_pTxData0 = 1;
          phost[_i0].pActiveClass->pData->pTxData = (int *) malloc(_len_phost__i0__pActiveClass_pData_pTxData0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData_pTxData0; _j0++) {
            phost[_i0].pActiveClass->pData->pTxData[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          ...
          int benchRet = USBH_CDC_Transmit(phost,pbuff,length);
          printf("%d\n", benchRet); 
