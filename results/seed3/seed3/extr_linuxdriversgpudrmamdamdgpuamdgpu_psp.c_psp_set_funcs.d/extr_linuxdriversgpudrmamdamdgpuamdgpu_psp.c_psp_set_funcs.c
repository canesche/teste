...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_adev0; _i0++) {
              int _len_adev__i0__firmware_funcs0 = 1;
          adev[_i0].firmware.funcs = (int *) malloc(_len_adev__i0__firmware_funcs0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_adev__i0__firmware_funcs0; _j0++) {
            adev[_i0].firmware.funcs[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          psp_set_funcs(adev);
          free(adev);
