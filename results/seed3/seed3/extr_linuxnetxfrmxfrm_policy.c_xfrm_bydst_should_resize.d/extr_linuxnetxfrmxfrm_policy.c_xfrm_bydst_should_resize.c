...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          net[_i0].xfrm.policy_count = (unsigned int *) malloc(_len_net__i0__xfrm_policy_count0*sizeof(unsigned int));
          ...
          for(int _j0 = 0; _j0 < _len_net__i0__xfrm_policy_bydst0; _j0++) {
            net[_i0].xfrm.policy_bydst->hmask = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_total0 = 1;
          int * total = (int *) malloc(_len_total0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_total0; _i0++) {
            total[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = xfrm_bydst_should_resize(net,dir,total);
          printf("%d\n", benchRet); 
          free(net);
          free(total);
