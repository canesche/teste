...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          e[_i0].rsa_meth = (const int *) malloc(_len_e__i0__rsa_meth0*sizeof(const int));
          for(int _j0 = 0; _j0 < _len_e__i0__rsa_meth0; _j0++) {
            e[_i0].rsa_meth[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_rsa_meth0 = 1;
          const int * rsa_meth = (const int *) malloc(_len_rsa_meth0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_rsa_meth0; _i0++) {
            rsa_meth[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ENGINE_set_RSA(e,rsa_meth);
          printf("%d\n", benchRet); 
