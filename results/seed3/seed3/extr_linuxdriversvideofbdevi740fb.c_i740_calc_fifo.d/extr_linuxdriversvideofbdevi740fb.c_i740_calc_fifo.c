...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int bpp = 100;
          int _len_par0 = 1;
          struct i740fb_par * par = (struct i740fb_par *) malloc(_len_par0*sizeof(struct i740fb_par));
          for(int _i0 = 0; _i0 < _len_par0; _i0++) {
            par[_i0].has_sgram = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = i740_calc_fifo(par,freq,bpp);
          printf("%d\n", benchRet); 
          free(par);
