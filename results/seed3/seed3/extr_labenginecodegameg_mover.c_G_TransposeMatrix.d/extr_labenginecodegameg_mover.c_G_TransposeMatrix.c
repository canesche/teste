...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_transpose0 = 3;
          int ** transpose = (int **) malloc(_len_transpose0*sizeof(int *));
          for(int _i0 = 0; _i0 < _len_transpose0; _i0++) {
            int _len_transpose1 = 1;
            transpose[_i0] = (int *) malloc(_len_transpose1*sizeof(int));
            for(int _i1 = 0; _i1 < _len_transpose1; _i1++) {
              transpose[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          ...
          free(matrix);
          for(int i1 = 0; i1 < _len_transpose0; i1++) {
            int _len_transpose1 = 1;
              free(transpose[i1]);
          }
          free(transpose);
