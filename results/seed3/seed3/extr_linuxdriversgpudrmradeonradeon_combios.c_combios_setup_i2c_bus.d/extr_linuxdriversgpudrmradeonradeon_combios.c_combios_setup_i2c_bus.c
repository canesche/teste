...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          void * clk_mask;
          void * data_mask;
          struct radeon_i2c_bus_rec benchRet = combios_setup_i2c_bus(rdev,ddc,clk_mask,data_mask);
          printf("%d\n", benchRet.mask_clk_reg);
          printf("%d\n", benchRet.mask_data_reg);
          printf("%d\n", benchRet.a_clk_reg);
          printf("%d\n", benchRet.a_data_reg);
          printf("%d\n", benchRet.en_clk_reg);
          printf("%d\n", benchRet.en_data_reg);
          printf("%d\n", benchRet.y_clk_reg);
          printf("%d\n", benchRet.y_data_reg);
          printf("%d\n", benchRet.mask_clk_mask);
          printf("%d\n", benchRet.mask_data_mask);
          printf("%d\n", benchRet.a_clk_mask);
          printf("%d\n", benchRet.a_data_mask);
          printf("%d\n", benchRet.en_clk_mask);
          printf("%d\n", benchRet.en_data_mask);
          printf("%d\n", benchRet.y_clk_mask);
          printf("%d\n", benchRet.y_data_mask);
          printf("%d\n", benchRet.hw_capable);
          printf("%d\n", benchRet.mm_i2c);
          printf("%d\n", benchRet.i2c_id);
          printf("%d\n", benchRet.valid);
