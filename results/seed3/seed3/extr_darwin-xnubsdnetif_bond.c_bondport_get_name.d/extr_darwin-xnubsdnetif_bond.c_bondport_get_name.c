...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
              int _len_p__i0__po_name0 = 1;
          p[_i0].po_name = (const char *) malloc(_len_p__i0__po_name0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_p__i0__po_name0; _j0++) {
            p[_i0].po_name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = bondport_get_name(p);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
