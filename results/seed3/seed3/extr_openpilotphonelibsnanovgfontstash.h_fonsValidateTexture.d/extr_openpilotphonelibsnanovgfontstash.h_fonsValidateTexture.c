...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stash0; _i0++) {
              int _len_stash__i0__dirtyRect0 = 1;
          stash[_i0].dirtyRect = (int *) malloc(_len_stash__i0__dirtyRect0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_stash__i0__dirtyRect0; _j0++) {
            stash[_i0].dirtyRect[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        stash[_i0].params.width = ((-2 * (next_i()%2)) + 1) * next_i();
        stash[_i0].params.height = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dirty0 = 1;
          int * dirty = (int *) malloc(_len_dirty0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_dirty0; _i0++) {
            dirty[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = fonsValidateTexture(stash,dirty);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_stash0; _aux++) {
          free(stash[_aux].dirtyRect);
          }
          free(stash);
          free(dirty);
