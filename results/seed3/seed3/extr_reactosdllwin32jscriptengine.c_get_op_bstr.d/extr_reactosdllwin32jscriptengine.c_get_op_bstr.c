...
struct TYPE_8__ {int /*<<< orphan*/  bstr; } ;
typedef  int /*<<< orphan*/  BSTR ;

/* Variables and functions */

__attribute__((used)) static inline BSTR get_op_bstr(script_ctx_t *ctx, int i)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctx__i0__call_ctx_bytecode_instrs_u_arg0; _j0++) {
            ctx[_i0].call_ctx->bytecode->instrs->u.arg->bstr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          }
          int benchRet = get_op_bstr(ctx,i);
          printf("%d\n", benchRet); 
