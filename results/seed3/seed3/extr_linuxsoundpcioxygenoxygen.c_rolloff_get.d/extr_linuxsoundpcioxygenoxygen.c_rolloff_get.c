...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ctl[_i0].private_data->model_data = (struct generic_data *) malloc(_len_ctl__i0__private_data_model_data0*sizeof(struct generic_data));
          for(int _j0 = 0; _j0 < _len_ctl__i0__private_data_model_data0; _j0++) {
              int _len_ctl__i0__private_data_model_data_ak4396_regs0 = 1;
          ctl[_i0].private_data->model_data->ak4396_regs = (int **) malloc(_len_ctl__i0__private_data_model_data_ak4396_regs0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_ctl__i0__private_data_model_data_ak4396_regs0; _j0++) {
            int _len_ctl__i0__private_data_model_data_ak4396_regs1 = 1;
            ctl[_i0].private_data->model_data->ak4396_regs[_j0] = (int *) malloc(_len_ctl__i0__private_data_model_data_ak4396_regs1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_ctl__i0__private_data_model_data_ak4396_regs1; _j1++) {
              ctl[_i0].private_data->model_data->ak4396_regs[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          }
