...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_r__i0__upstream0; _j0++) {
              int _len_r__i0__upstream_headers_in_vary0 = 1;
          r[_i0].upstream->headers_in.vary = (int *) malloc(_len_r__i0__upstream_headers_in_vary0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_r__i0__upstream_headers_in_vary0; _j0++) {
            r[_i0].upstream->headers_in.vary[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_h0 = 1;
          ...
          int benchRet = ngx_http_upstream_process_vary(r,h,offset);
          printf("%d\n", benchRet); 
