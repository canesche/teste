...
__attribute__((used)) static inline struct gpio_desc *mlx90614_probe_wakeup(struct i2c_client *client)
{
	return NULL;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct gpio_desc * benchRet = mlx90614_probe_wakeup(client);
          printf("%d\n", (*benchRet).dummy);
          free(client);
