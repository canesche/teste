...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData0; _j0++) {
              int _len_phost__i0__pActiveClass_pData_info_storinfo0 = 1;
          phost[_i0].pActiveClass->pData->info.storinfo = (int *) malloc(_len_phost__i0__pActiveClass_pData_info_storinfo0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData_info_storinfo0; _j0++) {
            phost[_i0].pActiveClass->pData->info.storinfo[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        phost[_i0].pActiveClass->pData->is_ready = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = USBH_MTP_GetStorageInfo(phost,storage_idx,info);
          printf("%d\n", benchRet); 
