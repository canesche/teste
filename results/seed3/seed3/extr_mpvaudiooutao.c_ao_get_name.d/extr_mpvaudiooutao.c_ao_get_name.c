...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ao__i0__driver0; _j0++) {
              int _len_ao__i0__driver_name0 = 1;
          ao[_i0].driver->name = (const char *) malloc(_len_ao__i0__driver_name0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_ao__i0__driver_name0; _j0++) {
            ao[_i0].driver->name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          const char * benchRet = ao_get_name(ao);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
