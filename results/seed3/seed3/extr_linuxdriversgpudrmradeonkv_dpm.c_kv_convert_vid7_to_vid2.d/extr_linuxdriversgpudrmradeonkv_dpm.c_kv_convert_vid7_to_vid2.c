...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          rdev[_i0].pm.dpm.dyn_state.vddc_dependency_on_sclk.entries = (struct TYPE_9__ *) malloc(_len_rdev__i0__pm_dpm_dyn_state_vddc_dependency_on_sclk_entries0*sizeof(struct TYPE_9__));
        ...
        vid_mapping_table[_i0].entries->vid_2bit = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          unsigned long benchRet = kv_convert_vid7_to_vid2(rdev,vid_mapping_table,vid_7bit);
          printf("%lu\n", benchRet); 
          free(rdev);
