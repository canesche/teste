...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_head0 = 1;
          struct igb_ring_container * head = (struct igb_ring_container *) malloc(_len_head0*sizeof(struct igb_ring_container));
          for(int _i0 = 0; _i0 < _len_head0; _i0++) {
            head[_i0].count = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_head__i0__ring0 = 1;
          head[_i0].ring = (struct igb_ring *) malloc(_len_head__i0__ring0*sizeof(struct igb_ring));
          for(int _j0 = 0; _j0 < _len_head__i0__ring0; _j0++) {
            head[_i0].ring->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          igb_add_ring(ring,head);
          free(ring);
