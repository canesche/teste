...
/* Type definitions */
struct team_port {int /*<<< orphan*/  priority; } ;
struct TYPE_4__ {int /*<<< orphan*/  s32_val; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx[_i0].data.s32_val = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ctx__i0__info0 = 1;
          ctx[_i0].info = (struct TYPE_3__ *) malloc(_len_ctx__i0__info0*sizeof(struct TYPE_3__));
          ...
          for(int _j0 = 0; _j0 < _len_ctx__i0__info_port0; _j0++) {
            ctx[_i0].info->port->priority = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = team_priority_option_get(team,ctx);
          printf("%d\n", benchRet); 
          free(team);
