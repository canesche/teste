...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
              int _len_s__i0__func0 = 1;
          s[_i0].func = (int *) malloc(_len_s__i0__func0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_s__i0__func0; _j0++) {
            s[_i0].func[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_c0 = 1;
          ...
          void * context;
          stbi__start_write_callbacks(s,c,context);
