...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          substream[_i0].runtime->private_data = (struct cs4281_dma *) malloc(_len_substream__i0__runtime_private_data0*sizeof(struct cs4281_dma));
          ...
          int benchRet = snd_cs4281_playback_close(substream);
          printf("%d\n", benchRet); 
