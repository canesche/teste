...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_i0; _i0++) {
              int _len_i__i0__input_name0 = 1;
          i[_i0].input_name = (char *) malloc(_len_i__i0__input_name0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_i__i0__input_name0; _j0++) {
            i[_i0].input_name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        i[_i0].near_text = ((-2 * (next_i()%2)) + 1) * next_i();
        i[_i0].line_number = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          init_loc_info(i);
          for(int _aux = 0; _aux < _len_i0; _aux++) {
          free(i[_aux].input_name);
          }
          free(i);
