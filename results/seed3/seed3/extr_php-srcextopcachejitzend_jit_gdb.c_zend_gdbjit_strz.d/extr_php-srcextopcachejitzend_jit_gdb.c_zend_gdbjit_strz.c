...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx[_i0].startp = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ctx__i0__p0 = 1;
          ctx[_i0].p = (long *) malloc(_len_ctx__i0__p0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_ctx__i0__p0; _j0++) {
            ctx[_i0].p[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_str0 = 1;
          ...
          int benchRet = zend_gdbjit_strz(ctx,str);
          printf("%d\n", benchRet); 
