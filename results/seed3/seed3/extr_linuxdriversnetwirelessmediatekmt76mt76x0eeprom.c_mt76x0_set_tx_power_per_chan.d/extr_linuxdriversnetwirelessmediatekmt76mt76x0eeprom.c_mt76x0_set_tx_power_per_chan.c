...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dev__i0__ee0; _j0++) {
              int _len_dev__i0__ee_tx_pwr_per_chan0 = 1;
          dev[_i0].ee->tx_pwr_per_chan = (int *) malloc(_len_dev__i0__ee_tx_pwr_per_chan0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dev__i0__ee_tx_pwr_per_chan0; _j0++) {
            dev[_i0].ee->tx_pwr_per_chan[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_eeprom0 = 1;
