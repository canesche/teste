...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_info__i0____embedded_blob0 = 1;
          info[_i0]._.embedded.blob = (int *) malloc(_len_info__i0____embedded_blob0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_info__i0____embedded_blob0; _j0++) {
            info[_i0]._.embedded.blob[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = ossl_store_info_get0_EMBEDDED_buffer(info);
          printf("%d\n", (*benchRet)); 
          free(info);
