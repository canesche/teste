...
/* Variables and functions */
 ...
 int RK2928_PULL_OFFSET ; 
 int RK2928_PULL_PINS_PER_REG ; 

__attribute__((used)) static void rk2928_calc_pull_reg_and_bit(struct rockchip_pin_bank *bank,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          rk2928_calc_pull_reg_and_bit(bank,pin_num,regmap,reg,bit);
