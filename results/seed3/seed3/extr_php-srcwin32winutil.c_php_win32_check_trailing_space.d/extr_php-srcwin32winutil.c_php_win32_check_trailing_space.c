...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          const unsigned long path_len = 100;
          int _len_path0 = 1;
          ...
          int benchRet = php_win32_check_trailing_space(path,path_len);
          printf("%d\n", benchRet); 
          free(path);
    ...
    case 1:
    {
          const unsigned long path_len = 255;
    ...
    case 2:
    {
          const unsigned long path_len = 10;
          int _len_path0 = 100;
          const char * path = (const char *) malloc(_len_path0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_path0; _i0++) {
            path[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
