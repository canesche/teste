...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
              int _len_info__i0__merge0 = 1;
          info[_i0].merge = (long *) malloc(_len_info__i0__merge0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_info__i0__merge0; _j0++) {
            info[_i0].merge[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = counter_active(info,type);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_info0; _aux++) {
          free(info[_aux].merge);
          }
          free(info);
