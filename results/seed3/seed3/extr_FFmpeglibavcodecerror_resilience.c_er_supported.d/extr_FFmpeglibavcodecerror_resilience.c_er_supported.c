...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
            s[_i0].cur_pic.field_picture = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].cur_pic.f = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _j0 = 0; _j0 < _len_s__i0__avctx0; _j0++) {
              int _len_s__i0__avctx_hwaccel0 = 1;
          s[_i0].avctx->hwaccel = (struct TYPE_6__ *) malloc(_len_s__i0__avctx_hwaccel0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_s__i0__avctx_hwaccel0; _j0++) {
            s[_i0].avctx->hwaccel->decode_slice = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = er_supported(s);
          printf("%d\n", benchRet); 
