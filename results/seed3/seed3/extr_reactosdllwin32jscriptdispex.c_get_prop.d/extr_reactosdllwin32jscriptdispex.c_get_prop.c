...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_This0; _i0++) {
            This[_i0].prop_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_This__i0__props0 = 1;
          This[_i0].props = (struct TYPE_6__ *) malloc(_len_This__i0__props0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_This__i0__props0; _j0++) {
            This[_i0].props->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct TYPE_6__ * benchRet = get_prop(This,id);
          printf("%ld\n", (*benchRet).type);
          for(int _aux = 0; _aux < _len_This0; _aux++) {
          free(This[_aux].props);
          }
          free(This);
