...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
            self[_i0].dynamic_color_stack_idx = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_self__i0__dynamic_color_stack0 = 1;
          self[_i0].dynamic_color_stack = (int *) malloc(_len_self__i0__dynamic_color_stack0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_self__i0__dynamic_color_stack0; _j0++) {
            self[_i0].dynamic_color_stack[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        self[_i0].overridden = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          colorprofile_pop_dynamic_colors(self);
          for(int _aux = 0; _aux < _len_self0; _aux++) {
          free(self[_aux].dynamic_color_stack);
          }
          free(self);
