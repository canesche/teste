...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        table[_i0].mc_reg_table_entry->mclk_max = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_eg_table0 = 1;
          struct evergreen_mc_reg_table * eg_table = (struct evergreen_mc_reg_table *) malloc(_len_eg_table0*sizeof(struct evergreen_mc_reg_table));
          for(int _i0 = 0; _i0 < _len_eg_table0; _i0++) {
            eg_table[_i0].last = ((-2 * (next_i()%2)) + 1) * next_i();
        eg_table[_i0].num_entries = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_eg_table__i0__mc_reg_table_entry0 = 1;
          eg_table[_i0].mc_reg_table_entry = (struct TYPE_7__ *) malloc(_len_eg_table__i0__mc_reg_table_entry0*sizeof(struct TYPE_7__));
          for(int _j0 = 0; _j0 < _len_eg_table__i0__mc_reg_table_entry0; _j0++) {
              int _len_eg_table__i0__mc_reg_table_entry_mc_data0 = 1;
          eg_table[_i0].mc_reg_table_entry->mc_data = (int *) malloc(_len_eg_table__i0__mc_reg_table_entry_mc_data0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_eg_table__i0__mc_reg_table_entry_mc_data0; _j0++) {
            eg_table[_i0].mc_reg_table_entry->mc_data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        eg_table[_i0].mc_reg_table_entry->mclk_max = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_eg_table__i0__mc_reg_address0 = 1;
          eg_table[_i0].mc_reg_address = (struct TYPE_5__ *) malloc(_len_eg_table__i0__mc_reg_address0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_eg_table__i0__mc_reg_address0; _j0++) {
            eg_table[_i0].mc_reg_address->s1 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = btc_copy_vbios_mc_reg_table(table,eg_table);
          printf("%d\n", benchRet); 
          ...
          free(table);
          for(int _aux = 0; _aux < _len_eg_table0; _aux++) {
          free(eg_table[_aux].mc_reg_table_entry);
          }
          for(int _aux = 0; _aux < _len_eg_table0; _aux++) {
          free(eg_table[_aux].mc_reg_address);
          }
          free(eg_table);
