...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_red0 = 256;
          unsigned char * red = (unsigned char *) malloc(_len_red0*sizeof(unsigned char));
          for(int _i0 = 0; _i0 < _len_red0; _i0++) {
            red[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_green0 = 256;
          unsigned char * green = (unsigned char *) malloc(_len_green0*sizeof(unsigned char));
          for(int _i0 = 0; _i0 < _len_green0; _i0++) {
            green[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_blue0 = 256;
          unsigned char * blue = (unsigned char *) malloc(_len_blue0*sizeof(unsigned char));
