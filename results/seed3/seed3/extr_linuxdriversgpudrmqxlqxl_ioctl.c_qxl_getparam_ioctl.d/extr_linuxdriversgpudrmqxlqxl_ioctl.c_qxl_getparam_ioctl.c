...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].dev_private->rom = (struct TYPE_2__ *) malloc(_len_dev__i0__dev_private_rom0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_dev__i0__dev_private_rom0; _j0++) {
            dev[_i0].dev_private->rom->n_surfaces = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          void * data;
          ...
          int benchRet = qxl_getparam_ioctl(dev,data,file_priv);
          printf("%d\n", benchRet); 
