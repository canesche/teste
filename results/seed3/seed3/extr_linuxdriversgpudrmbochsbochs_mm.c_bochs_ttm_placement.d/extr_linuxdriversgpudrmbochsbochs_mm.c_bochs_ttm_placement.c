...
struct TYPE_4__ {unsigned int num_placement; unsigned int num_busy_placement; TYPE_1__* busy_placement; TYPE_1__* placement; } ;
struct bochs_bo {TYPE_2__ placement; TYPE_1__* placements; } ;
struct TYPE_3__ {int flags; scalar_t__ lpfn; scalar_t__ fpfn; } ;
...
__attribute__((used)) static void bochs_ttm_placement(struct bochs_bo *bo, int domain)
{
	unsigned i;
	u32 c = 0;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        bo[_i0].placement.num_busy_placement = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          bo[_i0].placement.busy_placement = (struct TYPE_3__ *) malloc(_len_bo__i0__placement_busy_placement0*sizeof(struct TYPE_3__));
        ...
        bo[_i0].placement.busy_placement->fpfn = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          bo[_i0].placement.placement = (struct TYPE_3__ *) malloc(_len_bo__i0__placement_placement0*sizeof(struct TYPE_3__));
        ...
        bo[_i0].placement.placement->fpfn = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          bo[_i0].placements = (struct TYPE_3__ *) malloc(_len_bo__i0__placements0*sizeof(struct TYPE_3__));
