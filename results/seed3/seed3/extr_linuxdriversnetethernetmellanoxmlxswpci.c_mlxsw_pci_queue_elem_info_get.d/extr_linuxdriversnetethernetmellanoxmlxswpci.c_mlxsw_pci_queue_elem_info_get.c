...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_q0; _i0++) {
              int _len_q__i0__elem_info0 = 1;
          q[_i0].elem_info = (struct mlxsw_pci_queue_elem_info *) malloc(_len_q__i0__elem_info0*sizeof(struct mlxsw_pci_queue_elem_info));
          for(int _j0 = 0; _j0 < _len_q__i0__elem_info0; _j0++) {
            q[_i0].elem_info->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct mlxsw_pci_queue_elem_info * benchRet = mlxsw_pci_queue_elem_info_get(q,elem_index);
          printf("%d\n", (*benchRet).dummy);
          for(int _aux = 0; _aux < _len_q0; _aux++) {
          free(q[_aux].elem_info);
          }
          free(q);
    ...
    case 3:
    {
          int elem_index = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_q0 = 1;
          struct mlxsw_pci_queue * q = (struct mlxsw_pci_queue *) malloc(_len_q0*sizeof(struct mlxsw_pci_queue));
          for(int _i0 = 0; _i0 < _len_q0; _i0++) {
              int _len_q__i0__elem_info0 = 1;
