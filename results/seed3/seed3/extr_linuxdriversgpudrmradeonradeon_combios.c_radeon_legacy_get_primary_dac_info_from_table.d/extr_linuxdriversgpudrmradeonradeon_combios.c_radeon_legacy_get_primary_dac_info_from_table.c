...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_dac0 = 1;
          struct radeon_encoder_primary_dac * p_dac = (struct radeon_encoder_primary_dac *) malloc(_len_p_dac0*sizeof(struct radeon_encoder_primary_dac));
          for(int _i0 = 0; _i0 < _len_p_dac0; _i0++) {
            p_dac[_i0].ps2_pdac_adj = ((-2 * (next_i()%2)) + 1) * next_i();
          }
