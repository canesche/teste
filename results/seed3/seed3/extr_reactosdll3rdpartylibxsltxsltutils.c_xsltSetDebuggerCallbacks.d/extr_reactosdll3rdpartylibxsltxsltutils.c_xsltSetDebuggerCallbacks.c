...
struct TYPE_4__ {int /*<<< orphan*/  drop; int /*<<< orphan*/  add; int /*<<< orphan*/  handler; } ;
struct TYPE_3__ {int /*<<< orphan*/  drop; int /*<<< orphan*/  add; int /*<<< orphan*/  handler; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int no = 100;
          void * block;
          int benchRet = xsltSetDebuggerCallbacks(no,block);
          printf("%d\n", benchRet); 
