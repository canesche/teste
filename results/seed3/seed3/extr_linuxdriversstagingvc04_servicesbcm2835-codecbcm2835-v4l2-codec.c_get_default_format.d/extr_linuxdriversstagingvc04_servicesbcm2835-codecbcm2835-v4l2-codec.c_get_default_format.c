...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].supported_fmts = (struct TYPE_2__ *) malloc(_len_dev__i0__supported_fmts0*sizeof(struct TYPE_2__));
          ...
          for(int _j0 = 0; _j0 < _len_dev__i0__supported_fmts_list0; _j0++) {
            dev[_i0].supported_fmts->list->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct bcm2835_codec_fmt * benchRet = get_default_format(dev,capture);
          printf("%d\n", (*benchRet).dummy);
