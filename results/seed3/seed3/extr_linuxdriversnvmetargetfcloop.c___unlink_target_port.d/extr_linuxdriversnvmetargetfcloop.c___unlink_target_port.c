...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          nport[_i0].tport = (struct fcloop_tport *) malloc(_len_nport__i0__tport0*sizeof(struct fcloop_tport));
          for(int _j0 = 0; _j0 < _len_nport__i0__tport0; _j0++) {
            nport[_i0].tport->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_nport__i0__rport0 = 1;
          nport[_i0].rport = (struct TYPE_2__ *) malloc(_len_nport__i0__rport0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_nport__i0__rport0; _j0++) {
              int _len_nport__i0__rport_targetport0 = 1;
          nport[_i0].rport->targetport = (int *) malloc(_len_nport__i0__rport_targetport0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_nport__i0__rport_targetport0; _j0++) {
            nport[_i0].rport->targetport[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct fcloop_tport * benchRet = __unlink_target_port(nport);
          printf("%d\n", (*benchRet).dummy);
