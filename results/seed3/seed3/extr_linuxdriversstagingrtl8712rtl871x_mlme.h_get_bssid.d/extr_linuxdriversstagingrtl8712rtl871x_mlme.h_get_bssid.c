...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pmlmepriv0; _i0++) {
              int _len_pmlmepriv__i0__cur_network_network_MacAddress0 = 1;
          pmlmepriv[_i0].cur_network.network.MacAddress = (int *) malloc(_len_pmlmepriv__i0__cur_network_network_MacAddress0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_pmlmepriv__i0__cur_network_network_MacAddress0; _j0++) {
            pmlmepriv[_i0].cur_network.network.MacAddress[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = get_bssid(pmlmepriv);
          printf("%d\n", (*benchRet)); 
          free(pmlmepriv);
