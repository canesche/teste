...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int col = 100;
          int _len_kp0 = 1;
          struct pmic8xxx_kp * kp = (struct pmic8xxx_kp *) malloc(_len_kp0*sizeof(struct pmic8xxx_kp));
          for(int _i0 = 0; _i0 < _len_kp0; _i0++) {
            kp[_i0].num_cols = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = pmic8xxx_col_state(kp,col);
          printf("%d\n", benchRet); 
          free(kp);
