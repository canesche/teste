...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_cdev0; _i0++) {
              int _len_cdev__i0__protocol_ops_fcoe0 = 1;
          cdev[_i0].protocol_ops.fcoe = (struct qed_fcoe_cb_ops *) malloc(_len_cdev__i0__protocol_ops_fcoe0*sizeof(struct qed_fcoe_cb_ops));
          for(int _j0 = 0; _j0 < _len_cdev__i0__protocol_ops_fcoe0; _j0++) {
            cdev[_i0].protocol_ops.fcoe->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_ops0 = 1;
          struct qed_fcoe_cb_ops * ops = (struct qed_fcoe_cb_ops *) malloc(_len_ops0*sizeof(struct qed_fcoe_cb_ops));
          for(int _i0 = 0; _i0 < _len_ops0; _i0++) {
            ops[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * cookie;
          qed_register_fcoe_ops(cdev,ops,cookie);
          free(cdev);
          free(ops);
