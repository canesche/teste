...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_node__i0__sway_workspace0; _j0++) {
              int _len_node__i0__sway_workspace_tiling0 = 1;
          node[_i0].sway_workspace->tiling = (int *) malloc(_len_node__i0__sway_workspace_tiling0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_node__i0__sway_workspace_tiling0; _j0++) {
            node[_i0].sway_workspace->tiling[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          for(int _j0 = 0; _j0 < _len_node__i0__sway_container0; _j0++) {
              int _len_node__i0__sway_container_children0 = 1;
          node[_i0].sway_container->children = (int *) malloc(_len_node__i0__sway_container_children0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_node__i0__sway_container_children0; _j0++) {
            node[_i0].sway_container->children[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int * benchRet = node_get_children(node);
          printf("%d\n", (*benchRet)); 
