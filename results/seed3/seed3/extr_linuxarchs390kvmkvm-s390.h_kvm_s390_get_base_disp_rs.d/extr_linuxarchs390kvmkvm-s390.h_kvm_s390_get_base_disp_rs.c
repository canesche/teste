...
__attribute__((used)) static inline u64 kvm_s390_get_base_disp_rs(struct kvm_vcpu *vcpu, u8 *ar)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vcpu[_i0].arch.sie_block = (struct TYPE_7__ *) malloc(_len_vcpu__i0__arch_sie_block0*sizeof(struct TYPE_7__));
          ...
          int benchRet = kvm_s390_get_base_disp_rs(vcpu,ar);
          printf("%d\n", benchRet); 
