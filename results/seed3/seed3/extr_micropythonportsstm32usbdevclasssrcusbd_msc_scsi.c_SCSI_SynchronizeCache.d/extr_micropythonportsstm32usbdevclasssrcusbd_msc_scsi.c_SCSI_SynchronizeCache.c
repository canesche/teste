...
/* Type definitions */
struct TYPE_6__ {scalar_t__ bot_data_length; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int lun = 100;
          int _len_pdev0 = 1;
          struct TYPE_7__ * pdev = (struct TYPE_7__ *) malloc(_len_pdev0*sizeof(struct TYPE_7__));
          ...
          int benchRet = SCSI_SynchronizeCache(pdev,lun,params);
          printf("%d\n", benchRet); 
          free(pdev);
          free(params);
