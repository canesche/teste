...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pf0 = 1;
          float * pf = (float *) malloc(_len_pf0*sizeof(float));
          for(int _i0 = 0; _i0 < _len_pf0; _i0++) {
            pf[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          byte2word48(t,pitch,pf);
          free(t);
          free(pf);
