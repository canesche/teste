...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tree0; _i0++) {
            tree[_i0].index = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_tree__i0__children0 = 1;
          tree[_i0].children = (long *) malloc(_len_tree__i0__children0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_tree__i0__children0; _j0++) {
            tree[_i0].children[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          color_tree_init(tree);
          for(int _aux = 0; _aux < _len_tree0; _aux++) {
          free(tree[_aux].children);
          }
          free(tree);
