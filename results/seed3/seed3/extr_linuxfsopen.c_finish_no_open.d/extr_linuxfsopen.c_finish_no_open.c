...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_file0; _i0++) {
              int _len_file__i0__f_path_dentry0 = 1;
          file[_i0].f_path.dentry = (struct dentry *) malloc(_len_file__i0__f_path_dentry0*sizeof(struct dentry));
          for(int _j0 = 0; _j0 < _len_file__i0__f_path_dentry0; _j0++) {
            file[_i0].f_path.dentry->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_dentry0 = 1;
          ...
          int benchRet = finish_no_open(file,dentry);
          printf("%d\n", benchRet); 
          free(file);
          free(dentry);
