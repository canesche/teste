...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_SettingName0 = 1;
          char * SettingName = (char *) malloc(_len_SettingName0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_SettingName0; _i0++) {
            SettingName[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int benchRet = IniExtractSettingName(SettingName,SettingNameLine,LineLength);
          printf("%d\n", benchRet); 
          free(SettingName);
