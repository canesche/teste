...
/* Type definitions */
struct snd_soc_dai_link {int no_pcm; int /*<<< orphan*/  be_hw_params_fixup; int /*<<< orphan*/ * ops; } ;
struct snd_soc_card {int num_links; struct snd_soc_dai_link* dai_link; } ;

/* Variables and functions */
 int /*<<< orphan*/  sdm845_be_hw_params_fixup ; 
 int /*<<< orphan*/  sdm845_be_ops ; 

__attribute__((used)) static void sdm845_add_be_ops(struct snd_soc_card *card)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        card[_i0].dai_link->be_hw_params_fixup = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_card__i0__dai_link_ops0 = 1;
          card[_i0].dai_link->ops = (int *) malloc(_len_card__i0__dai_link_ops0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_card__i0__dai_link_ops0; _j0++) {
            card[_i0].dai_link->ops[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
