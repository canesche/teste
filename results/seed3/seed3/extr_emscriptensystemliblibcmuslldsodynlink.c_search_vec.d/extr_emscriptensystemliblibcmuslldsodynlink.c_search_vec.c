...
__attribute__((used)) static int search_vec(size_t *v, size_t *r, size_t key)
{
	for (; v[0]!=key; v+=2)
		if (!v[0]) return 0;
	*r = v[1];
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_r0 = 1;
          unsigned long * r = (unsigned long *) malloc(_len_r0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_r0; _i0++) {
            r[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = search_vec(v,r,key);
          printf("%d\n", benchRet); 
          free(v);
          free(r);
