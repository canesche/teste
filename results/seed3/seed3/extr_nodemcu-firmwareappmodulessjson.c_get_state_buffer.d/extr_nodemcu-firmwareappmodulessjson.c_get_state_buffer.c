...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
            ctx[_i0].min_available = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ctx__i0__buffer0 = 1;
          ctx[_i0].buffer = (const char *) malloc(_len_ctx__i0__buffer0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_ctx__i0__buffer0; _j0++) {
            ctx[_i0].buffer[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_state0 = 1;
          struct jsonsl_state_st * state = (struct jsonsl_state_st *) malloc(_len_state0*sizeof(struct jsonsl_state_st));
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state[_i0].pos_begin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          const char * benchRet = get_state_buffer(ctx,state);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
