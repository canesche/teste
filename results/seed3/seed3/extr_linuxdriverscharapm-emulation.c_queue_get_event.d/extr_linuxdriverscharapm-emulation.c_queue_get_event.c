...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_q__i0__events0 = 1;
          q[_i0].events = (int *) malloc(_len_q__i0__events0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_q__i0__events0; _j0++) {
            q[_i0].events[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = queue_get_event(q);
          printf("%d\n", benchRet); 
