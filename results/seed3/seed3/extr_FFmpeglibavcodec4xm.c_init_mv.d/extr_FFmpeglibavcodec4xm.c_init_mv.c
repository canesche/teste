...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
            f[_i0].version = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_f__i0__mv0 = 1;
          f[_i0].mv = (int *) malloc(_len_f__i0__mv0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_f__i0__mv0; _j0++) {
            f[_i0].mv[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          init_mv(f,linesize);
