...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int MiniportRestartParameters = 100;
          int benchRet = NeoNdisRestart(MiniportAdapterContext,MiniportRestartParameters);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          ...
          int MiniportRestartParameters = 255;
          int benchRet = NeoNdisRestart(MiniportAdapterContext,MiniportRestartParameters);
          printf("%d\n", benchRet); 
    ...
    case 2:
    {
          ...
          int MiniportRestartParameters = 10;
          int benchRet = NeoNdisRestart(MiniportAdapterContext,MiniportRestartParameters);
          printf("%d\n", benchRet); 
