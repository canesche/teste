...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dev__i0__ieee80211_ptr_wiphy0; _j0++) {
            dev[_i0].ieee80211_ptr->wiphy->rts_threshold = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_info0 = 1;
          ...
          int _len_rts0 = 1;
          struct iw_param * rts = (struct iw_param *) malloc(_len_rts0*sizeof(struct iw_param));
          for(int _i0 = 0; _i0 < _len_rts0; _i0++) {
            rts[_i0].disabled = ((-2 * (next_i()%2)) + 1) * next_i();
        rts[_i0].fixed = ((-2 * (next_i()%2)) + 1) * next_i();
        rts[_i0].value = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_extra0 = 1;
          ...
          int benchRet = cfg80211_wext_giwrts(dev,info,rts,extra);
          printf("%d\n", benchRet); 
