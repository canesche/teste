...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fatent0; _i0++) {
              int _len_fatent__i0__u_ent16_p0 = 1;
          fatent[_i0].u.ent16_p = (int *) malloc(_len_fatent__i0__u_ent16_p0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_fatent__i0__u_ent16_p0; _j0++) {
            fatent[_i0].u.ent16_p[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        fatent[_i0].bhs[_j0]->b_size = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = fat16_ent_next(fatent);
          printf("%d\n", benchRet); 
