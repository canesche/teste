...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_m__i0__data_bytes0 = 1;
          m[_i0].data.bytes = (void **) malloc(_len_m__i0__data_bytes0*sizeof(void *));
          for(int _j0 = 0; _j0 < _len_m__i0__data_bytes0; _j0++) {
          }
          }
          void * r;
          void * g;
          void * b;
          vncSetColourMapEntry(m,i,r,g,b);
          free(m);
