...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_d0; _i0++) {
              int _len_d__i0__priv_key0 = 1;
          d[_i0].priv_key = (int *) malloc(_len_d__i0__priv_key0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_d__i0__priv_key0; _j0++) {
            d[_i0].priv_key[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_d__i0__pub_key0 = 1;
          d[_i0].pub_key = (int *) malloc(_len_d__i0__pub_key0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_d__i0__pub_key0; _j0++) {
            d[_i0].pub_key[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_pub_key0 = 1;
          ...
          int benchRet = DSA_set0_key(d,pub_key,priv_key);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_d0; _aux++) {
          free(d[_aux].priv_key);
          }
          for(int _aux = 0; _aux < _len_d0; _aux++) {
          free(d[_aux].pub_key);
          }
