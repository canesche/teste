...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_info__i0____embedded_pem_name0 = 1;
          info[_i0]._.embedded.pem_name = (char *) malloc(_len_info__i0____embedded_pem_name0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_info__i0____embedded_pem_name0; _j0++) {
            info[_i0]._.embedded.pem_name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          char * benchRet = ossl_store_info_get0_EMBEDDED_pem_name(info);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          free(info);
