...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          et[_i0].et_object = (struct ocfs2_xattr_value_buf *) malloc(_len_et__i0__et_object0*sizeof(struct ocfs2_xattr_value_buf));
          for(int _j0 = 0; _j0 < _len_et__i0__et_object0; _j0++) {
              int _len_et__i0__et_object_vb_xv0 = 1;
          et[_i0].et_object->vb_xv = (struct TYPE_2__ *) malloc(_len_et__i0__et_object_vb_xv0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_et__i0__et_object_vb_xv0; _j0++) {
            et[_i0].et_object->vb_xv->xr_list = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          ocfs2_xattr_value_fill_root_el(et);
