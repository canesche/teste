...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctl__i0__private_data_model_data0; _j0++) {
              int _len_ctl__i0__private_data_model_data_wm8785_regs0 = 1;
          ctl[_i0].private_data->model_data->wm8785_regs = (int *) malloc(_len_ctl__i0__private_data_model_data_wm8785_regs0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ctl__i0__private_data_model_data_wm8785_regs0; _j0++) {
            ctl[_i0].private_data->model_data->wm8785_regs[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          ...
          int benchRet = hpf_get(ctl,value);
          printf("%d\n", benchRet); 
