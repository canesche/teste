...
__attribute__((used)) static void shader_sm5_read_dcl_tessellator_partitioning(struct wined3d_shader_instruction *ins,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ins0; _i0++) {
            ins[_i0].declaration.tessellator_partitioning = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_tokens0 = 1;
          ...
          shader_sm5_read_dcl_tessellator_partitioning(ins,opcode,opcode_token,tokens,token_count,priv);
          free(ins);
          free(tokens);
          free(priv);
