...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_args0; _i0++) {
            args[_i0].sa_cache_this = ((-2 * (next_i()%2)) + 1) * next_i();
        args[_i0].sa_privileged = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_args__i0__sa_slot0 = 1;
          args[_i0].sa_slot = (int *) malloc(_len_args__i0__sa_slot0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_args__i0__sa_slot0; _j0++) {
            args[_i0].sa_slot[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_res0 = 1;
          ...
          res[_i0].sr_slot = (int *) malloc(_len_res__i0__sr_slot0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_res__i0__sr_slot0; _j0++) {
            res[_i0].sr_slot[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
