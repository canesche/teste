...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ring[_i0].descbase = (struct b43_dmadesc64 *) malloc(_len_ring__i0__descbase0*sizeof(struct b43_dmadesc64));
          for(int _j0 = 0; _j0 < _len_ring__i0__descbase0; _j0++) {
            ring[_i0].descbase->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ring__i0__meta0 = 1;
          ring[_i0].meta = (struct b43_dmadesc_meta *) malloc(_len_ring__i0__meta0*sizeof(struct b43_dmadesc_meta));
          for(int _j0 = 0; _j0 < _len_ring__i0__meta0; _j0++) {
            ring[_i0].meta->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_meta0 = 1;
          struct b43_dmadesc_meta ** meta = (struct b43_dmadesc_meta **) malloc(_len_meta0*sizeof(struct b43_dmadesc_meta *));
          for(int _i0 = 0; _i0 < _len_meta0; _i0++) {
            int _len_meta1 = 1;
            meta[_i0] = (struct b43_dmadesc_meta *) malloc(_len_meta1*sizeof(struct b43_dmadesc_meta));
            for(int _i1 = 0; _i1 < _len_meta1; _i1++) {
              meta[_i0][_i1].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          struct b43_dmadesc_generic * benchRet = op64_idx2desc(ring,slot,meta);
          printf("%d\n", (*benchRet).dummy);
