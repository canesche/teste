...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct ecryptfs_file_info * file_info = (struct ecryptfs_file_info *) malloc(_len_file_info0*sizeof(struct ecryptfs_file_info));
          for(int _i0 = 0; _i0 < _len_file_info0; _i0++) {
            file_info[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
