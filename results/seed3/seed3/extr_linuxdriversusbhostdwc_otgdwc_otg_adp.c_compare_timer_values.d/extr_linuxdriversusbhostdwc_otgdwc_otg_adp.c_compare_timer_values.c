...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_core_if0; _i0++) {
              int _len_core_if__i0__adp_probe_timer_values0 = 1;
          core_if[_i0].adp.probe_timer_values = (long *) malloc(_len_core_if__i0__adp_probe_timer_values0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_core_if__i0__adp_probe_timer_values0; _j0++) {
            core_if[_i0].adp.probe_timer_values[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = compare_timer_values(core_if);
          printf("%d\n", benchRet); 
          free(core_if);
