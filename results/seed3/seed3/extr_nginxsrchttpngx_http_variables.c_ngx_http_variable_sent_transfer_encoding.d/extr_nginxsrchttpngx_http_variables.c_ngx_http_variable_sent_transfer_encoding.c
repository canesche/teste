...
struct TYPE_5__ {int len; int valid; int not_found; int /*<<< orphan*/ * data; scalar_t__ no_cacheable; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_r0; _i0++) {
            r[_i0].chunked = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_v0 = 1;
        ...
        v[_i0].no_cacheable = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = ngx_http_variable_sent_transfer_encoding(r,v,data);
          printf("%d\n", benchRet); 
          free(r);
