...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_rh0 = 1;
          long long * rh = (long long *) malloc(_len_rh0*sizeof(long long));
          for(int _i0 = 0; _i0 < _len_rh0; _i0++) {
            rh[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_hn0 = 1;
          int * hn = (int *) malloc(_len_hn0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_hn0; _i0++) {
            hn[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
