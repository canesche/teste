...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_cols0 = 7;
          char ** cols = (char **) malloc(_len_cols0*sizeof(char *));
          for(int _i0 = 0; _i0 < _len_cols0; _i0++) {
            int _len_cols1 = 1;
            cols[_i0] = (char *) malloc(_len_cols1*sizeof(char));
            for(int _i1 = 0; _i1 < _len_cols1; _i1++) {
              cols[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int benchRet = parse_line(ptr,cols);
          printf("%d\n", benchRet); 
