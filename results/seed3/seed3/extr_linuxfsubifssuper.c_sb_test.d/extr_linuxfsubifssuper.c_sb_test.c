...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          sb[_i0].s_fs_info = (struct ubifs_info *) malloc(_len_sb__i0__s_fs_info0*sizeof(struct ubifs_info));
          for(int _j0 = 0; _j0 < _len_sb__i0__s_fs_info0; _j0++) {
            sb[_i0].s_fs_info->vi.cdev = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          void * data;
          int benchRet = sb_test(sb,data);
          printf("%d\n", benchRet); 
