...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          filp[_i0].private_data = (struct kvm_device *) malloc(_len_filp__i0__private_data0*sizeof(struct kvm_device));
          ...
          struct kvm_device * benchRet = kvm_device_from_filp(filp);
          printf("%d\n", (*benchRet).dummy);
