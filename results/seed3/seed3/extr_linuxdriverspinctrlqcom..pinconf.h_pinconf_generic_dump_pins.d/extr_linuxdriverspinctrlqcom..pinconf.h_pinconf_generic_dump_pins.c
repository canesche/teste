...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_gname0 = 1;
          const char * gname = (const char *) malloc(_len_gname0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_gname0; _i0++) {
            gname[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          pinconf_generic_dump_pins(pctldev,s,gname,pin);
          free(pctldev);
          free(s);
          free(gname);
