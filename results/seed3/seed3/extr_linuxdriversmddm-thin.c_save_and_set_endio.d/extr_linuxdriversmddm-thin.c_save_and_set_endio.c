...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_save0 = 1;
          int ** save = (int **) malloc(_len_save0*sizeof(int *));
          for(int _i0 = 0; _i0 < _len_save0; _i0++) {
            int _len_save1 = 1;
            save[_i0] = (int *) malloc(_len_save1*sizeof(int));
            for(int _i1 = 0; _i1 < _len_save1; _i1++) {
              save[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int _len_fn0 = 1;
          ...
          save_and_set_endio(bio,save,fn);
          for(int _aux = 0; _aux < _len_bio0; _aux++) {
          free(bio[_aux].bi_end_io);
          }
          free(bio);
          for(int i1 = 0; i1 < _len_save0; i1++) {
            int _len_save1 = 1;
              free(save[i1]);
          }
          free(save);
