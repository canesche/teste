...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_src00 = 1;
          const double * src0 = (const double *) malloc(_len_src00*sizeof(const double));
          ...
          int _len_src10 = 1;
          const double * src1 = (const double *) malloc(_len_src10*sizeof(const double));
          ...
          vector_dmul_c(dst,src0,src1,len);
          free(dst);
          free(src0);
          free(src1);
