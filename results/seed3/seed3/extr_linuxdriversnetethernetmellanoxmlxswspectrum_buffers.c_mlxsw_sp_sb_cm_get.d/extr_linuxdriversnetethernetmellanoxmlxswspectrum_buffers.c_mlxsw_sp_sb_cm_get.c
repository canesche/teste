...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_mlxsw_sp__i0__sb_ports0; _j0++) {
              int _len_mlxsw_sp__i0__sb_ports_cms0 = 1;
          mlxsw_sp[_i0].sb->ports->cms = (struct mlxsw_sp_sb_cm **) malloc(_len_mlxsw_sp__i0__sb_ports_cms0*sizeof(struct mlxsw_sp_sb_cm *));
          for(int _j0 = 0; _j0 < _len_mlxsw_sp__i0__sb_ports_cms0; _j0++) {
            int _len_mlxsw_sp__i0__sb_ports_cms1 = 1;
            mlxsw_sp[_i0].sb->ports->cms[_j0] = (struct mlxsw_sp_sb_cm *) malloc(_len_mlxsw_sp__i0__sb_ports_cms1*sizeof(struct mlxsw_sp_sb_cm));
            for(int _j1 = 0; _j1 < _len_mlxsw_sp__i0__sb_ports_cms1; _j1++) {
              mlxsw_sp[_i0].sb->ports->cms[_j0]->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          }
          }
          struct mlxsw_sp_sb_cm * benchRet = mlxsw_sp_sb_cm_get(mlxsw_sp,local_port,pg_buff,dir);
          printf("%d\n", (*benchRet).dummy);
