...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          struct list_entry * aux_entry[10000];
          struct list_entry * entry = _allocate_entry(10000, aux_entry);
          struct list_entry * aux_prev[10000];
          struct list_entry * prev = _allocate_prev(10000, aux_prev);
          struct list_entry * aux_next[10000];
          struct list_entry * next = _allocate_next(10000, aux_next);
          list_add(entry,prev,next);
