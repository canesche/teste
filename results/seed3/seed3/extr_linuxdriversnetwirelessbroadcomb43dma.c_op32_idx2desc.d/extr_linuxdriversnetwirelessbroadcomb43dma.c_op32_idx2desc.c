...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ring[_i0].descbase = (struct b43_dmadesc32 *) malloc(_len_ring__i0__descbase0*sizeof(struct b43_dmadesc32));
          ...
          struct b43_dmadesc_generic * benchRet = op32_idx2desc(ring,slot,meta);
          printf("%d\n", (*benchRet).dummy);
