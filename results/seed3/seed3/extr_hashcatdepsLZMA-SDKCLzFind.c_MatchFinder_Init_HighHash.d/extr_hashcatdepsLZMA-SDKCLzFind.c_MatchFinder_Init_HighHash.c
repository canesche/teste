...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p[_i0].fixedHashSize = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].hashMask = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_p__i0__hash0 = 1;
          p[_i0].hash = (int *) malloc(_len_p__i0__hash0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__hash0; _j0++) {
            p[_i0].hash[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
