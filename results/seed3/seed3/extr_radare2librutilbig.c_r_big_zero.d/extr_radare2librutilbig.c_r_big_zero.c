...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_n0; _i0++) {
            n[_i0].last = ((-2 * (next_i()%2)) + 1) * next_i();
        n[_i0].sign = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_n__i0__dgts0 = 1;
          n[_i0].dgts = (int *) malloc(_len_n__i0__dgts0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_n__i0__dgts0; _j0++) {
            n[_i0].dgts[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          r_big_zero(n);
