...
__attribute__((used)) static void pseudocolor_filter_10(int max, int width, int height,
                                  const uint8_t *index,
                                  const uint8_t *src,
                                  uint8_t *dst,
                                  ptrdiff_t ilinesize,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          pseudocolor_filter_10(max,width,height,index,src,dst,ilinesize,slinesize,dlinesize,lut);
          free(index);
          free(src);
          free(dst);
          free(lut);
