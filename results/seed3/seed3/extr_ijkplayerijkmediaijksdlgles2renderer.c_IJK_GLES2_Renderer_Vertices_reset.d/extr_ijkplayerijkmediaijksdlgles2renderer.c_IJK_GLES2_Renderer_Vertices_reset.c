...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_renderer0; _i0++) {
              int _len_renderer__i0__vertices0 = 1;
          renderer[_i0].vertices = (float *) malloc(_len_renderer__i0__vertices0*sizeof(float));
          for(int _j0 = 0; _j0 < _len_renderer__i0__vertices0; _j0++) {
            renderer[_i0].vertices[_j0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          }
          IJK_GLES2_Renderer_Vertices_reset(renderer);
          for(int _aux = 0; _aux < _len_renderer0; _aux++) {
          free(renderer[_aux].vertices);
          }
          free(renderer);
