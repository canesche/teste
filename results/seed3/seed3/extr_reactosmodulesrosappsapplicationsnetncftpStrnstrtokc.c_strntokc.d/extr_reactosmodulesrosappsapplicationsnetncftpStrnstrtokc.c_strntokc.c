...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long tokenSize = 100;
          int _len_dstTokenStart0 = 1;
          char * dstTokenStart = (char *) malloc(_len_dstTokenStart0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_dstTokenStart0; _i0++) {
            dstTokenStart[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int benchRet = strntokc(dstTokenStart,tokenSize,parsestr,delims,context);
          printf("%d\n", benchRet); 
          free(dstTokenStart);
          free(parsestr);
          free(delims);
    ...
    case 1:
    {
          unsigned long tokenSize = 255;
          int _len_dstTokenStart0 = 65025;
          char * dstTokenStart = (char *) malloc(_len_dstTokenStart0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_dstTokenStart0; _i0++) {
            dstTokenStart[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
    ...
    case 2:
    {
          unsigned long tokenSize = 10;
          int _len_dstTokenStart0 = 100;
          char * dstTokenStart = (char *) malloc(_len_dstTokenStart0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_dstTokenStart0; _i0++) {
            dstTokenStart[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
