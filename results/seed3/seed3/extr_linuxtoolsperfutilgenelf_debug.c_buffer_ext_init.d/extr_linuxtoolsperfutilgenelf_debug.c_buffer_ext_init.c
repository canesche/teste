...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_be0; _i0++) {
            be[_i0].max_sz = ((-2 * (next_i()%2)) + 1) * next_i();
        be[_i0].cur_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_be__i0__data0 = 1;
          be[_i0].data = (int *) malloc(_len_be__i0__data0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_be__i0__data0; _j0++) {
            be[_i0].data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          buffer_ext_init(be);
