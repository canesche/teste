...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_bdev__i0__rds_info_rds_ps0 = 1;
          bdev[_i0].rds_info.rds_ps = (long *) malloc(_len_bdev__i0__rds_info_rds_ps0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_bdev__i0__rds_info_rds_ps0; _j0++) {
            bdev[_i0].rds_info.rds_ps[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
