...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pcdev0; _i0++) {
              int _len_pcdev__i0__v4l2_dev_dev0 = 1;
          pcdev[_i0].v4l2_dev.dev = (struct device *) malloc(_len_pcdev__i0__v4l2_dev_dev0*sizeof(struct device));
          for(int _j0 = 0; _j0 < _len_pcdev__i0__v4l2_dev_dev0; _j0++) {
            pcdev[_i0].v4l2_dev.dev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct device * benchRet = pcdev_to_dev(pcdev);
          printf("%d\n", (*benchRet).dummy);
          free(pcdev);
