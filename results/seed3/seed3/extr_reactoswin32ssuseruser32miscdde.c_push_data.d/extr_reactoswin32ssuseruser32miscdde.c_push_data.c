...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int size = 100;
          int _len_data0 = 1;
          struct packed_message * data = (struct packed_message *) malloc(_len_data0*sizeof(struct packed_message));
          for(int _i0 = 0; _i0 < _len_data0; _i0++) {
            data[_i0].size = ((-2 * (next_i()%2)) + 1) * next_i();
        data[_i0].count = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_data__i0__data0 = 1;
          data[_i0].data = (const void *) malloc(_len_data__i0__data0*sizeof(const void));
          for(int _j0 = 0; _j0 < _len_data__i0__data0; _j0++) {
            data[_i0].data[_j0] = 0;
          }
          }
          int _len_ptr0 = 1;
