...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pp0; _i0++) {
              int _len_pp__i0__value0 = 1;
          pp[_i0].value = (char *) malloc(_len_pp__i0__value0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_pp__i0__value0; _j0++) {
            pp[_i0].value[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          char * benchRet = take_value(pp);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
