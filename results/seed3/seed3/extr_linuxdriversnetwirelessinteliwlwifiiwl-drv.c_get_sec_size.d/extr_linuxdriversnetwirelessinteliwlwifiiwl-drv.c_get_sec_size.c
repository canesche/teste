...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          pieces[_i0].img = (struct TYPE_4__ *) malloc(_len_pieces__i0__img0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_pieces__i0__img0; _j0++) {
              int _len_pieces__i0__img_sec0 = 1;
          pieces[_i0].img->sec = (struct TYPE_3__ *) malloc(_len_pieces__i0__img_sec0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_pieces__i0__img_sec0; _j0++) {
            pieces[_i0].img->sec->size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          unsigned long benchRet = get_sec_size(pieces,type,sec);
          printf("%lu\n", benchRet); 
