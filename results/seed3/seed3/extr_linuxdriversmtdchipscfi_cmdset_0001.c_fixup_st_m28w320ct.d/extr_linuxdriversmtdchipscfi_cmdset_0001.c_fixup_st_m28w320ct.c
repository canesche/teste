...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_mtd__i0__priv_fldrv_priv_cfiq0; _j0++) {
            mtd[_i0].priv->fldrv_priv->cfiq->BufWriteTimeoutMax = ((-2 * (next_i()%2)) + 1) * next_i();
        mtd[_i0].priv->fldrv_priv->cfiq->BufWriteTimeoutTyp = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          fixup_st_m28w320ct(mtd);
