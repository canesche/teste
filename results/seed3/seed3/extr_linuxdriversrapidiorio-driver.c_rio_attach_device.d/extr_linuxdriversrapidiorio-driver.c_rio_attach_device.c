...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rdev0; _i0++) {
              int _len_rdev__i0__dev_bus0 = 1;
          rdev[_i0].dev.bus = (int *) malloc(_len_rdev__i0__dev_bus0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_rdev__i0__dev_bus0; _j0++) {
            rdev[_i0].dev.bus[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
