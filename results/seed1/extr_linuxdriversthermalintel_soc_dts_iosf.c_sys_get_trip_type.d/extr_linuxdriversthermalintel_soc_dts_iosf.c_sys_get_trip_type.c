...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          tzd[_i0].devdata = (struct intel_soc_dts_sensor_entry *) malloc(_len_tzd__i0__devdata0*sizeof(struct intel_soc_dts_sensor_entry));
          for(int _j0 = 0; _j0 < _len_tzd__i0__devdata0; _j0++) {
              int _len_tzd__i0__devdata_trip_types0 = 1;
          tzd[_i0].devdata->trip_types = (int *) malloc(_len_tzd__i0__devdata_trip_types0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_tzd__i0__devdata_trip_types0; _j0++) {
            tzd[_i0].devdata->trip_types[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_type0 = 1;
          ...
          int benchRet = sys_get_trip_type(tzd,trip,type);
          printf("%d\n", benchRet); 
