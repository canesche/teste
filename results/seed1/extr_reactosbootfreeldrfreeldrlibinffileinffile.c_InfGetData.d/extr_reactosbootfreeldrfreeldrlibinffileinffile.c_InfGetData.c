...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_Context0 = 1;
          struct TYPE_6__ * Context = (struct TYPE_6__ *) malloc(_len_Context0*sizeof(struct TYPE_6__));
          ...
          for(int _i0 = 0; _i0 < _len_Key0; _i0++) {
            int _len_Key1 = 1;
            Key[_i0] = (int *) malloc(_len_Key1*sizeof(int));
          ...
          int benchRet = InfGetData(Context,Key,Data);
          printf("%d\n", benchRet); 
