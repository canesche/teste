...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctx__i0__priv0; _j0++) {
            ctx[_i0].priv->boundaryscale = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        ctx[_i0].priv->steps = ((-2 * (next_i()%2)) + 1) * next_i();
        ctx[_i0].priv->nu = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          ...
          void * arg;
          int benchRet = filter_horizontally(ctx,arg,jobnr,nb_jobs);
          printf("%d\n", benchRet); 
