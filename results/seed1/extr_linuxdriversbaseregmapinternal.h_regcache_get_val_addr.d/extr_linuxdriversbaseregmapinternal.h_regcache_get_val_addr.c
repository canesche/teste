...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_map0; _i0++) {
            map[_i0].cache_word_size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_base0 = 1;
          const void * base = (const void *) malloc(_len_base0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_base0; _i0++) {
            base[_i0] = 0;
          }
          const void * benchRet = regcache_get_val_addr(map,base,idx);
          free(map);
          free(base);
