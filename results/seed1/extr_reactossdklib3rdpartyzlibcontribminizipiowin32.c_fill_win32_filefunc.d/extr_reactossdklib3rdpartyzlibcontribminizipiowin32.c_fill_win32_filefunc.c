...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        pzlib_filefunc_def[_i0].zseek_file = ((-2 * (next_i()%2)) + 1) * next_i();
        pzlib_filefunc_def[_i0].ztell_file = ((-2 * (next_i()%2)) + 1) * next_i();
        pzlib_filefunc_def[_i0].zwrite_file = ((-2 * (next_i()%2)) + 1) * next_i();
        pzlib_filefunc_def[_i0].zread_file = ((-2 * (next_i()%2)) + 1) * next_i();
        pzlib_filefunc_def[_i0].zopen_file = ((-2 * (next_i()%2)) + 1) * next_i();
          }
