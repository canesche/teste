...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        hmc_info[_i0].hmc_obj->size = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_pd_idx0 = 1;
          unsigned long * pd_idx = (unsigned long *) malloc(_len_pd_idx0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_pd_idx0; _i0++) {
            pd_idx[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pd_limit0 = 1;
          unsigned long * pd_limit = (unsigned long *) malloc(_len_pd_limit0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_pd_limit0; _i0++) {
            pd_limit[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          i40iw_find_pd_index_limit(hmc_info,type,idx,cnt,pd_idx,pd_limit);
    ...
    case 1:
    {
        ...
        hmc_info[_i0].hmc_obj->size = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_pd_idx0 = 65025;
          unsigned long * pd_idx = (unsigned long *) malloc(_len_pd_idx0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_pd_idx0; _i0++) {
            pd_idx[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pd_limit0 = 65025;
          unsigned long * pd_limit = (unsigned long *) malloc(_len_pd_limit0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_pd_limit0; _i0++) {
            pd_limit[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
    ...
    case 2:
    {
        ...
        hmc_info[_i0].hmc_obj->size = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_pd_idx0 = 100;
          unsigned long * pd_idx = (unsigned long *) malloc(_len_pd_idx0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_pd_idx0; _i0++) {
            pd_idx[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pd_limit0 = 100;
          unsigned long * pd_limit = (unsigned long *) malloc(_len_pd_limit0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_pd_limit0; _i0++) {
            pd_limit[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
