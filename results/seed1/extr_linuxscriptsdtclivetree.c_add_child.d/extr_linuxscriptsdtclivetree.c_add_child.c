...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          struct node * aux_parent[10000];
          struct node * parent = _allocate_parent(10000, aux_parent);
          struct node * aux_child[10000];
          struct node * child = _allocate_child(10000, aux_child);
          add_child(parent,child);
