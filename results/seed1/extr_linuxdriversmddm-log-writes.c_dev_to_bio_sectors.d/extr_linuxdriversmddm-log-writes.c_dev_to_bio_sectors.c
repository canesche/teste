...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int sectors = 100;
          int _len_lc0 = 1;
          struct log_writes_c * lc = (struct log_writes_c *) malloc(_len_lc0*sizeof(struct log_writes_c));
          for(int _i0 = 0; _i0 < _len_lc0; _i0++) {
            lc[_i0].sectorshift = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = dev_to_bio_sectors(lc,sectors);
          printf("%d\n", benchRet); 
          free(lc);
