...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vsk[_i0].trans = (struct hvsock *) malloc(_len_vsk__i0__trans0*sizeof(struct hvsock));
          for(int _j0 = 0; _j0 < _len_vsk__i0__trans0; _j0++) {
              int _len_vsk__i0__trans_chan0 = 1;
          vsk[_i0].trans->chan = (int *) malloc(_len_vsk__i0__trans_chan0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_vsk__i0__trans_chan0; _j0++) {
            vsk[_i0].trans->chan[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = hvs_stream_is_active(vsk);
          printf("%d\n", benchRet); 
