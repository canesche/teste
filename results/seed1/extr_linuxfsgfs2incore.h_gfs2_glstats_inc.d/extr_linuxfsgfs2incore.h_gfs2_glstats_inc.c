...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_gl0; _i0++) {
              int _len_gl__i0__gl_stats_stats0 = 1;
          gl[_i0].gl_stats.stats = (int *) malloc(_len_gl__i0__gl_stats_stats0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_gl__i0__gl_stats_stats0; _j0++) {
            gl[_i0].gl_stats.stats[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          gfs2_glstats_inc(gl,which);
          free(gl);
