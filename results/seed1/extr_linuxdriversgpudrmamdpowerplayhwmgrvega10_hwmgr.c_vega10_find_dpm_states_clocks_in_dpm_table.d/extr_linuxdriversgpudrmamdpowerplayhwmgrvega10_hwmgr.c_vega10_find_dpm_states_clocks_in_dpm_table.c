...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          hwmgr[_i0].display_config = (struct TYPE_4__ *) malloc(_len_hwmgr__i0__display_config0*sizeof(struct TYPE_4__));
        ...
        hwmgr[_i0].backend->display_timing.num_existing_displays = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_input0 = 1;
          const void * input = (const void *) malloc(_len_input0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_input0; _i0++) {
            input[_i0] = 0;
          }
          int benchRet = vega10_find_dpm_states_clocks_in_dpm_table(hwmgr,input);
          printf("%d\n", benchRet); 
