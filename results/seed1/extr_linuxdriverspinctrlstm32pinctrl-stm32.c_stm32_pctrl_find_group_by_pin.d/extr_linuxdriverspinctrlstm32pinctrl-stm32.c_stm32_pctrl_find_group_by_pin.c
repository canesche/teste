...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          long pin = 100;
          int _len_pctl0 = 1;
          struct stm32_pinctrl * pctl = (struct stm32_pinctrl *) malloc(_len_pctl0*sizeof(struct stm32_pinctrl));
          for(int _i0 = 0; _i0 < _len_pctl0; _i0++) {
            pctl[_i0].ngroups = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_pctl__i0__groups0 = 1;
          pctl[_i0].groups = (struct stm32_pinctrl_group *) malloc(_len_pctl__i0__groups0*sizeof(struct stm32_pinctrl_group));
          for(int _j0 = 0; _j0 < _len_pctl__i0__groups0; _j0++) {
            pctl[_i0].groups->pin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct stm32_pinctrl_group * benchRet = stm32_pctrl_find_group_by_pin(pctl,pin);
          printf("%ld\n", (*benchRet).pin);
