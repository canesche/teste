...
int main(int argc, char *argv[]) {
    ...
    case 1:
    {
          unsigned long num_msdus = 255;
          enum ath10k_pkt_rx_err err = 0;
          unsigned long unchain_cnt = 255;
          unsigned long drop_cnt = 255;
          unsigned long drop_cnt_filter = 255;
          unsigned long queued_msdus = 255;
          int _len_ar0 = 65025;
          struct ath10k * ar = (struct ath10k *) malloc(_len_ar0*sizeof(struct ath10k));
          for(int _i0 = 0; _i0 < _len_ar0; _i0++) {
            ar[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_first_hdr0 = 65025;
          int * first_hdr = (int *) malloc(_len_first_hdr0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_first_hdr0; _i0++) {
            first_hdr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
    ...
    case 2:
    {
          unsigned long num_msdus = 10;
          enum ath10k_pkt_rx_err err = 0;
          unsigned long unchain_cnt = 10;
          unsigned long drop_cnt = 10;
          unsigned long drop_cnt_filter = 10;
          unsigned long queued_msdus = 10;
          int _len_ar0 = 100;
          struct ath10k * ar = (struct ath10k *) malloc(_len_ar0*sizeof(struct ath10k));
          for(int _i0 = 0; _i0 < _len_ar0; _i0++) {
            ar[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_first_hdr0 = 100;
          int * first_hdr = (int *) malloc(_len_first_hdr0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_first_hdr0; _i0++) {
            first_hdr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
