...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_uis__i0____string_data_test_buf0 = 1;
          uis[_i0]._.string_data.test_buf = (const char *) malloc(_len_uis__i0____string_data_test_buf0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_uis__i0____string_data_test_buf0; _j0++) {
            uis[_i0]._.string_data.test_buf[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = UI_get0_test_string(uis);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          free(uis);
