...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          t[_i0].trans = (unsigned int *) malloc(_len_t__i0__trans0*sizeof(unsigned int));
          for(int _j0 = 0; _j0 < _len_t__i0__trans0; _j0++) {
            t[_i0].trans[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_t__i0__table0 = 1;
          t[_i0].table = (long *) malloc(_len_t__i0__table0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_t__i0__table0; _j0++) {
            t[_i0].table[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_lengths0 = 1;
          const unsigned char * lengths = (const unsigned char *) malloc(_len_lengths0*sizeof(const unsigned char));
          for(int _i0 = 0; _i0 < _len_lengths0; _i0++) {
            lengths[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          tinf_build_tree(t,lengths,num);
