...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        fifo[_i0].size = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_fifo__i0__buffer0 = 1;
          fifo[_i0].buffer = (int *) malloc(_len_fifo__i0__buffer0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_fifo__i0__buffer0; _j0++) {
            fifo[_i0].buffer[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_buffer0 = 1;
          ...
          fm10k_fifo_init(fifo,buffer,size);
          for(int _aux = 0; _aux < _len_fifo0; _aux++) {
          free(fifo[_aux].buffer);
          }
          free(fifo);
          free(buffer);
