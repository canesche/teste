...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_di__i0__bm0; _j0++) {
              int _len_di__i0__bm_chg_input_curr0 = 1;
          di[_i0].bm->chg_input_curr = (int *) malloc(_len_di__i0__bm_chg_input_curr0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_di__i0__bm_chg_input_curr0; _j0++) {
            di[_i0].bm->chg_input_curr[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        di[_i0].bm->n_chg_in_curr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = ab8500_vbus_in_curr_to_regval(di,curr);
          printf("%d\n", benchRet); 
