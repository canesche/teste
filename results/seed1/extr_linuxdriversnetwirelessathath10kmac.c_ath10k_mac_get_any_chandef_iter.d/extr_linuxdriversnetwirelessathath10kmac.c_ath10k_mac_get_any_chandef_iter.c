...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_conf0 = 1;
          struct ieee80211_chanctx_conf * conf = (struct ieee80211_chanctx_conf *) malloc(_len_conf0*sizeof(struct ieee80211_chanctx_conf));
          for(int _i0 = 0; _i0 < _len_conf0; _i0++) {
            conf[_i0].def.dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * data;
          ath10k_mac_get_any_chandef_iter(hw,conf,data);
          free(hw);
          free(conf);
