...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
            priv[_i0].rx_pointer = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _j0 = 0; _j0 < _len_priv__i0__descs0; _j0++) {
              int _len_priv__i0__descs_rxdes0 = 1;
          priv[_i0].descs->rxdes = (struct ftmac100_rxdes *) malloc(_len_priv__i0__descs_rxdes0*sizeof(struct ftmac100_rxdes));
          for(int _j0 = 0; _j0 < _len_priv__i0__descs_rxdes0; _j0++) {
            priv[_i0].descs->rxdes->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct ftmac100_rxdes * benchRet = ftmac100_current_rxdes(priv);
          printf("%d\n", (*benchRet).dummy);
