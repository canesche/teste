...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_r0; _i0++) {
            r[_i0].d = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_r__i0__o0 = 1;
          r[_i0].o = (int *) malloc(_len_r__i0__o0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_r__i0__o0; _j0++) {
            r[_i0].o[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = rrdr_line_options(r,rrdr_line);
          printf("%d\n", (*benchRet)); 
