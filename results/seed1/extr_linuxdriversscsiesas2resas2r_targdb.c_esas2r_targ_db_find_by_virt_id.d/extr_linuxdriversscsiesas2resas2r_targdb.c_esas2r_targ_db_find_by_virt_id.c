...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_a__i0__targetdb_end0; _j0++) {
            a[_i0].targetdb_end->target_state = ((-2 * (next_i()%2)) + 1) * next_i();
        a[_i0].targetdb_end->virt_targ_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        a[_i0].targetdb->virt_targ_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct esas2r_target * benchRet = esas2r_targ_db_find_by_virt_id(a,virt_id);
          printf("%ld\n", (*benchRet).target_state);
          printf("%ld\n", (*benchRet).virt_targ_id);
