...
int main(int argc, char *argv[]) {
    ...
    {
          int lag = 100;
          float fac = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          int n = 100;
          int _len_out0 = 1;
          ...
          int _len_lagged0 = 1;
          const float * lagged = (const float *) malloc(_len_lagged0*sizeof(const float));
          for(int _i0 = 0; _i0 < _len_lagged0; _i0++) {
            lagged[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          ff_celp_circ_addf(out,in,lagged,lag,fac,n);
          free(out);
          free(in);
          free(lagged);
