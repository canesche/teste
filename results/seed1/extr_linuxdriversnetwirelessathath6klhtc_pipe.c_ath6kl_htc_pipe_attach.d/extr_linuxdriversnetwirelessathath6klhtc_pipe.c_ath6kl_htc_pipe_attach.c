...
/* Variables and functions */
 int /*<<< orphan*/  ath6kl_htc_pipe_ops ; 
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ar0; _i0++) {
              int _len_ar__i0__htc_ops0 = 1;
          ar[_i0].htc_ops = (int *) malloc(_len_ar__i0__htc_ops0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ar__i0__htc_ops0; _j0++) {
            ar[_i0].htc_ops[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ath6kl_htc_pipe_attach(ar);
          for(int _aux = 0; _aux < _len_ar0; _aux++) {
          free(ar[_aux].htc_ops);
          }
          free(ar);
