...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ac[_i0].oc = (struct TYPE_13__ *) malloc(_len_ac__i0__oc0*sizeof(struct TYPE_13__));
          ...
          target[_i0].ret = (float *) malloc(_len_target__i0__ret0*sizeof(float));
          for(int _j0 = 0; _j0 < _len_target__i0__ret0; _j0++) {
            target[_i0].ret[_j0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          }
          int _len_cce0 = 1;
          ...
          cce[_i0].ch = (struct TYPE_11__ *) malloc(_len_cce__i0__ch0*sizeof(struct TYPE_11__));
          for(int _j0 = 0; _j0 < _len_cce__i0__ch0; _j0++) {
              int _len_cce__i0__ch_ret0 = 1;
          cce[_i0].ch->ret = (float *) malloc(_len_cce__i0__ch_ret0*sizeof(float));
          for(int _j0 = 0; _j0 < _len_cce__i0__ch_ret0; _j0++) {
            cce[_i0].ch->ret[_j0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          }
          int _len_cce__i0__coup_gain0 = 1;
          cce[_i0].coup.gain = (float **) malloc(_len_cce__i0__coup_gain0*sizeof(float *));
          for(int _j0 = 0; _j0 < _len_cce__i0__coup_gain0; _j0++) {
            int _len_cce__i0__coup_gain1 = 1;
            cce[_i0].coup.gain[_j0] = (float *) malloc(_len_cce__i0__coup_gain1*sizeof(float));
            for(int _j1 = 0; _j1 < _len_cce__i0__coup_gain1; _j1++) {
              cce[_i0].coup.gain[_j0][_j1] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
            }
          }
          }
          apply_independent_coupling(ac,target,cce,index);
