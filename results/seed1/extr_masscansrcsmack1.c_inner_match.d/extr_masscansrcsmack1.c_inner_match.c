...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long benchRet = inner_match(px,length,char_to_symbol,table,state,match_limit,row_shift);
          printf("%lu\n", benchRet); 
          free(px);
          free(char_to_symbol);
          free(table);
