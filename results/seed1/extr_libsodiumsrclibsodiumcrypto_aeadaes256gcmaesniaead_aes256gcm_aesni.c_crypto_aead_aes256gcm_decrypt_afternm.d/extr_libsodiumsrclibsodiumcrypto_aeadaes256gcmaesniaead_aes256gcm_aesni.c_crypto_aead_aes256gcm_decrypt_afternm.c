...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_mlen_p0 = 1;
          unsigned long long * mlen_p = (unsigned long long *) malloc(_len_mlen_p0*sizeof(unsigned long long));
          for(int _i0 = 0; _i0 < _len_mlen_p0; _i0++) {
            mlen_p[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_nsec0 = 1;
          ...
          int benchRet = crypto_aead_aes256gcm_decrypt_afternm(m,mlen_p,nsec,c,clen,ad,adlen,npub,ctx_);
          printf("%d\n", benchRet); 
          free(m);
          free(mlen_p);
          free(nsec);
