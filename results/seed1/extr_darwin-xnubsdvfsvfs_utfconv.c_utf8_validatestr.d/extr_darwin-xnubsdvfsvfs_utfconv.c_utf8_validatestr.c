...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long utf8len = 100;
          int _len_utf8p0 = 1;
          const int * utf8p = (const int *) malloc(_len_utf8p0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_utf8p0; _i0++) {
            utf8p[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = utf8_validatestr(utf8p,utf8len);
          printf("%d\n", benchRet); 
          free(utf8p);
    ...
    case 1:
    {
          unsigned long utf8len = 255;
          int _len_utf8p0 = 65025;
          const int * utf8p = (const int *) malloc(_len_utf8p0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_utf8p0; _i0++) {
            utf8p[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
