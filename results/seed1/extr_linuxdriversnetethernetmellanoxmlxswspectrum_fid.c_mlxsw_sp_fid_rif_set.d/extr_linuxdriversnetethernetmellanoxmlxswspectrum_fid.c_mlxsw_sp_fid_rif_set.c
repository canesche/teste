...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fid0; _i0++) {
              int _len_fid__i0__rif0 = 1;
          fid[_i0].rif = (struct mlxsw_sp_rif *) malloc(_len_fid__i0__rif0*sizeof(struct mlxsw_sp_rif));
          for(int _j0 = 0; _j0 < _len_fid__i0__rif0; _j0++) {
            fid[_i0].rif->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_rif0 = 1;
          struct mlxsw_sp_rif * rif = (struct mlxsw_sp_rif *) malloc(_len_rif0*sizeof(struct mlxsw_sp_rif));
          for(int _i0 = 0; _i0 < _len_rif0; _i0++) {
            rif[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
