...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dctx0; _i0++) {
            dctx[_i0].flagStaticTables = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_dctx__i0__hufTableX40 = 1;
          dctx[_i0].hufTableX4 = (int *) malloc(_len_dctx__i0__hufTableX40*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dctx__i0__hufTableX40; _j0++) {
            dctx[_i0].hufTableX4[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        dctx[_i0].expected = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          unsigned long benchRet = ZSTDv05_decompressBegin(dctx);
          printf("%lu\n", benchRet); 
          for(int _aux = 0; _aux < _len_dctx0; _aux++) {
          free(dctx[_aux].hufTableX4);
          }
          for(int _aux = 0; _aux < _len_dctx0; _aux++) {
