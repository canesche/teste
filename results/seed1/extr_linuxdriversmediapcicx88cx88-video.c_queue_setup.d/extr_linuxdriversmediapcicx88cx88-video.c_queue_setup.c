...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          q[_i0].drv_priv->core = (struct cx88_core *) malloc(_len_q__i0__drv_priv_core0*sizeof(struct cx88_core));
          for(int _j0 = 0; _j0 < _len_q__i0__drv_priv_core0; _j0++) {
            q[_i0].drv_priv->core->width = ((-2 * (next_i()%2)) + 1) * next_i();
        q[_i0].drv_priv->core->height = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
