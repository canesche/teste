...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_hdr0 = 1;
          const int * hdr = (const int *) malloc(_len_hdr0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_hdr0; _i0++) {
            hdr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_sechdrs0 = 1;
          const int * sechdrs = (const int *) malloc(_len_sechdrs0*sizeof(const int));
          ...
          int benchRet = module_finalize(hdr,sechdrs,module);
          printf("%d\n", benchRet); 
          free(hdr);
          free(sechdrs);
          free(module);
