...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          struct sym_quehead * aux_new[10000];
          struct sym_quehead * new = _allocate_new(10000, aux_new);
          struct sym_quehead * aux_blink[10000];
          struct sym_quehead * blink = _allocate_blink(10000, aux_blink);
          struct sym_quehead * aux_flink[10000];
          struct sym_quehead * flink = _allocate_flink(10000, aux_flink);
          __sym_que_add(new,blink,flink);
          _delete_new(aux_new, 10000);
          _delete_blink(aux_blink, 10000);
          _delete_flink(aux_flink, 10000);
