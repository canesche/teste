...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_page0; _i0++) {
              int _len_page__i0__data0 = 1;
          page[_i0].data = (const unsigned char *) malloc(_len_page__i0__data0*sizeof(const unsigned char));
          for(int _j0 = 0; _j0 < _len_page__i0__data0; _j0++) {
            page[_i0].data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const unsigned char * benchRet = sqliterkPageGetData(page);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
