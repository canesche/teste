...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_r0; _i0++) {
              int _len_r__i0__q0 = 1;
          r[_i0].q = (int *) malloc(_len_r__i0__q0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_r__i0__q0; _j0++) {
            r[_i0].q[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_r__i0__p0 = 1;
          r[_i0].p = (int *) malloc(_len_r__i0__p0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_r__i0__p0; _j0++) {
            r[_i0].p[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_p0 = 1;
          ...
          int benchRet = RSA_set0_factors(r,p,q);
          printf("%d\n", benchRet); 
