...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ll0; _i0++) {
              int _len_ll__i0__bounds0 = 1;
          ll[_i0].bounds = (long **) malloc(_len_ll__i0__bounds0*sizeof(long *));
          for(int _j0 = 0; _j0 < _len_ll__i0__bounds0; _j0++) {
            int _len_ll__i0__bounds1 = 1;
            ll[_i0].bounds[_j0] = (long *) malloc(_len_ll__i0__bounds1*sizeof(long));
            for(int _j1 = 0; _j1 < _len_ll__i0__bounds1; _j1++) {
              ll[_i0].bounds[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
        ll[_i0].count = ((-2 * (next_i()%2)) + 1) * next_i();
        ll[_i0].maxcount = ((-2 * (next_i()%2)) + 1) * next_i();
        ll[_i0].list = ((-2 * (next_i()%2)) + 1) * next_i();
        ll[_i0].overflowed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          CM_StoreBrushes(ll,nodenum);
