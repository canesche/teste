...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_cfg__i0__tc_config_path0; _j0++) {
            cfg[_i0].tc_config->path->data_credits_refill = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_refill0 = 1;
          int * refill = (int *) malloc(_len_refill0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_refill0; _i0++) {
            refill[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ixgbe_dcb_unpack_refill(cfg,direction,refill);
