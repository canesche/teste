...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        list[_i0].bank_bitmap->bitmapwords = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_pPage0 = 1;
          long * pPage = (long *) malloc(_len_pPage0*sizeof(long));
          for(int _i0 = 0; _i0 < _len_pPage0; _i0++) {
            pPage[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct TYPE_6__ * benchRet = hibernate_page_bitmap_pin(list,pPage);
          printf("%ld\n", (*benchRet).first_page);
          printf("%ld\n", (*benchRet).last_page);
