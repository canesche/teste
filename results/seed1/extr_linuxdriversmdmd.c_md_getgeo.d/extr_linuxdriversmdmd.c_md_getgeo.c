...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          bdev[_i0].bd_disk->private_data = (struct mddev *) malloc(_len_bdev__i0__bd_disk_private_data0*sizeof(struct mddev));
          for(int _j0 = 0; _j0 < _len_bdev__i0__bd_disk_private_data0; _j0++) {
            bdev[_i0].bd_disk->private_data->array_sectors = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_geo0 = 1;
        ...
        geo[_i0].cylinders = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = md_getgeo(bdev,geo);
          printf("%d\n", benchRet); 
