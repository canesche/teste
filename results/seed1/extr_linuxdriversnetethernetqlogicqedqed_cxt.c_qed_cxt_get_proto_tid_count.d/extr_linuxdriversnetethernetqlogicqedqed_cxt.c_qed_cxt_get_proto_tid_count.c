...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          p_hwfn[_i0].p_cxt_mngr = (struct TYPE_6__ *) malloc(_len_p_hwfn__i0__p_cxt_mngr0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_p_hwfn__i0__p_cxt_mngr0; _j0++) {
              int _len_p_hwfn__i0__p_cxt_mngr_conn_cfg0 = 1;
          p_hwfn[_i0].p_cxt_mngr->conn_cfg = (struct TYPE_5__ *) malloc(_len_p_hwfn__i0__p_cxt_mngr_conn_cfg0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_p_hwfn__i0__p_cxt_mngr_conn_cfg0; _j0++) {
              int _len_p_hwfn__i0__p_cxt_mngr_conn_cfg_tid_seg0 = 1;
          p_hwfn[_i0].p_cxt_mngr->conn_cfg->tid_seg = (struct TYPE_4__ *) malloc(_len_p_hwfn__i0__p_cxt_mngr_conn_cfg_tid_seg0*sizeof(struct TYPE_4__));
          ...
          int benchRet = qed_cxt_get_proto_tid_count(p_hwfn,type);
          printf("%d\n", benchRet); 
