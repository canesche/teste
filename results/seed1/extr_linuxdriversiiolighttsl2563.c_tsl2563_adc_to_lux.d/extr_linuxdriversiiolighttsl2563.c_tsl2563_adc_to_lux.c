...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long adc0 = 100;
          unsigned long adc1 = 100;
          unsigned int benchRet = tsl2563_adc_to_lux(adc0,adc1);
          printf("%u\n", benchRet); 
    ...
    case 1:
    {
          unsigned long adc0 = 255;
          unsigned long adc1 = 255;
          unsigned int benchRet = tsl2563_adc_to_lux(adc0,adc1);
          printf("%u\n", benchRet); 
    ...
    case 2:
    {
          unsigned long adc0 = 10;
          unsigned long adc1 = 10;
          unsigned int benchRet = tsl2563_adc_to_lux(adc0,adc1);
          printf("%u\n", benchRet); 
