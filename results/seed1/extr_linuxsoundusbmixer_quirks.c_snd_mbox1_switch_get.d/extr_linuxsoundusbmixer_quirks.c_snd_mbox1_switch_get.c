...
__attribute__((used)) static int snd_mbox1_switch_get(struct snd_kcontrol *kctl,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ucontrol0; _i0++) {
              int _len_ucontrol__i0__value_enumerated_item0 = 1;
          ucontrol[_i0].value.enumerated.item = (int *) malloc(_len_ucontrol__i0__value_enumerated_item0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ucontrol__i0__value_enumerated_item0; _j0++) {
            ucontrol[_i0].value.enumerated.item[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = snd_mbox1_switch_get(kctl,ucontrol);
          printf("%d\n", benchRet); 
          free(kctl);
          free(ucontrol);
