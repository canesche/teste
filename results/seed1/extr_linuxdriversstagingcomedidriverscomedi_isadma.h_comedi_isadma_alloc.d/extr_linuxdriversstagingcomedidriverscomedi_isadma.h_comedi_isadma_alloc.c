...
int main(int argc, char *argv[]) {
    ...
    {
          int n_desc = 100;
          unsigned int dma_chan1 = 100;
          unsigned int dma_chan2 = 100;
          ...
          struct comedi_isadma * benchRet = comedi_isadma_alloc(dev,n_desc,dma_chan1,dma_chan2,maxsize,dma_dir);
          printf("%d\n", (*benchRet).dummy);
          free(dev);
    ...
    {
          int n_desc = 255;
          unsigned int dma_chan1 = 255;
          unsigned int dma_chan2 = 255;
          unsigned int maxsize = 255;
          char dma_dir = 255;
          int _len_dev0 = 65025;
          struct comedi_device * dev = (struct comedi_device *) malloc(_len_dev0*sizeof(struct comedi_device));
          for(int _i0 = 0; _i0 < _len_dev0; _i0++) {
    ...
    {
          int n_desc = 10;
          unsigned int dma_chan1 = 10;
          unsigned int dma_chan2 = 10;
