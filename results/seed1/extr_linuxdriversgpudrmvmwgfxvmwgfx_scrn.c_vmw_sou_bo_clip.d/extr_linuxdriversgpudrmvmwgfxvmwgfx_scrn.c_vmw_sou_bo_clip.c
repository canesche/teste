...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        dirty[_i0].fb_x = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          dirty[_i0].cmd = (struct vmw_kms_sou_bo_blit *) malloc(_len_dirty__i0__cmd0*sizeof(struct vmw_kms_sou_bo_blit));
          for(int _j0 = 0; _j0 < _len_dirty__i0__cmd0; _j0++) {
            dirty[_i0].cmd->body.destRect.bottom = ((-2 * (next_i()%2)) + 1) * next_i();
        dirty[_i0].cmd->body.destRect.right = ((-2 * (next_i()%2)) + 1) * next_i();
        dirty[_i0].cmd->body.destRect.top = ((-2 * (next_i()%2)) + 1) * next_i();
        dirty[_i0].cmd->body.destRect.left = ((-2 * (next_i()%2)) + 1) * next_i();
        dirty[_i0].cmd->body.srcOrigin.y = ((-2 * (next_i()%2)) + 1) * next_i();
        dirty[_i0].cmd->body.srcOrigin.x = ((-2 * (next_i()%2)) + 1) * next_i();
        dirty[_i0].cmd->body.destScreenId = ((-2 * (next_i()%2)) + 1) * next_i();
        dirty[_i0].cmd->header = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          vmw_sou_bo_clip(dirty);
