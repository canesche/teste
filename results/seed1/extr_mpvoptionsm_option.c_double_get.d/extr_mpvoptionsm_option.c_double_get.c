...
/* Type definitions */
struct TYPE_2__ {double double_; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dst0; _i0++) {
            dst[_i0].u.double_ = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        dst[_i0].format = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * src;
          int benchRet = double_get(opt,ta_parent,dst,src);
          printf("%d\n", benchRet); 
          free(opt);
          free(dst);
