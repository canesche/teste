...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          node[_i0].sway_output = (struct sway_output *) malloc(_len_node__i0__sway_output0*sizeof(struct sway_output));
          for(int _j0 = 0; _j0 < _len_node__i0__sway_output0; _j0++) {
            node[_i0].sway_output->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _j0 = 0; _j0 < _len_node__i0__sway_workspace0; _j0++) {
              int _len_node__i0__sway_workspace_output0 = 1;
          node[_i0].sway_workspace->output = (struct sway_output *) malloc(_len_node__i0__sway_workspace_output0*sizeof(struct sway_output));
          for(int _j0 = 0; _j0 < _len_node__i0__sway_workspace_output0; _j0++) {
            node[_i0].sway_workspace->output->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          node[_i0].sway_container->workspace = (struct sway_workspace *) malloc(_len_node__i0__sway_container_workspace0*sizeof(struct sway_workspace));
          for(int _j0 = 0; _j0 < _len_node__i0__sway_container_workspace0; _j0++) {
              int _len_node__i0__sway_container_workspace_output0 = 1;
          node[_i0].sway_container->workspace->output = (struct sway_output *) malloc(_len_node__i0__sway_container_workspace_output0*sizeof(struct sway_output));
          for(int _j0 = 0; _j0 < _len_node__i0__sway_container_workspace_output0; _j0++) {
            node[_i0].sway_container->workspace->output->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          struct sway_output * benchRet = node_get_output(node);
          printf("%d\n", (*benchRet).dummy);
