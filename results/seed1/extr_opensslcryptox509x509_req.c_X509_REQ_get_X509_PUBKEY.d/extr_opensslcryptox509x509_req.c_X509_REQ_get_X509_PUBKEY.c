...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_req0; _i0++) {
              int _len_req__i0__req_info_pubkey0 = 1;
          req[_i0].req_info.pubkey = (int *) malloc(_len_req__i0__req_info_pubkey0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_req__i0__req_info_pubkey0; _j0++) {
            req[_i0].req_info.pubkey[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = X509_REQ_get_X509_PUBKEY(req);
          printf("%d\n", (*benchRet)); 
          free(req);
