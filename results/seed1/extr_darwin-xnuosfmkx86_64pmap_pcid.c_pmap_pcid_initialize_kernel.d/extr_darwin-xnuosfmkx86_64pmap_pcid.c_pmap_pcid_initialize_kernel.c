...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
              int _len_p__i0__pmap_pcid_cpus0 = 1;
          p[_i0].pmap_pcid_cpus = (long *) malloc(_len_p__i0__pmap_pcid_cpus0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_p__i0__pmap_pcid_cpus0; _j0++) {
            p[_i0].pmap_pcid_cpus[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          pmap_pcid_initialize_kernel(p);
          for(int _aux = 0; _aux < _len_p0; _aux++) {
          free(p[_aux].pmap_pcid_cpus);
          }
          free(p);
