...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_mlc__i0__di_scratch_rsc0 = 1;
          mlc[_i0].di_scratch.rsc = (int *) malloc(_len_mlc__i0__di_scratch_rsc0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_mlc__i0__di_scratch_rsc0; _j0++) {
            mlc[_i0].di_scratch.rsc[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int benchRet = hilse_take_rsc(mlc,unused);
          printf("%d\n", benchRet); 
