...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long object_type = 100;
          unsigned long object_size = 100;
          int benchRet = cache_should_store(object_type,object_size);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          unsigned long object_type = 255;
          unsigned long object_size = 255;
          int benchRet = cache_should_store(object_type,object_size);
          printf("%d\n", benchRet); 
    ...
    case 2:
    {
          unsigned long object_type = 10;
          unsigned long object_size = 10;
          int benchRet = cache_should_store(object_type,object_size);
          printf("%d\n", benchRet); 
