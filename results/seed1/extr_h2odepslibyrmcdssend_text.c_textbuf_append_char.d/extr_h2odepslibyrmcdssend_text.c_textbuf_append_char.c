...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_buf0; _i0++) {
              int _len_buf__i0__pos0 = 1;
          buf[_i0].pos = (char *) malloc(_len_buf__i0__pos0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_buf__i0__pos0; _j0++) {
            buf[_i0].pos[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          textbuf_append_char(buf,c);
