...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_reg0 = 1;
          struct rtw_regulatory * reg = (struct rtw_regulatory *) malloc(_len_reg0*sizeof(struct rtw_regulatory));
          for(int _i0 = 0; _i0 < _len_reg0; _i0++) {
            reg[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          const struct ieee80211_regdomain * benchRet = _rtw_regdomain_select(reg);
          free(reg);
