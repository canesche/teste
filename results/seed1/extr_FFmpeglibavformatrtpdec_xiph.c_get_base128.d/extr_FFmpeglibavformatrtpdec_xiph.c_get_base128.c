...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_buf0; _i0++) {
            int _len_buf1 = 1;
            buf[_i0] = (const int *) malloc(_len_buf1*sizeof(const int));
            for(int _i1 = 0; _i1 < _len_buf1; _i1++) {
              buf[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int _len_buf_end0 = 1;
          const int * buf_end = (const int *) malloc(_len_buf_end0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_buf_end0; _i0++) {
            buf_end[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = get_base128(buf,buf_end);
          printf("%d\n", benchRet); 
