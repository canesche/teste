...
__attribute__((used)) static void empty(void *elem, unsigned long opaque, unsigned long *key,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          void * func2;
          empty(elem,opaque,key,index,func2);
          free(key);
