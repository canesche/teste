...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_iter0; _i0++) {
            iter[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_iter__i0__type_info0 = 1;
          iter[_i0].type_info = (struct type_info *) malloc(_len_iter__i0__type_info0*sizeof(struct type_info));
          for(int _j0 = 0; _j0 < _len_iter__i0__type_info0; _j0++) {
            iter[_i0].type_info->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct type_info * benchRet = get_type(iter);
          printf("%d\n", (*benchRet).dummy);
          for(int _aux = 0; _aux < _len_iter0; _aux++) {
          free(iter[_aux].type_info);
          }
          free(iter);
