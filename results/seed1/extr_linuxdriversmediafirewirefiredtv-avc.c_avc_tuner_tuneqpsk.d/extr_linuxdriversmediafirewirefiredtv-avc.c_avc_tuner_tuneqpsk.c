...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fdtv0; _i0++) {
            fdtv[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
        fdtv[_i0].voltage = ((-2 * (next_i()%2)) + 1) * next_i();
        fdtv[_i0].tone = ((-2 * (next_i()%2)) + 1) * next_i();
        fdtv[_i0].fe.dtv_property_cache.delivery_system = ((-2 * (next_i()%2)) + 1) * next_i();
        fdtv[_i0].fe.dtv_property_cache.modulation = ((-2 * (next_i()%2)) + 1) * next_i();
        fdtv[_i0].fe.dtv_property_cache.rolloff = ((-2 * (next_i()%2)) + 1) * next_i();
        fdtv[_i0].fe.dtv_property_cache.pilot = ((-2 * (next_i()%2)) + 1) * next_i();
        fdtv[_i0].avc_data = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_p0 = 1;
        ...
        p[_i0].symbol_rate = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].fec_inner = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = avc_tuner_tuneqpsk(fdtv,p);
          printf("%d\n", benchRet); 
          free(fdtv);
          free(p);
