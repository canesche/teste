...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
              int _len_p__i0__rv0 = 1;
          p[_i0].rv = (int *) malloc(_len_p__i0__rv0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__rv0; _j0++) {
            p[_i0].rv[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_p__i0__v0 = 1;
          p[_i0].v = (int *) malloc(_len_p__i0__v0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__v0; _j0++) {
            p[_i0].v[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
