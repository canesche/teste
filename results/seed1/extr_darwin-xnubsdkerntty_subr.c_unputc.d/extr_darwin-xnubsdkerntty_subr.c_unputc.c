...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_clp__i0__c_cl0 = 1;
          clp[_i0].c_cl = (int *) malloc(_len_clp__i0__c_cl0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_clp__i0__c_cl0; _j0++) {
            clp[_i0].c_cl[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int _len_clp__i0__c_ce0 = 1;
          clp[_i0].c_ce = (int *) malloc(_len_clp__i0__c_ce0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_clp__i0__c_ce0; _j0++) {
            clp[_i0].c_ce[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
