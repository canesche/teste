...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_nanosecs0 = 1;
          long * nanosecs = (long *) malloc(_len_nanosecs0*sizeof(long));
          for(int _i0 = 0; _i0 < _len_nanosecs0; _i0++) {
            nanosecs[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
