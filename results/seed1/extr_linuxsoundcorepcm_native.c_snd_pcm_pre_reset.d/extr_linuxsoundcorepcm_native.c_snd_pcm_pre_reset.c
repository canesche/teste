...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime0; _j0++) {
              int _len_substream__i0__runtime_status0 = 1;
          substream[_i0].runtime->status = (struct TYPE_2__ *) malloc(_len_substream__i0__runtime_status0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime_status0; _j0++) {
            substream[_i0].runtime->status->state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = snd_pcm_pre_reset(substream,state);
          printf("%d\n", benchRet); 
