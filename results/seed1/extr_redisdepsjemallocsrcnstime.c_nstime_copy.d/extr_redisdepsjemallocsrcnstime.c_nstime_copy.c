...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_time0 = 1;
          int * time = (int *) malloc(_len_time0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_time0; _i0++) {
            time[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_source0 = 1;
          const int * source = (const int *) malloc(_len_source0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_source0; _i0++) {
            source[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          nstime_copy(time,source);
          free(time);
          free(source);
