...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          mdev[_i0].intr_info = (struct mic_intr_info *) malloc(_len_mdev__i0__intr_info0*sizeof(struct mic_intr_info));
          for(int _j0 = 0; _j0 < _len_mdev__i0__intr_info0; _j0++) {
            mdev[_i0].intr_info->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          mic_x100_hw_intr_init(mdev);
