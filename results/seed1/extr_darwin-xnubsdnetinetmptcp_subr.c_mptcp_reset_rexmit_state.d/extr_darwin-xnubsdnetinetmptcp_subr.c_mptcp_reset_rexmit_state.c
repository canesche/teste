...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          tp[_i0].t_inpcb = (struct inpcb *) malloc(_len_tp__i0__t_inpcb0*sizeof(struct inpcb));
          ...
          for(int _j0 = 0; _j0 < _len_tp__i0__t_inpcb_inp_socket0; _j0++) {
            tp[_i0].t_inpcb->inp_socket->so_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          mptcp_reset_rexmit_state(tp);
