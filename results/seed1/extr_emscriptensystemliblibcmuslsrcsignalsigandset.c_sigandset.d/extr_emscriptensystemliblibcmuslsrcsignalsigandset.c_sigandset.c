...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_left0 = 1;
          const int * left = (const int *) malloc(_len_left0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_left0; _i0++) {
            left[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_right0 = 1;
          const int * right = (const int *) malloc(_len_right0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_right0; _i0++) {
            right[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = sigandset(dest,left,right);
          printf("%d\n", benchRet); 
          free(dest);
          free(left);
          free(right);
