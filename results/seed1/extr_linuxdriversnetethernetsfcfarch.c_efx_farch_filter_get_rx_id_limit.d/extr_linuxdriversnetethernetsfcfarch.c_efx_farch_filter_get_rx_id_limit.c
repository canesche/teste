...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          efx[_i0].filter_state = (struct efx_farch_filter_state *) malloc(_len_efx__i0__filter_state0*sizeof(struct efx_farch_filter_state));
          ...
          unsigned int benchRet = efx_farch_filter_get_rx_id_limit(efx);
          printf("%u\n", benchRet); 
