...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_outlink0 = 1;
          struct TYPE_6__ * outlink = (struct TYPE_6__ *) malloc(_len_outlink0*sizeof(struct TYPE_6__));
        ...
        outlink[_i0].h = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          outlink[_i0].src = (struct TYPE_7__ *) malloc(_len_outlink__i0__src0*sizeof(struct TYPE_7__));
          for(int _j0 = 0; _j0 < _len_outlink__i0__src0; _j0++) {
              int _len_outlink__i0__src_priv0 = 1;
          outlink[_i0].src->priv = (struct TYPE_5__ *) malloc(_len_outlink__i0__src_priv0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_outlink__i0__src_priv0; _j0++) {
            outlink[_i0].src->priv->size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
