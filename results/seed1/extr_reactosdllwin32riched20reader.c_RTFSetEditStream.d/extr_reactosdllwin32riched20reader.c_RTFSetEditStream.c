...
typedef  int /*<<< orphan*/  ME_InStream ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
              int _len_info__i0__stream0 = 1;
          info[_i0].stream = (int *) malloc(_len_info__i0__stream0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_info__i0__stream0; _j0++) {
            info[_i0].stream[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_stream0 = 1;
          ...
          RTFSetEditStream(info,stream);
          for(int _aux = 0; _aux < _len_info0; _aux++) {
          free(info[_aux].stream);
          }
          free(info);
          free(stream);
