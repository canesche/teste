...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData0; _j0++) {
              int _len_phost__i0__pActiveClass_pData_pUserLineCoding0 = 1;
          phost[_i0].pActiveClass->pData->pUserLineCoding = (int *) malloc(_len_phost__i0__pActiveClass_pData_pUserLineCoding0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData_pUserLineCoding0; _j0++) {
            phost[_i0].pActiveClass->pData->pUserLineCoding[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        phost[_i0].pActiveClass->pData->state = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = USBH_CDC_SetLineCoding(phost,linecodin);
          printf("%d\n", benchRet); 
