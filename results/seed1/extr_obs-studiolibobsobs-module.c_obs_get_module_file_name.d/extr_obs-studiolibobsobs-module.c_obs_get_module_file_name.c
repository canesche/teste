...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_module0; _i0++) {
              int _len_module__i0__file0 = 1;
          module[_i0].file = (const char *) malloc(_len_module__i0__file0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_module__i0__file0; _j0++) {
            module[_i0].file[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = obs_get_module_file_name(module);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          for(int _aux = 0; _aux < _len_module0; _aux++) {
          free(module[_aux].file);
          }
          free(module);
