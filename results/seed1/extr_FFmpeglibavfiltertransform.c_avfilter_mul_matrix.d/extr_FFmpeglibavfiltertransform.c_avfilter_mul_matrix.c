...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          float scalar = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          int _len_m10 = 1;
          const float * m1 = (const float *) malloc(_len_m10*sizeof(const float));
          ...
          avfilter_mul_matrix(m1,scalar,result);
          free(m1);
          free(result);
