...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          view[_i0].wlr_xdg_surface = (struct TYPE_2__ *) malloc(_len_view__i0__wlr_xdg_surface0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_view__i0__wlr_xdg_surface0; _j0++) {
              int _len_view__i0__wlr_xdg_surface_toplevel0 = 1;
          view[_i0].wlr_xdg_surface->toplevel = (struct wlr_xdg_toplevel *) malloc(_len_view__i0__wlr_xdg_surface_toplevel0*sizeof(struct wlr_xdg_toplevel));
          for(int _j0 = 0; _j0 < _len_view__i0__wlr_xdg_surface_toplevel0; _j0++) {
            view[_i0].wlr_xdg_surface->toplevel->parent = ((-2 * (next_i()%2)) + 1) * next_i();
        view[_i0].wlr_xdg_surface->toplevel->current.min_width = ((-2 * (next_i()%2)) + 1) * next_i();
        view[_i0].wlr_xdg_surface->toplevel->current.min_height = ((-2 * (next_i()%2)) + 1) * next_i();
        view[_i0].wlr_xdg_surface->toplevel->current.max_width = ((-2 * (next_i()%2)) + 1) * next_i();
        view[_i0].wlr_xdg_surface->toplevel->current.max_height = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
