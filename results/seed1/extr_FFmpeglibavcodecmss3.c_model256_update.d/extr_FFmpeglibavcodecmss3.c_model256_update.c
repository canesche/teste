...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        m[_i0].upd_val = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_m__i0__secondary0 = 1;
          m[_i0].secondary = (int *) malloc(_len_m__i0__secondary0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_m__i0__secondary0; _j0++) {
            m[_i0].secondary[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        m[_i0].sec_size = ((-2 * (next_i()%2)) + 1) * next_i();
