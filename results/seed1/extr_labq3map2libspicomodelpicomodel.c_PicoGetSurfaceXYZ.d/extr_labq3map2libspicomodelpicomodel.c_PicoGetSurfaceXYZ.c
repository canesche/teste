...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          surface[_i0].xyz = (int **) malloc(_len_surface__i0__xyz0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_surface__i0__xyz0; _j0++) {
            int _len_surface__i0__xyz1 = 1;
            surface[_i0].xyz[_j0] = (int *) malloc(_len_surface__i0__xyz1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_surface__i0__xyz1; _j1++) {
              surface[_i0].xyz[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          int * benchRet = PicoGetSurfaceXYZ(surface,num);
          printf("%d\n", (*benchRet)); 
