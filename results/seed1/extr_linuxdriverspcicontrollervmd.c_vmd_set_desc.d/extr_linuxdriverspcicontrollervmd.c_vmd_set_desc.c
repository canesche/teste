...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_arg0; _i0++) {
              int _len_arg__i0__desc0 = 1;
          arg[_i0].desc = (struct msi_desc *) malloc(_len_arg__i0__desc0*sizeof(struct msi_desc));
          for(int _j0 = 0; _j0 < _len_arg__i0__desc0; _j0++) {
            arg[_i0].desc->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_desc0 = 1;
          struct msi_desc * desc = (struct msi_desc *) malloc(_len_desc0*sizeof(struct msi_desc));
          for(int _i0 = 0; _i0 < _len_desc0; _i0++) {
            desc[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          vmd_set_desc(arg,desc);
