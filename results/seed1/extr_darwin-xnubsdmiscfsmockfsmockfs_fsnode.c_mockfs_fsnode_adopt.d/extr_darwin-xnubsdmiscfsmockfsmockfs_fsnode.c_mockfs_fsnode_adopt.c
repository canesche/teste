...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          struct TYPE_4__ * aux_parent[10000];
          struct TYPE_4__ * parent = _allocate_parent(10000, aux_parent);
          struct TYPE_4__ * aux_child[10000];
          struct TYPE_4__ * child = _allocate_child(10000, aux_child);
          int benchRet = mockfs_fsnode_adopt(parent,child);
          printf("%d\n", benchRet); 
