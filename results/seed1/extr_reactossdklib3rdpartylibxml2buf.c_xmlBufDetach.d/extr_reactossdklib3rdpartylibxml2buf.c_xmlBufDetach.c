...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        buf[_i0].compat_size = ((-2 * (next_i()%2)) + 1) * next_i();
        buf[_i0].compat_use = ((-2 * (next_i()%2)) + 1) * next_i();
        buf[_i0].use = ((-2 * (next_i()%2)) + 1) * next_i();
        buf[_i0].size = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_buf__i0__content0 = 1;
          buf[_i0].content = (int *) malloc(_len_buf__i0__content0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_buf__i0__content0; _j0++) {
            buf[_i0].content[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        buf[_i0].error = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_buf__i0__buffer0 = 1;
          buf[_i0].buffer = (int *) malloc(_len_buf__i0__buffer0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_buf__i0__buffer0; _j0++) {
            buf[_i0].buffer[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = xmlBufDetach(buf);
          printf("%d\n", (*benchRet)); 
          for(int _aux = 0; _aux < _len_buf0; _aux++) {
          free(buf[_aux].content);
          }
          for(int _aux = 0; _aux < _len_buf0; _aux++) {
