...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long data_port = 100;
          unsigned long ctrl_port = 100;
          unsigned long irq_port = 100;
          int _len_hw0 = 1;
        ...
        hw[_i0].io_ports.irq_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          sgiioc4_init_hwif_ports(hw,data_port,ctrl_port,irq_port);
    ...
    case 1:
    {
          unsigned long data_port = 255;
          unsigned long ctrl_port = 255;
          unsigned long irq_port = 255;
          int _len_hw0 = 65025;
          struct ide_hw * hw = (struct ide_hw *) malloc(_len_hw0*sizeof(struct ide_hw));
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
              int _len_hw__i0__io_ports_array0 = 1;
    ...
    case 2:
    {
          unsigned long data_port = 10;
          unsigned long ctrl_port = 10;
          unsigned long irq_port = 10;
          int _len_hw0 = 100;
          struct ide_hw * hw = (struct ide_hw *) malloc(_len_hw0*sizeof(struct ide_hw));
          for(int _i0 = 0; _i0 < _len_hw0; _i0++) {
              int _len_hw__i0__io_ports_array0 = 1;
