...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ac97[_i0].private_data = (struct intel8x0 *) malloc(_len_ac97__i0__private_data0*sizeof(struct intel8x0));
          ...
          for(int _j0 = 0; _j0 < _len_ac97__i0__private_data_ac970; _j0++) {
            int _len_ac97__i0__private_data_ac971 = 1;
            ac97[_i0].private_data->ac97[_j0] = (int *) malloc(_len_ac97__i0__private_data_ac971*sizeof(int));
            for(int _j1 = 0; _j1 < _len_ac97__i0__private_data_ac971; _j1++) {
              ac97[_i0].private_data->ac97[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          }
          snd_intel8x0_mixer_free_ac97(ac97);
