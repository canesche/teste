...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].dev_private = (struct msm_drm_private *) malloc(_len_dev__i0__dev_private0*sizeof(struct msm_drm_private));
          for(int _j0 = 0; _j0 < _len_dev__i0__dev_private0; _j0++) {
              int _len_dev__i0__dev_private_gpu_pdev0 = 1;
          dev[_i0].dev_private->gpu_pdev = (struct platform_device *) malloc(_len_dev__i0__dev_private_gpu_pdev0*sizeof(struct platform_device));
          for(int _j0 = 0; _j0 < _len_dev__i0__dev_private_gpu_pdev0; _j0++) {
            dev[_i0].dev_private->gpu_pdev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_pdev0 = 1;
