...
int main(int argc, char *argv[]) {
    ...
    case 1:
    {
          ...
          struct rndis_params * params = (struct rndis_params *) malloc(_len_params0*sizeof(struct rndis_params));
          for(int _i0 = 0; _i0 < _len_params0; _i0++) {
              int _len_params__i0__host_mac0 = 1;
          params[_i0].host_mac = (const int *) malloc(_len_params__i0__host_mac0*sizeof(const int));
          for(int _j0 = 0; _j0 < _len_params__i0__host_mac0; _j0++) {
            params[_i0].host_mac[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
