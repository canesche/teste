...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_info0; _i0++) {
            info[_i0].lshift = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_info__i0__keys0 = 1;
          info[_i0].keys = (unsigned long *) malloc(_len_info__i0__keys0*sizeof(unsigned long));
          for(int _j0 = 0; _j0 < _len_info__i0__keys0; _j0++) {
            info[_i0].keys[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        info[_i0].rshift = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = USBH_HID_GetASCIICode(info);
          printf("%d\n", benchRet); 
