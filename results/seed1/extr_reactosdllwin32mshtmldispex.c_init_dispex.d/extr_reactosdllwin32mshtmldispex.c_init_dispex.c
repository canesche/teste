...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dispex0; _i0++) {
              int _len_dispex__i0__dynamic_data0 = 1;
          dispex[_i0].dynamic_data = (int *) malloc(_len_dispex__i0__dynamic_data0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dispex__i0__dynamic_data0; _j0++) {
            dispex[_i0].dynamic_data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
