...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        phost[_i0].pActiveClass->pData->headphone.partial_ptr = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_phost__i0__pActiveClass_pData_headphone_buf0 = 1;
          phost[_i0].pActiveClass->pData->headphone.buf = (int *) malloc(_len_phost__i0__pActiveClass_pData_headphone_buf0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData_headphone_buf0; _j0++) {
            phost[_i0].pActiveClass->pData->headphone.buf[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_phost__i0__pActiveClass_pData_headphone_cbuf0 = 1;
          phost[_i0].pActiveClass->pData->headphone.cbuf = (int *) malloc(_len_phost__i0__pActiveClass_pData_headphone_cbuf0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData_headphone_cbuf0; _j0++) {
            phost[_i0].pActiveClass->pData->headphone.cbuf[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          ...
          int benchRet = USBH_AUDIO_ChangeOutBuffer(phost,buf);
          printf("%d\n", benchRet); 
