...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          p[_i0].p_fd = (struct TYPE_2__ *) malloc(_len_p__i0__p_fd0*sizeof(struct TYPE_2__));
          ...
          p[_i0].p_fd->fd_ofiles = (int **) malloc(_len_p__i0__p_fd_fd_ofiles0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_p__i0__p_fd_fd_ofiles0; _j0++) {
            int _len_p__i0__p_fd_fd_ofiles1 = 1;
            p[_i0].p_fd->fd_ofiles[_j0] = (int *) malloc(_len_p__i0__p_fd_fd_ofiles1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_p__i0__p_fd_fd_ofiles1; _j1++) {
              p[_i0].p_fd->fd_ofiles[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          }
