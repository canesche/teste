...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ac97[_i0].private_data = (struct cs4281 *) malloc(_len_ac97__i0__private_data0*sizeof(struct cs4281));
          ...
          int _len_ac97__i0__private_data_ac97_secondary0 = 1;
          ac97[_i0].private_data->ac97_secondary = (int *) malloc(_len_ac97__i0__private_data_ac97_secondary0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ac97__i0__private_data_ac97_secondary0; _j0++) {
            ac97[_i0].private_data->ac97_secondary[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          snd_cs4281_mixer_free_ac97(ac97);
