...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_permutation0 = 64;
          unsigned long const* permutation = (unsigned long const*) malloc(_len_permutation0*sizeof(unsigned long const));
          for(int _i0 = 0; _i0 < _len_permutation0; _i0++) {
            permutation[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          permute(dst,src,permutation);
          free(dst);
          free(src);
          free(permutation);
