...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stash0; _i0++) {
            stash[_i0].nstates = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_stash__i0__states0 = 1;
          stash[_i0].states = (int *) malloc(_len_stash__i0__states0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_stash__i0__states0; _j0++) {
            stash[_i0].states[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = fons__getState(stash);
          printf("%d\n", (*benchRet)); 
          for(int _aux = 0; _aux < _len_stash0; _aux++) {
          free(stash[_aux].states);
          }
          free(stash);
