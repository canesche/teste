...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          chan[_i0].private = (struct sh_dmae_slave *) malloc(_len_chan__i0__private0*sizeof(struct sh_dmae_slave));
          for(int _j0 = 0; _j0 < _len_chan__i0__private0; _j0++) {
            chan[_i0].private->shdma_slave.slave_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          void * param;
          int benchRet = usbhsf_dma_filter(chan,param);
          printf("%d\n", benchRet); 
