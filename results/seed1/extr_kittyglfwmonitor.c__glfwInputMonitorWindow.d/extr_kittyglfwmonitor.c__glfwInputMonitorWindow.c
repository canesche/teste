...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_monitor0; _i0++) {
              int _len_monitor__i0__window0 = 1;
          monitor[_i0].window = (int *) malloc(_len_monitor__i0__window0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_monitor__i0__window0; _j0++) {
            monitor[_i0].window[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_window0 = 1;
          ...
          _glfwInputMonitorWindow(monitor,window);
          for(int _aux = 0; _aux < _len_monitor0; _aux++) {
          free(monitor[_aux].window);
          }
          free(monitor);
          free(window);
