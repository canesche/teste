...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int block_size = 100;
          int _len_srcp0 = 1;
          const float * srcp = (const float *) malloc(_len_srcp0*sizeof(const float));
          for(int _i0 = 0; _i0 < _len_srcp0; _i0++) {
            srcp[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          int _len_dst0 = 1;
          ...
          get_block_row(srcp,src_linesize,y,x,block_size,dst);
          free(srcp);
          free(dst);
