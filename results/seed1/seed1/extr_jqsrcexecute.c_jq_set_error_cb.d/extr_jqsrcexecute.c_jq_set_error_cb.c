...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_jq0; _i0++) {
              int _len_jq__i0__err_cb0 = 1;
          jq[_i0].err_cb = (int *) malloc(_len_jq__i0__err_cb0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_jq__i0__err_cb0; _j0++) {
            jq[_i0].err_cb[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_cb0 = 1;
          ...
          void * data;
          jq_set_error_cb(jq,cb,data);
          for(int _aux = 0; _aux < _len_jq0; _aux++) {
          free(jq[_aux].err_cb);
          }
          free(jq);
          free(cb);
