...
/* Type definitions */
struct TYPE_3__ {int* state; scalar_t__ count; int /*<<< orphan*/ * f; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        ctx[_i0].count = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ctx__i0__f0 = 1;
          ctx[_i0].f = (int *) malloc(_len_ctx__i0__f0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ctx__i0__f0; _j0++) {
            ctx[_i0].f[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          SHA_init(ctx);
