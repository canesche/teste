...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_b0; _i0++) {
            b[_i0].linew = ((-2 * (next_i()%2)) + 1) * next_i();
        b[_i0].data = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_b__i0__format0 = 1;
          b[_i0].format = (struct TYPE_4__ *) malloc(_len_b__i0__format0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_b__i0__format0; _j0++) {
            b[_i0].format->bitsPerPixel = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = vncGetPixel(b,x,y);
          printf("%d\n", benchRet); 
