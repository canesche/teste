...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ptr0; _i0++) {
            int _len_ptr1 = 1;
            ptr[_i0] = (unsigned char *) malloc(_len_ptr1*sizeof(unsigned char));
            for(int _i1 = 0; _i1 < _len_ptr1; _i1++) {
              ptr[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int _len_base0 = 1;
          unsigned char * base = (unsigned char *) malloc(_len_base0*sizeof(unsigned char));
          for(int _i0 = 0; _i0 < _len_base0; _i0++) {
            base[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          align_pointer_offset(ptr,base,align);
