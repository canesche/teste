...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        SiS_Pr[_i0].SiS_RefIndex->Ext_CRT1CRTC_WIDE = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr[_i0].SiS_RefIndex->Ext_CRT1CRTC_NORM = ((-2 * (next_i()%2)) + 1) * next_i();
        SiS_Pr[_i0].SiS_RefIndex->Ext_CRT1CRTC = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          unsigned short benchRet = SiS_GetRefCRT1CRTC(SiS_Pr,Index,UseWide);
          printf("%hu\n", benchRet); 
