...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          is[_i0].config = (struct chain_config *) malloc(_len_is__i0__config0*sizeof(struct chain_config));
          for(int _j0 = 0; _j0 < _len_is__i0__config0; _j0++) {
            is[_i0].config->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct chain_config * benchRet = __get_curr_is_config(is);
          printf("%d\n", (*benchRet).dummy);
