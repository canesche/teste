...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          id[_i0].active_entries = (long *) malloc(_len_id__i0__active_entries0*sizeof(long));
        ...
        id[_i0].entry_size = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_id__i0__active_pages0 = 1;
          id[_i0].active_pages = (int *) malloc(_len_id__i0__active_pages0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_id__i0__active_pages0; _j0++) {
            id[_i0].active_pages[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        id[_i0].pages_per_area = ((-2 * (next_i()%2)) + 1) * next_i();
          }
