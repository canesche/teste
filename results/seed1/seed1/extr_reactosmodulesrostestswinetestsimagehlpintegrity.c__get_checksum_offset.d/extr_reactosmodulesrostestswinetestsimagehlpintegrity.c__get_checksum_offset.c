...
int main(int argc, char *argv[]) {
    ...
    {
          long base = 100;
          int _len_nt_header0 = 1;
          long * nt_header = (long *) malloc(_len_nt_header0*sizeof(long));
          for(int _i0 = 0; _i0 < _len_nt_header0; _i0++) {
            nt_header[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int benchRet = _get_checksum_offset(base,nt_header,checksum);
          printf("%d\n", benchRet); 
          free(nt_header);
          free(checksum);
