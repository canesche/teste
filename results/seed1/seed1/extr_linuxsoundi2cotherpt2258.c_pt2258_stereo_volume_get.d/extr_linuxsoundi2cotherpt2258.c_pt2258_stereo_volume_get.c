...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_kcontrol__i0__private_data0; _j0++) {
              int _len_kcontrol__i0__private_data_volume0 = 1;
          kcontrol[_i0].private_data->volume = (long *) malloc(_len_kcontrol__i0__private_data_volume0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_kcontrol__i0__private_data_volume0; _j0++) {
            kcontrol[_i0].private_data->volume[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          ...
          ucontrol[_i0].value.integer.value = (long *) malloc(_len_ucontrol__i0__value_integer_value0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_ucontrol__i0__value_integer_value0; _j0++) {
            ucontrol[_i0].value.integer.value[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = pt2258_stereo_volume_get(kcontrol,ucontrol);
          printf("%d\n", benchRet); 
