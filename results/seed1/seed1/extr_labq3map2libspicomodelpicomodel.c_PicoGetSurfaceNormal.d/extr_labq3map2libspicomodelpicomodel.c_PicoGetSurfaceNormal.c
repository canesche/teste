...
struct TYPE_3__ {int numVertexes; int /*<<< orphan*/ ** normal; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          surface[_i0].normal = (int **) malloc(_len_surface__i0__normal0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_surface__i0__normal0; _j0++) {
            int _len_surface__i0__normal1 = 1;
            surface[_i0].normal[_j0] = (int *) malloc(_len_surface__i0__normal1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_surface__i0__normal1; _j1++) {
              surface[_i0].normal[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          int * benchRet = PicoGetSurfaceNormal(surface,num);
          printf("%d\n", (*benchRet)); 
