...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_o0; _i0++) {
            o[_i0].i = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_o__i0__out0 = 1;
          o[_i0].out = (int *) malloc(_len_o__i0__out0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_o__i0__out0; _j0++) {
            o[_i0].out[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_output0 = 1;
