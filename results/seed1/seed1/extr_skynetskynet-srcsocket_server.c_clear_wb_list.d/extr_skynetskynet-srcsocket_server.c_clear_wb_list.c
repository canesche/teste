...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_list0 = 1;
          struct wb_list * list = (struct wb_list *) malloc(_len_list0*sizeof(struct wb_list));
          for(int _i0 = 0; _i0 < _len_list0; _i0++) {
              int _len_list__i0__tail0 = 1;
          list[_i0].tail = (int *) malloc(_len_list__i0__tail0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_list__i0__tail0; _j0++) {
            list[_i0].tail[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
