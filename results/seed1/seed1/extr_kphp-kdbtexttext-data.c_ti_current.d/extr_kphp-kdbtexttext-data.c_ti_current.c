...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_I0; _i0++) {
            I[_i0].Sp = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_I__i0__St0 = 1;
          I[_i0].St = (int **) malloc(_len_I__i0__St0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_I__i0__St0; _j0++) {
            int _len_I__i0__St1 = 1;
            I[_i0].St[_j0] = (int *) malloc(_len_I__i0__St1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_I__i0__St1; _j1++) {
              I[_i0].St[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          int * benchRet = ti_current(I);
          printf("%d\n", (*benchRet)); 
