...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_argv0 = 1;
          const char ** argv = (const char **) malloc(_len_argv0*sizeof(const char *));
          for(int _i0 = 0; _i0 < _len_argv0; _i0++) {
            int _len_argv1 = 1;
            argv[_i0] = (const char *) malloc(_len_argv1*sizeof(const char));
            for(int _i1 = 0; _i1 < _len_argv1; _i1++) {
              argv[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int benchRet = lang_c_set_argv(lang,argc,argv);
          printf("%d\n", benchRet); 
          free(lang);
