...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_c0 = 1;
          struct clock_event_device * c = (struct clock_event_device *) malloc(_len_c0*sizeof(struct clock_event_device));
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ckevt_dc21285_set_next_event(delta,c);
          printf("%d\n", benchRet); 
          free(c);
