...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_tplg__i0__fw0; _j0++) {
            tplg[_i0].fw->size = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_tplg__i0__fw_data0 = 1;
          tplg[_i0].fw->data = (const int *) malloc(_len_tplg__i0__fw_data0*sizeof(const int));
          for(int _j0 = 0; _j0 < _len_tplg__i0__fw_data0; _j0++) {
            tplg[_i0].fw->data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_tplg__i0__hdr_pos0 = 1;
          tplg[_i0].hdr_pos = (int *) malloc(_len_tplg__i0__hdr_pos0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_tplg__i0__hdr_pos0; _j0++) {
            tplg[_i0].hdr_pos[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = soc_tplg_is_eof(tplg);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_tplg0; _aux++) {
          free(tplg[_aux].fw);
          }
          for(int _aux = 0; _aux < _len_tplg0; _aux++) {
          free(tplg[_aux].hdr_pos);
          }
          free(tplg);
