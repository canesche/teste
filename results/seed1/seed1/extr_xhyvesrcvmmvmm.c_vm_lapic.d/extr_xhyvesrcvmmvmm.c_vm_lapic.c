...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_vm__i0__vcpu0; _j0++) {
              int _len_vm__i0__vcpu_vlapic0 = 1;
          vm[_i0].vcpu->vlapic = (struct vlapic *) malloc(_len_vm__i0__vcpu_vlapic0*sizeof(struct vlapic));
          for(int _j0 = 0; _j0 < _len_vm__i0__vcpu_vlapic0; _j0++) {
            vm[_i0].vcpu->vlapic->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct vlapic * benchRet = vm_lapic(vm,cpu);
          printf("%d\n", (*benchRet).dummy);
