...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_intspec0 = 1;
          const unsigned long * intspec = (const unsigned long *) malloc(_len_intspec0*sizeof(const unsigned long));
          ...
          int benchRet = mmp_irq_domain_xlate(d,node,intspec,intsize,out_hwirq,out_type);
          printf("%d\n", benchRet); 
          free(d);
          free(node);
          free(intspec);
