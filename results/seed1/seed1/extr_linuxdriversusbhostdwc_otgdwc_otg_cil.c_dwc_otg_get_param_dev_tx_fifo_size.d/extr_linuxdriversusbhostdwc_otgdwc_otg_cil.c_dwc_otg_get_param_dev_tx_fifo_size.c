...
struct TYPE_4__ {int /*<<< orphan*/ * dev_tx_fifo_size; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_core_if__i0__core_params0; _j0++) {
              int _len_core_if__i0__core_params_dev_tx_fifo_size0 = 1;
          core_if[_i0].core_params->dev_tx_fifo_size = (int *) malloc(_len_core_if__i0__core_params_dev_tx_fifo_size0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_core_if__i0__core_params_dev_tx_fifo_size0; _j0++) {
            core_if[_i0].core_params->dev_tx_fifo_size[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = dwc_otg_get_param_dev_tx_fifo_size(core_if,fifo_num);
          printf("%d\n", benchRet); 
