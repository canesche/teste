...
__attribute__((used)) static void twl_get_request_id(TW_Device_Extension *tw_dev, int *request_id)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        tw_dev[_i0].free_head = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_request_id0 = 1;
          int * request_id = (int *) malloc(_len_request_id0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_request_id0; _i0++) {
            request_id[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
