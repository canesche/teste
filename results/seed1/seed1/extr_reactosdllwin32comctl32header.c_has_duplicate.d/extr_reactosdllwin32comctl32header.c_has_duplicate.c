...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_array0 = 1;
          const unsigned long * array = (const unsigned long *) malloc(_len_array0*sizeof(const unsigned long));
          for(int _i0 = 0; _i0 < _len_array0; _i0++) {
            array[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = has_duplicate(array,to,value);
          printf("%lu\n", benchRet); 
          free(array);
