...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        cpu_data_ptr[_i0].cpu_pmap_cpu_data.cpu_user_pmap_stamp = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_cpu_data_ptr__i0__cpu_pmap_cpu_data_cpu_user_pmap0 = 1;
          cpu_data_ptr[_i0].cpu_pmap_cpu_data.cpu_user_pmap = (struct pmap *) malloc(_len_cpu_data_ptr__i0__cpu_pmap_cpu_data_cpu_user_pmap0*sizeof(struct pmap));
          for(int _j0 = 0; _j0 < _len_cpu_data_ptr__i0__cpu_pmap_cpu_data_cpu_user_pmap0; _j0++) {
            cpu_data_ptr[_i0].cpu_pmap_cpu_data.cpu_user_pmap->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        cpu_data_ptr[_i0].cpu_base_timebase_high = ((-2 * (next_i()%2)) + 1) * next_i();
        cpu_data_ptr[_i0].cpu_base_timebase_low = ((-2 * (next_i()%2)) + 1) * next_i();
