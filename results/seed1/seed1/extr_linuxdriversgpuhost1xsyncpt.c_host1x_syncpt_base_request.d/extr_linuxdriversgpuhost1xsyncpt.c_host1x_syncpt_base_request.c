...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_host__i0__bases0 = 1;
          host[_i0].bases = (struct host1x_syncpt_base *) malloc(_len_host__i0__bases0*sizeof(struct host1x_syncpt_base));
          for(int _j0 = 0; _j0 < _len_host__i0__bases0; _j0++) {
            host[_i0].bases->requested = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct host1x_syncpt_base * benchRet = host1x_syncpt_base_request(host);
          printf("%d\n", (*benchRet).requested);
          for(int _aux = 0; _aux < _len_host0; _aux++) {
          free(host[_aux].info);
          }
          for(int _aux = 0; _aux < _len_host0; _aux++) {
          free(host[_aux].bases);
          }
          free(host);
