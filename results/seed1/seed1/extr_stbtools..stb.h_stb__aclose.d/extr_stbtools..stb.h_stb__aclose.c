...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
              int _len_f__i0__buffer0 = 1;
          f[_i0].buffer = (unsigned char *) malloc(_len_f__i0__buffer0*sizeof(unsigned char));
          for(int _j0 = 0; _j0 < _len_f__i0__buffer0; _j0++) {
            f[_i0].buffer[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        f[_i0].ptr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          stb__aclose(f);
