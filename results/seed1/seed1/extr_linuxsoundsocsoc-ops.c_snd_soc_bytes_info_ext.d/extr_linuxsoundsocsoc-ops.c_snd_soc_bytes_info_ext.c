...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct snd_ctl_elem_info * ucontrol = (struct snd_ctl_elem_info *) malloc(_len_ucontrol0*sizeof(struct snd_ctl_elem_info));
          for(int _i0 = 0; _i0 < _len_ucontrol0; _i0++) {
            ucontrol[_i0].count = ((-2 * (next_i()%2)) + 1) * next_i();
        ucontrol[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = snd_soc_bytes_info_ext(kcontrol,ucontrol);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(ucontrol);
