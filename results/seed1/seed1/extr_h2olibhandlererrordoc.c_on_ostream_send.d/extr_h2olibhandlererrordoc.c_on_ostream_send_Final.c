...
__attribute__((used)) static void on_ostream_send(h2o_ostream_t *self, h2o_req_t *req, h2o_iovec_t *inbufs, size_t inbufcnt, h2o_send_state_t state)
{
    /* nothing to do */
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          on_ostream_send(self,req,inbufs,inbufcnt,state);
          free(self);
          free(req);
          free(inbufs);
