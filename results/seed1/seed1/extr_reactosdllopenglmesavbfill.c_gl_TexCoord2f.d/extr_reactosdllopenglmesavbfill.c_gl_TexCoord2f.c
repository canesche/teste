...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ctx0; _i0++) {
              int _len_ctx__i0__Current_TexCoord0 = 1;
          ctx[_i0].Current.TexCoord = (void **) malloc(_len_ctx__i0__Current_TexCoord0*sizeof(void *));
          for(int _j0 = 0; _j0 < _len_ctx__i0__Current_TexCoord0; _j0++) {
          }
          }
          void * s;
          void * t;
          gl_TexCoord2f(ctx,s,t);
          free(ctx);
