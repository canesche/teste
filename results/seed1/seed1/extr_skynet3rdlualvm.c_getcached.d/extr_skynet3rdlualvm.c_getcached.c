...
struct TYPE_15__ {TYPE_1__** upvals; } ;
struct TYPE_14__ {TYPE_2__* sp; TYPE_6__* cache; } ;
struct TYPE_11__ {int sizeupvalues; TYPE_3__* upvalues; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
              int _len_p__i0__sp0 = 1;
          p[_i0].sp = (struct TYPE_11__ *) malloc(_len_p__i0__sp0*sizeof(struct TYPE_11__));
          for(int _j0 = 0; _j0 < _len_p__i0__sp0; _j0++) {
            p[_i0].sp->sizeupvalues = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_p__i0__sp_upvalues0 = 1;
          p[_i0].sp->upvalues = (struct TYPE_12__ *) malloc(_len_p__i0__sp_upvalues0*sizeof(struct TYPE_12__));
          for(int _j0 = 0; _j0 < _len_p__i0__sp_upvalues0; _j0++) {
            p[_i0].sp->upvalues->idx = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].sp->upvalues->instack = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          for(int _j0 = 0; _j0 < _len_p__i0__cache0; _j0++) {
              int _len_p__i0__cache_upvals0 = 1;
          p[_i0].cache->upvals = (struct TYPE_10__ **) malloc(_len_p__i0__cache_upvals0*sizeof(struct TYPE_10__ *));
          for(int _j0 = 0; _j0 < _len_p__i0__cache_upvals0; _j0++) {
            int _len_p__i0__cache_upvals1 = 1;
            p[_i0].cache->upvals[_j0] = (struct TYPE_10__ *) malloc(_len_p__i0__cache_upvals1*sizeof(struct TYPE_10__));
            for(int _j1 = 0; _j1 < _len_p__i0__cache_upvals1; _j1++) {
                int _len_p__i0__cache_upvals__j0__v0 = 1;
          p[_i0].cache->upvals[_j0]->v = (int *) malloc(_len_p__i0__cache_upvals__j0__v0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__cache_upvals__j0__v0; _j0++) {
            p[_i0].cache->upvals[_j0]->v[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
            }
          }
          }
