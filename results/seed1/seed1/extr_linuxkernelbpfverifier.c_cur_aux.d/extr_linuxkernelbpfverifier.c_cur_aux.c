...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_env0; _i0++) {
            env[_i0].insn_idx = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_env__i0__insn_aux_data0 = 1;
          env[_i0].insn_aux_data = (struct bpf_insn_aux_data *) malloc(_len_env__i0__insn_aux_data0*sizeof(struct bpf_insn_aux_data));
          for(int _j0 = 0; _j0 < _len_env__i0__insn_aux_data0; _j0++) {
            env[_i0].insn_aux_data->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct bpf_insn_aux_data * benchRet = cur_aux(env);
          printf("%d\n", (*benchRet).dummy);
          for(int _aux = 0; _aux < _len_env0; _aux++) {
          free(env[_aux].insn_aux_data);
          }
          free(env);
