...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_r__i0__v0 = 1;
          r[_i0].v = (int *) malloc(_len_r__i0__v0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_r__i0__v0; _j0++) {
            r[_i0].v[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = rrdr_line_values(r,rrdr_line);
          printf("%d\n", (*benchRet)); 
