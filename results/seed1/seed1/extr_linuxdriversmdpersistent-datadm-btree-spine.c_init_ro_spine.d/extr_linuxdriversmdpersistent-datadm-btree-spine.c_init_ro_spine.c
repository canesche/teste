...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_s0 = 1;
          struct ro_spine * s = (struct ro_spine *) malloc(_len_s0*sizeof(struct ro_spine));
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
              int _len_s__i0__nodes0 = 1;
          s[_i0].nodes = (int **) malloc(_len_s__i0__nodes0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_s__i0__nodes0; _j0++) {
            int _len_s__i0__nodes1 = 1;
            s[_i0].nodes[_j0] = (int *) malloc(_len_s__i0__nodes1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_s__i0__nodes1; _j1++) {
              s[_i0].nodes[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
