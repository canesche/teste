    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_e__i0__values0; _j0++) {
            ...
            for(int _j1 = 0; _j1 < _len_e__i0__values1; _j1++) {
                int _len_e__i0__values__j0__Str0 = 1;
          e[_i0].values[_j0]->Str = (char *) malloc(_len_e__i0__values__j0__Str0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_e__i0__values__j0__Str0; _j0++) {
            e[_i0].values[_j0]->Str[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
            }
          }
          }
          char * benchRet = GetStrValue(e,index);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
