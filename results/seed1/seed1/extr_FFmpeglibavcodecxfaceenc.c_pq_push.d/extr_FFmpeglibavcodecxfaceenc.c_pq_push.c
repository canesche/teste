...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pq0; _i0++) {
            pq[_i0].prob_ranges_idx = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_pq__i0__prob_ranges0 = 1;
          pq[_i0].prob_ranges = (int *) malloc(_len_pq__i0__prob_ranges0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_pq__i0__prob_ranges0; _j0++) {
            pq[_i0].prob_ranges[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_p0 = 1;
          ...
          int benchRet = pq_push(pq,p);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_pq0; _aux++) {
          free(pq[_aux].prob_ranges);
          }
          free(pq);
          free(p);
