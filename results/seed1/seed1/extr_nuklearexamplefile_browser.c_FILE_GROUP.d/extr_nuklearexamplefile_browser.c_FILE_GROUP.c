...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_icon0 = 1;
          struct nk_image * icon = (struct nk_image *) malloc(_len_icon0*sizeof(struct nk_image));
          for(int _i0 = 0; _i0 < _len_icon0; _i0++) {
            icon[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct file_group benchRet = FILE_GROUP(group,name,icon);
          printf("%d\n", benchRet.group);
          free(name);
          free(icon);
