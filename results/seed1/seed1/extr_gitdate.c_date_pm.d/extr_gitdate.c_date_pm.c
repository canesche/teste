...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        tm[_i0].tm_min = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_now0 = 1;
          struct tm * now = (struct tm *) malloc(_len_now0*sizeof(struct tm));
          for(int _i0 = 0; _i0 < _len_now0; _i0++) {
            now[_i0].tm_hour = ((-2 * (next_i()%2)) + 1) * next_i();
        now[_i0].tm_sec = ((-2 * (next_i()%2)) + 1) * next_i();
        now[_i0].tm_min = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_num0 = 1;
