...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          et[_i0].et_object = (struct ocfs2_dinode *) malloc(_len_et__i0__et_object0*sizeof(struct ocfs2_dinode));
          for(int _j0 = 0; _j0 < _len_et__i0__et_object0; _j0++) {
            et[_i0].et_object->id2.i_list = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ocfs2_dinode_fill_root_el(et);
