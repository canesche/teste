...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_module0; _i0++) {
              int _len_module__i0__data_path0 = 1;
          module[_i0].data_path = (const char *) malloc(_len_module__i0__data_path0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_module__i0__data_path0; _j0++) {
            module[_i0].data_path[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = obs_get_module_data_path(module);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          for(int _aux = 0; _aux < _len_module0; _aux++) {
          free(module[_aux].data_path);
          }
          free(module);
