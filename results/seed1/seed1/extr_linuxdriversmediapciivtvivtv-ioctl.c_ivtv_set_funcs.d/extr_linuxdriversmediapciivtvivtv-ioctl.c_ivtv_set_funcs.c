...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vdev0; _i0++) {
              int _len_vdev__i0__ioctl_ops0 = 1;
          vdev[_i0].ioctl_ops = (int *) malloc(_len_vdev__i0__ioctl_ops0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_vdev__i0__ioctl_ops0; _j0++) {
            vdev[_i0].ioctl_ops[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ivtv_set_funcs(vdev);
          for(int _aux = 0; _aux < _len_vdev0; _aux++) {
          free(vdev[_aux].ioctl_ops);
          }
          free(vdev);
