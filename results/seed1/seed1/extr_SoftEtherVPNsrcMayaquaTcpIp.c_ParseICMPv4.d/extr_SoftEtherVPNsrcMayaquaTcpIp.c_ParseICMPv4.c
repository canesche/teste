...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p__i0__L4_ICMPHeader0 = 1;
          p[_i0].L4.ICMPHeader = (int *) malloc(_len_p__i0__L4_ICMPHeader0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__L4_ICMPHeader0; _j0++) {
            p[_i0].L4.ICMPHeader[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_buf0 = 1;
          ...
          int benchRet = ParseICMPv4(p,buf,size);
          printf("%d\n", benchRet); 
          free(p);
          free(buf);
