...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          cc[_i0].dev = (struct TYPE_2__ *) malloc(_len_cc__i0__dev0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_cc__i0__dev0; _j0++) {
              int _len_cc__i0__dev_bus0 = 1;
          cc[_i0].dev->bus = (struct ssb_bus *) malloc(_len_cc__i0__dev_bus0*sizeof(struct ssb_bus));
          for(int _j0 = 0; _j0 < _len_cc__i0__dev_bus0; _j0++) {
            cc[_i0].dev->bus->chip_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = pmu_fast_powerup_delay(cc);
          printf("%d\n", benchRet); 
