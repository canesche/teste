...
/* Variables and functions */
 int A6XX_TEX_SAMP_1_MAX_LOD__MASK ; 
 int A6XX_TEX_SAMP_1_MAX_LOD__SHIFT ; 

__attribute__((used)) static inline uint32_t A6XX_TEX_SAMP_1_MAX_LOD(float val)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = A6XX_TEX_SAMP_1_MAX_LOD(val);
          printf("%d\n", benchRet); 
