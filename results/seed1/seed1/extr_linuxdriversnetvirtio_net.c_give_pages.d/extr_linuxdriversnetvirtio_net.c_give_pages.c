...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_rq0 = 1;
          struct receive_queue * rq = (struct receive_queue *) malloc(_len_rq0*sizeof(struct receive_queue));
          for(int _i0 = 0; _i0 < _len_rq0; _i0++) {
              int _len_rq__i0__pages0 = 1;
          rq[_i0].pages = (struct page *) malloc(_len_rq__i0__pages0*sizeof(struct page));
          for(int _j0 = 0; _j0 < _len_rq__i0__pages0; _j0++) {
            rq[_i0].pages->private = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_page0 = 1;
          struct page * page = (struct page *) malloc(_len_page0*sizeof(struct page));
          for(int _i0 = 0; _i0 < _len_page0; _i0++) {
            page[_i0].private = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          give_pages(rq,page);
