...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          skt[_i0].stat = (struct TYPE_2__ *) malloc(_len_skt__i0__stat0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_skt__i0__stat0; _j0++) {
              int _len_skt__i0__stat_name0 = 1;
          skt[_i0].stat->name = (char *) malloc(_len_skt__i0__stat_name0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_skt__i0__stat_name0; _j0++) {
            skt[_i0].stat->name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        skt[_i0].stat->gpio = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = e740_pcmcia_hw_init(skt);
          printf("%d\n", benchRet); 
