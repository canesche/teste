...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_a__i0__table0; _j0++) {
              int _len_a__i0__table_k0 = 1;
          a[_i0].table->k = (char *) malloc(_len_a__i0__table_k0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_a__i0__table_k0; _j0++) {
            a[_i0].table->k[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          char * benchRet = stb_sdict_internal_key(a,n);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
