...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned int * out_hwirq = (unsigned int *) malloc(_len_out_hwirq0*sizeof(unsigned int));
          ...
          int benchRet = gef_pic_host_xlate(h,ct,intspec,intsize,out_hwirq,out_flags);
          printf("%d\n", benchRet); 
          free(h);
          free(ct);
          free(intspec);
