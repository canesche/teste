...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_st0; _i0++) {
              int _len_st__i0__indexes0 = 1;
          st[_i0].indexes = (unsigned int *) malloc(_len_st__i0__indexes0*sizeof(unsigned int));
          for(int _j0 = 0; _j0 < _len_st__i0__indexes0; _j0++) {
            st[_i0].indexes[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        st[_i0].depth = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned int benchRet = BN_STACK_pop(st);
          printf("%u\n", benchRet); 
          for(int _aux = 0; _aux < _len_st0; _aux++) {
          free(st[_aux].indexes);
          }
          free(st);
