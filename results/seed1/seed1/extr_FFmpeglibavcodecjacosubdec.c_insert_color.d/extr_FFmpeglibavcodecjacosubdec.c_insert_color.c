...
__attribute__((used)) static int insert_color(AVBPrint *dst, const char *in, const char *arg)
{
    return 1; // skip id
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_arg0 = 1;
          const char * arg = (const char *) malloc(_len_arg0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_arg0; _i0++) {
            arg[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = insert_color(dst,in,arg);
          printf("%d\n", benchRet); 
          free(dst);
          free(in);
          free(arg);
