...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_control__i0__private_data_spec_volume0 = 1;
          control[_i0].private_data->spec->volume = (int *) malloc(_len_control__i0__private_data_spec_volume0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_control__i0__private_data_spec_volume0; _j0++) {
            control[_i0].private_data->spec->volume[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          ...
          for(int _i0 = 0; _i0 < _len_value0; _i0++) {
              int _len_value__i0__value_integer_value0 = 1;
          value[_i0].value.integer.value = (int *) malloc(_len_value__i0__value_integer_value0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_value__i0__value_integer_value0; _j0++) {
            value[_i0].value.integer.value[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = spkr_volume_get(control,value);
          printf("%d\n", benchRet); 
