...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_thread0; _i0++) {
            thread[_i0].at_safe_point = ((-2 * (next_i()%2)) + 1) * next_i();
        thread[_i0].wait_event = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_thread__i0__waitq0 = 1;
          thread[_i0].waitq = (int *) malloc(_len_thread__i0__waitq0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_thread__i0__waitq0; _j0++) {
            thread[_i0].waitq[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          thread_clear_waitq_state(thread);
          for(int _aux = 0; _aux < _len_thread0; _aux++) {
          free(thread[_aux].waitq);
          }
          free(thread);
