...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          table[_i0].array = (struct unw_table_entry *) malloc(_len_table__i0__array0*sizeof(struct unw_table_entry));
          for(int _j0 = 0; _j0 < _len_table__i0__array0; _j0++) {
            table[_i0].array->start_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        table[_i0].array->end_offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const struct unw_table_entry * benchRet = lookup(table,rel_ip);
    ...
    case 3:
    {
          unsigned long rel_ip = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_table0 = 1;
          struct unw_table * table = (struct unw_table *) malloc(_len_table0*sizeof(struct unw_table));
          for(int _i0 = 0; _i0 < _len_table0; _i0++) {
            table[_i0].length = ((-2 * (next_i()%2)) + 1) * next_i();
