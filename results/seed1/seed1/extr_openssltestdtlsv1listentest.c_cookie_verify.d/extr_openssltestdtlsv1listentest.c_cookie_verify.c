...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_cookie0 = 1;
          const unsigned char * cookie = (const unsigned char *) malloc(_len_cookie0*sizeof(const unsigned char));
          for(int _i0 = 0; _i0 < _len_cookie0; _i0++) {
            cookie[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = cookie_verify(ssl,cookie,cookie_len);
          printf("%d\n", benchRet); 
          free(ssl);
          free(cookie);
