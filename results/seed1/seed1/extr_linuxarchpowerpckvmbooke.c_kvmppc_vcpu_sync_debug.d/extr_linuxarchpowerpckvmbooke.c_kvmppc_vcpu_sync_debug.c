...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vcpu0; _i0++) {
            vcpu[_i0].arch.shadow_msr = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_vcpu__i0__arch_shared0 = 1;
          vcpu[_i0].arch.shared = (struct TYPE_3__ *) malloc(_len_vcpu__i0__arch_shared0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_vcpu__i0__arch_shared0; _j0++) {
            vcpu[_i0].arch.shared->msr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
