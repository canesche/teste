...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ctl[_i0].private_data->model_data->wm8776_regs = (unsigned int *) malloc(_len_ctl__i0__private_data_model_data_wm8776_regs0*sizeof(unsigned int));
          ...
          int benchRet = wm8776_input_mux_get(ctl,value);
          printf("%d\n", benchRet); 
