...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int value = 100;
          int _len_table0 = 1;
          struct value_to_name_map * table = (struct value_to_name_map *) malloc(_len_table0*sizeof(struct value_to_name_map));
          ...
          const char * benchRet = value_to_name(table,count,value);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
