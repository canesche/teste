...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_uinfo__i0__dimen_d0 = 1;
          uinfo[_i0].dimen.d = (int *) malloc(_len_uinfo__i0__dimen_d0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_uinfo__i0__dimen_d0; _j0++) {
            uinfo[_i0].dimen.d[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        uinfo[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = snd_echo_vumeters_info(kcontrol,uinfo);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(uinfo);
