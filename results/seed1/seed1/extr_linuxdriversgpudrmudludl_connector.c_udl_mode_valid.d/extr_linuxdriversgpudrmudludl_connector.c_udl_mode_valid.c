...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          connector[_i0].dev = (struct TYPE_2__ *) malloc(_len_connector__i0__dev0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_connector__i0__dev0; _j0++) {
              int _len_connector__i0__dev_dev_private0 = 1;
          connector[_i0].dev->dev_private = (struct udl_device *) malloc(_len_connector__i0__dev_dev_private0*sizeof(struct udl_device));
          for(int _j0 = 0; _j0 < _len_connector__i0__dev_dev_private0; _j0++) {
            connector[_i0].dev->dev_private->sku_pixel_limit = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_mode0 = 1;
        ...
        mode[_i0].hdisplay = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          enum drm_mode_status benchRet = udl_mode_valid(connector,mode);
