...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_upl0 = 1;
          struct TYPE_5__ * upl = (struct TYPE_5__ *) malloc(_len_upl0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_upl0; _i0++) {
            upl[_i0].vector_upl = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = upl_get_internal_vectorupl_pagelist(upl);
          printf("%d\n", (*benchRet)); 
          free(upl);
