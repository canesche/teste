...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_n10 = 1;
          const void * n1 = (const void *) malloc(_len_n10*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_n10; _i0++) {
            n1[_i0] = 0;
          }
          int _len_n20 = 1;
          const void * n2 = (const void *) malloc(_len_n20*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_n20; _i0++) {
            n2[_i0] = 0;
          }
          int benchRet = clusterManagerSlotCountCompareDesc(n1,n2);
          printf("%d\n", benchRet); 
          free(n1);
          free(n2);
