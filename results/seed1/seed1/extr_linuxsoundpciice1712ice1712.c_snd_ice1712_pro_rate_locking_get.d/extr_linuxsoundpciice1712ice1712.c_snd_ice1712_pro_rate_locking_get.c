...
__attribute__((used)) static int snd_ice1712_pro_rate_locking_get(struct snd_kcontrol *kcontrol,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = snd_ice1712_pro_rate_locking_get(kcontrol,ucontrol);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(ucontrol);
