...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pinctrl0 = 1;
          struct pinctrl_dev * pinctrl = (struct pinctrl_dev *) malloc(_len_pinctrl0*sizeof(struct pinctrl_dev));
          for(int _i0 = 0; _i0 < _len_pinctrl0; _i0++) {
              int _len_pinctrl__i0__desc0 = 1;
          pinctrl[_i0].desc = (struct TYPE_4__ *) malloc(_len_pinctrl__i0__desc0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_pinctrl__i0__desc0; _j0++) {
              int _len_pinctrl__i0__desc_pins0 = 1;
          pinctrl[_i0].desc->pins = (struct TYPE_3__ *) malloc(_len_pinctrl__i0__desc_pins0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_pinctrl__i0__desc_pins0; _j0++) {
            pinctrl[_i0].desc->pins->number = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_pins0 = 1;
          ...
          int benchRet = tegra_xusb_padctl_get_group_pins(pinctrl,group,pins,num_pins);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_pinctrl0; _aux++) {
          free(pinctrl[_aux].desc);
          }
          free(pinctrl);
