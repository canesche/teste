...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          const int * filter_coeffs = (const int *) malloc(_len_filter_coeffs0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_filter_coeffs0; _i0++) {
            filter_coeffs[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_in0 = 1;
          ...
          residual_filter(out,filter_coeffs,in,subframe_size);
          free(out);
          free(filter_coeffs);
          free(in);
