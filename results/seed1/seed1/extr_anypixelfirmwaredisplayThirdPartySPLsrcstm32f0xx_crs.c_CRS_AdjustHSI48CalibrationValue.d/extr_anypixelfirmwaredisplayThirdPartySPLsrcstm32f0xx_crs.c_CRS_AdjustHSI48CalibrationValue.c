...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          long CRS_HSI48CalibrationValue = 100;
          CRS_AdjustHSI48CalibrationValue(CRS_HSI48CalibrationValue);
    ...
    case 1:
    {
          long CRS_HSI48CalibrationValue = 255;
          CRS_AdjustHSI48CalibrationValue(CRS_HSI48CalibrationValue);
    ...
    case 2:
    {
          long CRS_HSI48CalibrationValue = 10;
          CRS_AdjustHSI48CalibrationValue(CRS_HSI48CalibrationValue);
