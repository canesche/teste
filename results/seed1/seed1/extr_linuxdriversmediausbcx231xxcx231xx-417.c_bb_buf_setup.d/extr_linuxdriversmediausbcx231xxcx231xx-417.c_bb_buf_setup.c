...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          q[_i0].priv_data = (struct cx231xx_fh *) malloc(_len_q__i0__priv_data0*sizeof(struct cx231xx_fh));
          for(int _j0 = 0; _j0 < _len_q__i0__priv_data0; _j0++) {
              int _len_q__i0__priv_data_dev0 = 1;
          q[_i0].priv_data->dev = (struct TYPE_4__ *) malloc(_len_q__i0__priv_data_dev0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_q__i0__priv_data_dev0; _j0++) {
            q[_i0].priv_data->dev->ts1.ts_packet_size = ((-2 * (next_i()%2)) + 1) * next_i();
        q[_i0].priv_data->dev->ts1.ts_packet_count = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_count0 = 1;
          ...
          int benchRet = bb_buf_setup(q,count,size);
          printf("%d\n", benchRet); 
