...
__attribute__((used)) static inline enum ib_port_speed pvrdma_port_speed_to_ib(
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum pvrdma_port_speed speed = 0;
          enum ib_port_speed benchRet = pvrdma_port_speed_to_ib(speed);
