...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_header0 = 1;
          struct TYPE_7__ * header = (struct TYPE_7__ *) malloc(_len_header0*sizeof(struct TYPE_7__));
          for(int _i0 = 0; _i0 < _len_header0; _i0++) {
            header[_i0].ncmds = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_seg0 = 1;
          struct TYPE_6__ * seg = (struct TYPE_6__ *) malloc(_len_seg0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_seg0; _i0++) {
            seg[_i0].cmd = ((-2 * (next_i()%2)) + 1) * next_i();
        seg[_i0].cmdsize = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct TYPE_6__ * benchRet = nextsegfromheader(header,seg);
          printf("%ld\n", (*benchRet).cmd);
          printf("%ld\n", (*benchRet).cmdsize);
          free(header);
          free(seg);
