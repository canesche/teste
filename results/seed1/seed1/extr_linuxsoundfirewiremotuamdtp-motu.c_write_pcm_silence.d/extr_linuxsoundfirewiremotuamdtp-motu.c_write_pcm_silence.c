...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          s[_i0].protocol = (struct amdtp_motu *) malloc(_len_s__i0__protocol0*sizeof(struct amdtp_motu));
          for(int _j0 = 0; _j0 < _len_s__i0__protocol0; _j0++) {
            s[_i0].protocol->pcm_chunks = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].protocol->pcm_byte_offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_buffer0 = 1;
