...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_a00 = 1;
          const void * a0 = (const void *) malloc(_len_a00*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_a00; _i0++) {
            a0[_i0] = 0;
          }
          int _len_b00 = 1;
          const void * b0 = (const void *) malloc(_len_b00*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_b00; _i0++) {
            b0[_i0] = 0;
          }
          int benchRet = window_tree_cmp_pane_time(a0,b0);
          printf("%d\n", benchRet); 
          free(a0);
          free(b0);
