...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        p[_i0].used = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_p__i0__tail0 = 1;
          p[_i0].tail = (int *) malloc(_len_p__i0__tail0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__tail0; _j0++) {
            p[_i0].tail[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        p[_i0].current = ((-2 * (next_i()%2)) + 1) * next_i();
        p[_i0].head = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          BN_POOL_init(p);
