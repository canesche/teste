...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ins0; _i0++) {
            ins[_i0].symbol_table.nsymbols = ((-2 * (next_i()%2)) + 1) * next_i();
        ins[_i0].symbol_table.highest_frag_index = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ins__i0__symbol_table_symbols0 = 1;
          ins[_i0].symbol_table.symbols = (struct TYPE_3__ *) malloc(_len_ins__i0__symbol_table_symbols0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_ins__i0__symbol_table_symbols0; _j0++) {
            ins[_i0].symbol_table.symbols->deleted = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = find_free_symbol_index(ins);
          printf("%d\n", benchRet); 
          free(ins);
