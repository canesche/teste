...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_card0 = 1;
          struct fritzcard * card = (struct fritzcard *) malloc(_len_card0*sizeof(struct fritzcard));
          for(int _i0 = 0; _i0 < _len_card0; _i0++) {
              int _len_card__i0__bch0 = 1;
          card[_i0].bch = (struct TYPE_6__ *) malloc(_len_card__i0__bch0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_card__i0__bch0; _j0++) {
              }
          }
          _set_debug(card);
