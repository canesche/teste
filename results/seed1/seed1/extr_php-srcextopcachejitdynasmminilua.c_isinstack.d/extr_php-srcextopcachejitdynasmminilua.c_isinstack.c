...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_ci0 = 1;
          struct TYPE_3__ * ci = (struct TYPE_3__ *) malloc(_len_ci0*sizeof(struct TYPE_3__));
          ...
          int _len_ci__i0__base0 = 1;
          ci[_i0].base = (int *) malloc(_len_ci__i0__base0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ci__i0__base0; _j0++) {
            ci[_i0].base[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_o0 = 1;
