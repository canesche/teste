...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_memb0 = 1;
          const void * memb = (const void *) malloc(_len_memb0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_memb0; _i0++) {
            memb[_i0] = 0;
          }
          int benchRet = gain_entry_compare(key,memb);
          printf("%d\n", benchRet); 
          free(key);
          free(memb);
