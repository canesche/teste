...
/* Type definitions */
struct TYPE_5__ {TYPE_2__* hcd_cb; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_core_if0; _i0++) {
              int _len_core_if__i0__hcd_cb0 = 1;
          core_if[_i0].hcd_cb = (struct TYPE_6__ *) malloc(_len_core_if__i0__hcd_cb0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_core_if__i0__hcd_cb0; _j0++) {
              }
          }
          int _len_cb0 = 1;
          struct TYPE_6__ * cb = (struct TYPE_6__ *) malloc(_len_cb0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_cb0; _i0++) {
              }
          void * p;
          dwc_otg_cil_register_hcd_callbacks(core_if,cb,p);
          for(int _aux = 0; _aux < _len_core_if0; _aux++) {
          free(core_if[_aux].hcd_cb);
          }
          free(core_if);
          free(cb);
