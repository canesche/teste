...
__attribute__((used)) static inline void qtnf_debugfs_init(struct qtnf_bus *bus, const char *name)
{
}
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_bus0 = 1;
          struct qtnf_bus * bus = (struct qtnf_bus *) malloc(_len_bus0*sizeof(struct qtnf_bus));
