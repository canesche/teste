...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dspi0; _i0++) {
              int _len_dspi__i0__rx0 = 1;
          dspi[_i0].rx = (long *) malloc(_len_dspi__i0__rx0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_dspi__i0__rx0; _j0++) {
            dspi[_i0].rx[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          davinci_spi_rx_buf_u16(data,dspi);
