...
__attribute__((used)) static int snd_rme9652_control_spdif_mask_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ucontrol0; _i0++) {
              int _len_ucontrol__i0__value_iec958_status0 = 1;
          ucontrol[_i0].value.iec958.status = (int *) malloc(_len_ucontrol__i0__value_iec958_status0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ucontrol__i0__value_iec958_status0; _j0++) {
            ucontrol[_i0].value.iec958.status[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = snd_rme9652_control_spdif_mask_get(kcontrol,ucontrol);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(ucontrol);
