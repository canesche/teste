...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_evlist0; _i0++) {
              int _len_evlist__i0__selected0 = 1;
          evlist[_i0].selected = (struct perf_evsel *) malloc(_len_evlist__i0__selected0*sizeof(struct perf_evsel));
          for(int _j0 = 0; _j0 < _len_evlist__i0__selected0; _j0++) {
            evlist[_i0].selected->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_evsel0 = 1;
          ...
          perf_evlist__set_selected(evlist,evsel);
          for(int _aux = 0; _aux < _len_evlist0; _aux++) {
          free(evlist[_aux].selected);
          }
          free(evlist);
          free(evsel);
