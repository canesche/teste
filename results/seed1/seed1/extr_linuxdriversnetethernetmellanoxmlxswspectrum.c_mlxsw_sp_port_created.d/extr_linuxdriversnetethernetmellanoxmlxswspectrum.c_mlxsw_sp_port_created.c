...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_mlxsw_sp0; _i0++) {
              int _len_mlxsw_sp__i0__ports0 = 1;
          mlxsw_sp[_i0].ports = (int **) malloc(_len_mlxsw_sp__i0__ports0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_mlxsw_sp__i0__ports0; _j0++) {
            int _len_mlxsw_sp__i0__ports1 = 1;
            mlxsw_sp[_i0].ports[_j0] = (int *) malloc(_len_mlxsw_sp__i0__ports1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_mlxsw_sp__i0__ports1; _j1++) {
              mlxsw_sp[_i0].ports[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          int benchRet = mlxsw_sp_port_created(mlxsw_sp,local_port);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_mlxsw_sp0; _aux++) {
          free(*(mlxsw_sp[_aux].ports));
        free(mlxsw_sp[_aux].ports);
          }
          free(mlxsw_sp);
