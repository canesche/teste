...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_cfg__i0__tc_config_path0; _j0++) {
            cfg[_i0].tc_config->path->bwg_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_bwgid0 = 1;
          int * bwgid = (int *) malloc(_len_bwgid0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_bwgid0; _i0++) {
            bwgid[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ixgbe_dcb_unpack_bwgid(cfg,direction,bwgid);
