...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_mcfuncs0 = 1;
          int * mcfuncs = (int *) malloc(_len_mcfuncs0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_mcfuncs0; _i0++) {
            mcfuncs[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          bfa_ioc_mbox_register(ioc,mcfuncs);
          free(ioc);
          free(mcfuncs);
