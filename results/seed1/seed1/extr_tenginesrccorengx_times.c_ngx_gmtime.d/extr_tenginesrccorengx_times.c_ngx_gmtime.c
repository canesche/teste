...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tp0; _i0++) {
            tp[_i0].ngx_tm_wday = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].ngx_tm_year = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].ngx_tm_mon = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].ngx_tm_mday = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].ngx_tm_hour = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].ngx_tm_min = ((-2 * (next_i()%2)) + 1) * next_i();
        tp[_i0].ngx_tm_sec = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ngx_gmtime(t,tp);
          free(tp);
