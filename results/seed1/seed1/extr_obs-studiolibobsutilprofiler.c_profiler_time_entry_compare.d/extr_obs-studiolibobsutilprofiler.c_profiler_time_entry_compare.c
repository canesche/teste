...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_first0 = 1;
          const void * first = (const void *) malloc(_len_first0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_first0; _i0++) {
            first[_i0] = 0;
          }
          int _len_second0 = 1;
          const void * second = (const void *) malloc(_len_second0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_second0; _i0++) {
            second[_i0] = 0;
          }
          int benchRet = profiler_time_entry_compare(first,second);
          printf("%d\n", benchRet); 
          free(first);
          free(second);
