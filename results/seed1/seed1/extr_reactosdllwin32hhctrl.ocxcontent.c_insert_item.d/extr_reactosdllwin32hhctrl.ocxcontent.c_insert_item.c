...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          ...
          struct TYPE_5__ * aux_item[10000];
          struct TYPE_5__ * item = _allocate_item(10000, aux_item);
          struct TYPE_5__ * aux_new_item[10000];
          struct TYPE_5__ * new_item = _allocate_new_item(10000, aux_new_item);
          struct TYPE_5__ * benchRet = insert_item(item,new_item,insert_type);
          _delete_item(aux_item, 10000);
          _delete_new_item(aux_new_item, 10000);
