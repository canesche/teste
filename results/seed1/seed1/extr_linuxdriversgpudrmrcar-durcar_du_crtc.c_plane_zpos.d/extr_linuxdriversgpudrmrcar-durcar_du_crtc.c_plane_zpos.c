...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_plane0; _i0++) {
              int _len_plane__i0__plane_state0 = 1;
          plane[_i0].plane.state = (struct TYPE_3__ *) malloc(_len_plane__i0__plane_state0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_plane__i0__plane_state0; _j0++) {
            plane[_i0].plane.state->normalized_zpos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          unsigned int benchRet = plane_zpos(plane);
          printf("%u\n", benchRet); 
          free(plane);
