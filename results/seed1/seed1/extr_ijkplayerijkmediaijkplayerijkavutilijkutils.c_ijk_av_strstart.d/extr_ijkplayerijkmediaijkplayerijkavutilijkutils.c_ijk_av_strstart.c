...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pfx0 = 1;
          const char * pfx = (const char *) malloc(_len_pfx0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_pfx0; _i0++) {
            pfx[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ptr0 = 1;
          const char ** ptr = (const char **) malloc(_len_ptr0*sizeof(const char *));
          for(int _i0 = 0; _i0 < _len_ptr0; _i0++) {
            int _len_ptr1 = 1;
            ptr[_i0] = (const char *) malloc(_len_ptr1*sizeof(const char));
            for(int _i1 = 0; _i1 < _len_ptr1; _i1++) {
              ptr[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int benchRet = ijk_av_strstart(str,pfx,ptr);
          printf("%d\n", benchRet); 
          free(str);
          free(pfx);
