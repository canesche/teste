...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_cptr__i0__info0; _j0++) {
              int _len_cptr__i0__info_desc0 = 1;
          cptr[_i0].info->desc = (const char *) malloc(_len_cptr__i0__info_desc0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_cptr__i0__info_desc0; _j0++) {
            cptr[_i0].info->desc[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          const char * benchRet = pvr2_ctrl_get_desc(cptr);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
