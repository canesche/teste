...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_patch0; _i0++) {
              int _len_patch__i0__nfile_map_data0 = 1;
          patch[_i0].nfile.map.data = (char *) malloc(_len_patch__i0__nfile_map_data0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_patch__i0__nfile_map_data0; _j0++) {
            patch[_i0].nfile.map.data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        patch[_i0].nfile.map.len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          git_patch_generated_new_data(ptr,len,patch);
