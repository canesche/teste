...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_qp0; _i0++) {
            qp[_i0].send_wqe_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        qp[_i0].sq.wqe_shift = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_qp__i0__queue_page_list0 = 1;
          qp[_i0].queue.page_list = (struct TYPE_5__ *) malloc(_len_qp__i0__queue_page_list0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_qp__i0__queue_page_list0; _j0++) {
              }
        qp[_i0].is_direct = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * benchRet = get_send_wqe(qp,n);
          free(qp);
