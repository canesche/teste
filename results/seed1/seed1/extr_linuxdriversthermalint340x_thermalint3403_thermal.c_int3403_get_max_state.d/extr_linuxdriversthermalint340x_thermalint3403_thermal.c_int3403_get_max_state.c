...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          cdev[_i0].devdata = (struct int3403_priv *) malloc(_len_cdev__i0__devdata0*sizeof(struct int3403_priv));
          for(int _j0 = 0; _j0 < _len_cdev__i0__devdata0; _j0++) {
              int _len_cdev__i0__devdata_priv0 = 1;
          cdev[_i0].devdata->priv = (struct int3403_cdev *) malloc(_len_cdev__i0__devdata_priv0*sizeof(struct int3403_cdev));
          for(int _j0 = 0; _j0 < _len_cdev__i0__devdata_priv0; _j0++) {
            cdev[_i0].devdata->priv->max_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_state0 = 1;
          ...
          int benchRet = int3403_get_max_state(cdev,state);
          printf("%d\n", benchRet); 
