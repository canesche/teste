...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_in10 = 1;
          const unsigned char * in1 = (const unsigned char *) malloc(_len_in10*sizeof(const unsigned char));
          for(int _i0 = 0; _i0 < _len_in10; _i0++) {
            in1[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_in20 = 1;
          const unsigned char * in2 = (const unsigned char *) malloc(_len_in20*sizeof(const unsigned char));
