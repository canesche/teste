...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long benchRet = arch_uretprobe_hijack_return_addr(trampoline,regs);
          printf("%lu\n", benchRet); 
