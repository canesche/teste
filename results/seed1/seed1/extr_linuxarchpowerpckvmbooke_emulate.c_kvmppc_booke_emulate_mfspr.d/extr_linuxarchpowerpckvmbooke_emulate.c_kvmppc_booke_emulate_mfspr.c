...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        vcpu[_i0].arch.epr = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.csrr0 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.csrr1 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dsrr0 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dsrr1 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbsr = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.tsr = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.tcr = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        vcpu[_i0].arch.mcsr = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbg_reg.iac1 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbg_reg.iac2 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbg_reg.dac1 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbg_reg.dac2 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbg_reg.dbcr0 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbg_reg.dbcr1 = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.dbg_reg.dbcr2 = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_vcpu__i0__arch_shared0 = 1;
          vcpu[_i0].arch.shared = (struct TYPE_4__ *) malloc(_len_vcpu__i0__arch_shared0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_vcpu__i0__arch_shared0; _j0++) {
            vcpu[_i0].arch.shared->dar = ((-2 * (next_i()%2)) + 1) * next_i();
        vcpu[_i0].arch.shared->esr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        vcpu[_i0].guest_debug = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = kvmppc_booke_emulate_mfspr(vcpu,sprn,spr_val);
          printf("%d\n", benchRet); 
          free(vcpu);
          free(spr_val);
