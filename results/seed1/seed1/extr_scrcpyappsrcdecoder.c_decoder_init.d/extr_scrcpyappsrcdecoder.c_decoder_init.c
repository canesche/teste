...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_decoder0; _i0++) {
              int _len_decoder__i0__video_buffer0 = 1;
          decoder[_i0].video_buffer = (struct video_buffer *) malloc(_len_decoder__i0__video_buffer0*sizeof(struct video_buffer));
          for(int _j0 = 0; _j0 < _len_decoder__i0__video_buffer0; _j0++) {
            decoder[_i0].video_buffer->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_vb0 = 1;
          ...
          decoder_init(decoder,vb);
          for(int _aux = 0; _aux < _len_decoder0; _aux++) {
          free(decoder[_aux].video_buffer);
          }
          free(decoder);
          free(vb);
