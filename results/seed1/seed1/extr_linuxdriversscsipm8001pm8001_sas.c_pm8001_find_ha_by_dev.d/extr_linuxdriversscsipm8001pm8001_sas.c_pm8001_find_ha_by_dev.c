...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dev[_i0].port = (struct TYPE_2__ *) malloc(_len_dev__i0__port0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_dev__i0__port0; _j0++) {
              int _len_dev__i0__port_ha0 = 1;
          dev[_i0].port->ha = (struct sas_ha_struct *) malloc(_len_dev__i0__port_ha0*sizeof(struct sas_ha_struct));
          for(int _j0 = 0; _j0 < _len_dev__i0__port_ha0; _j0++) {
              int _len_dev__i0__port_ha_lldd_ha0 = 1;
          dev[_i0].port->ha->lldd_ha = (struct pm8001_hba_info *) malloc(_len_dev__i0__port_ha_lldd_ha0*sizeof(struct pm8001_hba_info));
          ...
          struct pm8001_hba_info * benchRet = pm8001_find_ha_by_dev(dev);
          printf("%d\n", (*benchRet).dummy);
