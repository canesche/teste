...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_cea0 = 1;
          const int * cea = (const int *) malloc(_len_cea0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_cea0; _i0++) {
            cea[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_start0 = 1;
          ...
          int benchRet = cea_db_offsets(cea,start,end);
          printf("%d\n", benchRet); 
          free(cea);
          free(start);
          free(end);
