...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_h__i0__col_mv0 = 1;
          h[_i0].col_mv = (int *) malloc(_len_h__i0__col_mv0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_h__i0__col_mv0; _j0++) {
            h[_i0].col_mv[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          store_mvs(h);
