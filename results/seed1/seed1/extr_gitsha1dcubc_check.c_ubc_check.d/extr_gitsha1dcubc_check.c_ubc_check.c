...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_W0 = 80;
          int const* W = (int const*) malloc(_len_W0*sizeof(int const));
          for(int _i0 = 0; _i0 < _len_W0; _i0++) {
            W[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dvmask0 = 1;
          int * dvmask = (int *) malloc(_len_dvmask0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_dvmask0; _i0++) {
            dvmask[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ubc_check(W,dvmask);
          free(W);
          free(dvmask);
