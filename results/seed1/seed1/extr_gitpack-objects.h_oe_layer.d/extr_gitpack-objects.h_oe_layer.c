...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pack0; _i0++) {
              int _len_pack__i0__layer0 = 1;
          pack[_i0].layer = (unsigned char *) malloc(_len_pack__i0__layer0*sizeof(unsigned char));
          for(int _j0 = 0; _j0 < _len_pack__i0__layer0; _j0++) {
            pack[_i0].layer[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          unsigned char benchRet = oe_layer(pack,e);
          printf("%c\n", (benchRet %26) + 'a'); 
          for(int _aux = 0; _aux < _len_pack0; _aux++) {
          free(pack[_aux].layer);
          }
          for(int _aux = 0; _aux < _len_pack0; _aux++) {
