...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          file[_i0].private_data = (struct pipe_inode_info *) malloc(_len_file__i0__private_data0*sizeof(struct pipe_inode_info));
          ...
          struct pipe_inode_info * benchRet = get_pipe_info(file);
          printf("%d\n", (*benchRet).dummy);
