...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = Lzma2State_ResetOutBuf(p,outBuf,outBufSize);
          printf("%d\n", benchRet); 
          free(p);
          free(outBuf);
