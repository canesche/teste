...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
              int _len_s__i0__quant_matrix0 = 1;
          s[_i0].quant_matrix = (int *) malloc(_len_s__i0__quant_matrix0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_s__i0__quant_matrix0; _j0++) {
            s[_i0].quant_matrix[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          calc_quant_matrix(s,qscale);
          for(int _aux = 0; _aux < _len_s0; _aux++) {
          free(s[_aux].quant_matrix);
          }
          free(s);
