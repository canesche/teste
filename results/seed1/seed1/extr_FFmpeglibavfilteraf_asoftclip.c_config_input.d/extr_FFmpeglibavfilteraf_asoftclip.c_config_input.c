...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_inlink0 = 1;
          struct TYPE_5__ * inlink = (struct TYPE_5__ *) malloc(_len_inlink0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_inlink0; _i0++) {
            inlink[_i0].format = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_inlink__i0__dst0 = 1;
          inlink[_i0].dst = (struct TYPE_6__ *) malloc(_len_inlink__i0__dst0*sizeof(struct TYPE_6__));
          ...
          for(int _j0 = 0; _j0 < _len_inlink__i0__dst_priv0; _j0++) {
            inlink[_i0].dst->priv->filter = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
