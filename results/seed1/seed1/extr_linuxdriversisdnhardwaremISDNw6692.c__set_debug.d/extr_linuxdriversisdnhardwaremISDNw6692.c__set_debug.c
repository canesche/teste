...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_card0 = 1;
          struct w6692_hw * card = (struct w6692_hw *) malloc(_len_card0*sizeof(struct w6692_hw));
          for(int _i0 = 0; _i0 < _len_card0; _i0++) {
              int _len_card__i0__bc0 = 1;
          card[_i0].bc = (struct TYPE_6__ *) malloc(_len_card__i0__bc0*sizeof(struct TYPE_6__));
