...
__attribute__((used)) static void premultiply8(const uint8_t *msrc, const uint8_t *asrc,
                         uint8_t *dst,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          premultiply8(msrc,asrc,dst,mlinesize,alinesize,dlinesize,w,h,half,shift,offset);
          free(msrc);
          free(asrc);
          free(dst);
