...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_qdio__i0__req_q__j0__element0; _j0++) {
            qdio[_i0].req_q[_j0]->element->scount = ((-2 * (next_i()%2)) + 1) * next_i();
          }
            }
          }
          }
          ...
          for(int _i0 = 0; _i0 < _len_q_req0; _i0++) {
            q_req[_i0].sbal_first = ((-2 * (next_i()%2)) + 1) * next_i();
        q_req[_i0].sbal_number = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          zfcp_qdio_set_scount(qdio,q_req);
