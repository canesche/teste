...
__attribute__((used)) static int snd_usX2Y_usbpcm_close(struct snd_pcm_substream *substream)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          substream[_i0].runtime->private_data = (struct snd_usX2Y_substream *) malloc(_len_substream__i0__runtime_private_data0*sizeof(struct snd_usX2Y_substream));
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime_private_data0; _j0++) {
              int _len_substream__i0__runtime_private_data_pcm_substream0 = 1;
          substream[_i0].runtime->private_data->pcm_substream = (int *) malloc(_len_substream__i0__runtime_private_data_pcm_substream0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime_private_data_pcm_substream0; _j0++) {
            substream[_i0].runtime->private_data->pcm_substream[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          int benchRet = snd_usX2Y_usbpcm_close(substream);
          printf("%d\n", benchRet); 
