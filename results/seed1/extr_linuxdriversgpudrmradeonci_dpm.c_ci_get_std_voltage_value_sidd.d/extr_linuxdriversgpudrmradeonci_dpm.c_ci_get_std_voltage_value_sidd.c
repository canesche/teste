...
__attribute__((used)) static int ci_get_std_voltage_value_sidd(struct radeon_device *rdev,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rdev0; _i0++) {
            rdev[_i0].pm.dpm.dyn_state.cac_leakage_table.count = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_rdev__i0__pm_dpm_dyn_state_cac_leakage_table_entries0 = 1;
          rdev[_i0].pm.dpm.dyn_state.cac_leakage_table.entries = (struct TYPE_10__ *) malloc(_len_rdev__i0__pm_dpm_dyn_state_cac_leakage_table_entries0*sizeof(struct TYPE_10__));
          for(int _j0 = 0; _j0 < _len_rdev__i0__pm_dpm_dyn_state_cac_leakage_table_entries0; _j0++) {
            rdev[_i0].pm.dpm.dyn_state.cac_leakage_table.entries->vddc = ((-2 * (next_i()%2)) + 1) * next_i();
        rdev[_i0].pm.dpm.dyn_state.cac_leakage_table.entries->leakage = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        rdev[_i0].pm.dpm.dyn_state.vddc_dependency_on_sclk.count = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_rdev__i0__pm_dpm_dyn_state_vddc_dependency_on_sclk_entries0 = 1;
          rdev[_i0].pm.dpm.dyn_state.vddc_dependency_on_sclk.entries = (struct TYPE_8__ *) malloc(_len_rdev__i0__pm_dpm_dyn_state_vddc_dependency_on_sclk_entries0*sizeof(struct TYPE_8__));
          for(int _j0 = 0; _j0 < _len_rdev__i0__pm_dpm_dyn_state_vddc_dependency_on_sclk_entries0; _j0++) {
            rdev[_i0].pm.dpm.dyn_state.vddc_dependency_on_sclk.entries->v = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          int benchRet = ci_get_std_voltage_value_sidd(rdev,voltage_table,std_voltage_hi_sidd,std_voltage_lo_sidd);
          printf("%d\n", benchRet); 
          free(rdev);
          free(voltage_table);
