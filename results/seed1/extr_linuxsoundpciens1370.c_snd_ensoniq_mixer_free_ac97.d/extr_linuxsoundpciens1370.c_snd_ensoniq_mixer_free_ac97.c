...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ac97[_i0].private_data = (struct ensoniq *) malloc(_len_ac97__i0__private_data0*sizeof(struct ensoniq));
          for(int _j0 = 0; _j0 < _len_ac97__i0__private_data0; _j0++) {
              int _len_ac97__i0__private_data_u_es1371_ac970 = 1;
          ac97[_i0].private_data->u.es1371.ac97 = (int *) malloc(_len_ac97__i0__private_data_u_es1371_ac970*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ac97__i0__private_data_u_es1371_ac970; _j0++) {
            ac97[_i0].private_data->u.es1371.ac97[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          snd_ensoniq_mixer_free_ac97(ac97);
