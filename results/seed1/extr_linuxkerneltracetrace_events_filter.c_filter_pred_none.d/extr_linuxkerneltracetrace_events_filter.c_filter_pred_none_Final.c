...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_pred0 = 1;
          struct filter_pred * pred = (struct filter_pred *) malloc(_len_pred0*sizeof(struct filter_pred));
          for(int _i0 = 0; _i0 < _len_pred0; _i0++) {
            pred[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * event;
          int benchRet = filter_pred_none(pred,event);
          printf("%d\n", benchRet); 
          free(pred);
