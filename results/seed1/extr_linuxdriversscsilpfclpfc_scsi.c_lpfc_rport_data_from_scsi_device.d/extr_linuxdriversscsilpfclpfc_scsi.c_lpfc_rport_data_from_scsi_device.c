...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sdev0; _i0++) {
            sdev[_i0].hostdata = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_sdev__i0__host0 = 1;
          sdev[_i0].host = (struct TYPE_3__ *) malloc(_len_sdev__i0__host0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_sdev__i0__host0; _j0++) {
            sdev[_i0].host->hostdata = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct lpfc_rport_data * benchRet = lpfc_rport_data_from_scsi_device(sdev);
          printf("%d\n", (*benchRet).dummy);
