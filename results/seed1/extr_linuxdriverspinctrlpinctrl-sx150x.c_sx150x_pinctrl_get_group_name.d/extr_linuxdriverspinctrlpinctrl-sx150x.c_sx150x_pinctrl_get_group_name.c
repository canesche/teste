...
__attribute__((used)) static const char *sx150x_pinctrl_get_group_name(struct pinctrl_dev *pctldev,
						unsigned int group)
{
	return NULL;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          const char * benchRet = sx150x_pinctrl_get_group_name(pctldev,group);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          free(pctldev);
