...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_context__i0__count0 = 1;
          context[_i0].count = (long *) malloc(_len_context__i0__count0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_context__i0__count0; _j0++) {
            context[_i0].count[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          cs_sha1_init(context);
          for(int _aux = 0; _aux < _len_context0; _aux++) {
          free(context[_aux].state);
          }
          for(int _aux = 0; _aux < _len_context0; _aux++) {
          free(context[_aux].count);
          }
          free(context);
