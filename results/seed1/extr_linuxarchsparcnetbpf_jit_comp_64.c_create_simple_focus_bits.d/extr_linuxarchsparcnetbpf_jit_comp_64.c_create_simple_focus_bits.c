...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long high_bits = 100;
          unsigned long low_bits = 100;
          int lowest_bit_set = 100;
          int shift = 100;
    ...
    case 1:
    {
          unsigned long high_bits = 255;
          unsigned long low_bits = 255;
          int lowest_bit_set = 255;
          int shift = 255;
          unsigned long benchRet = create_simple_focus_bits(high_bits,low_bits,lowest_bit_set,shift);
          printf("%lu\n", benchRet); 
