...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
            p[_i0].p.Read = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_p__i0__StateCoder_p0 = 1;
          p[_i0].StateCoder.p = (int *) malloc(_len_p__i0__StateCoder_p0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__StateCoder_p0; _j0++) {
            p[_i0].StateCoder.p[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
