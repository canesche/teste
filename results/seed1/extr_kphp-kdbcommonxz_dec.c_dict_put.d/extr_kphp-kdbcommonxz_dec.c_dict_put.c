...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        dict[_i0].full = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_dict__i0__buf0 = 1;
          dict[_i0].buf = (int *) malloc(_len_dict__i0__buf0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dict__i0__buf0; _j0++) {
            dict[_i0].buf[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          dict_put(dict,byte);
