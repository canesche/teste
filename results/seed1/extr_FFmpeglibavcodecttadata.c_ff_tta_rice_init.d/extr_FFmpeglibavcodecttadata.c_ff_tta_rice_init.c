...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long k0 = 100;
          unsigned long k1 = 100;
          int _len_c0 = 1;
          struct TYPE_3__ * c = (struct TYPE_3__ *) malloc(_len_c0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c[_i0].k0 = ((-2 * (next_i()%2)) + 1) * next_i();
        c[_i0].k1 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ff_tta_rice_init(c,k0,k1);
          free(c);
    ...
    case 1:
    {
          unsigned long k0 = 255;
          unsigned long k1 = 255;
          int _len_c0 = 65025;
          struct TYPE_3__ * c = (struct TYPE_3__ *) malloc(_len_c0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c[_i0].k0 = ((-2 * (next_i()%2)) + 1) * next_i();
