...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        ctx[_i0].priv->step = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          ctx[_i0].priv->lut = (int **) malloc(_len_ctx__i0__priv_lut0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_ctx__i0__priv_lut0; _j0++) {
            int _len_ctx__i0__priv_lut1 = 1;
            ctx[_i0].priv->lut[_j0] = (int *) malloc(_len_ctx__i0__priv_lut1*sizeof(int));
          ...
          void * arg;
          int benchRet = apply_lut8(ctx,arg,jobnr,nb_jobs);
          printf("%d\n", benchRet); 
