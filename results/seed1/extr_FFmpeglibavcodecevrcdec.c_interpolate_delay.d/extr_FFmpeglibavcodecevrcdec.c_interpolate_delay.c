...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          float current = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          float prev = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          int index = 100;
          int _len_dst0 = 1;
          ...
          interpolate_delay(dst,current,prev,index);
          free(dst);
