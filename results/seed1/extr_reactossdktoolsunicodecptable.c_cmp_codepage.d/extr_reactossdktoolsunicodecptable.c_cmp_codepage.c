...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int _len_codepage0 = 1;
          const void * codepage = (const void *) malloc(_len_codepage0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_codepage0; _i0++) {
            codepage[_i0] = 0;
          }
          int _len_entry0 = 1;
          ...
          int benchRet = cmp_codepage(codepage,entry);
          printf("%d\n", benchRet); 
          free(codepage);
          free(entry);
