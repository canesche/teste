...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum wined3d_texture_filter_type min_filter = 0;
          enum wined3d_texture_filter_type mip_filter = 0;
          int benchRet = wined3d_gl_min_mip_filter(min_filter,mip_filter);
          printf("%d\n", benchRet); 
