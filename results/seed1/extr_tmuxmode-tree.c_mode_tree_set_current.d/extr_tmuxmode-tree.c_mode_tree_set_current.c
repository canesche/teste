...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        mtd[_i0].offset = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          mtd[_i0].line_list = (struct TYPE_4__ *) malloc(_len_mtd__i0__line_list0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_mtd__i0__line_list0; _j0++) {
              int _len_mtd__i0__line_list_item0 = 1;
          mtd[_i0].line_list->item = (struct TYPE_3__ *) malloc(_len_mtd__i0__line_list_item0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_mtd__i0__line_list_item0; _j0++) {
            mtd[_i0].line_list->item->tag = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
