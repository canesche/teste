...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_bank__i0__drvdata_ctrl0; _j0++) {
            bank[_i0].drvdata->ctrl->niomux_recalced = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_bank__i0__drvdata_ctrl_iomux_recalced0 = 1;
          bank[_i0].drvdata->ctrl->iomux_recalced = (struct rockchip_mux_recalced_data *) malloc(_len_bank__i0__drvdata_ctrl_iomux_recalced0*sizeof(struct rockchip_mux_recalced_data));
          for(int _j0 = 0; _j0 < _len_bank__i0__drvdata_ctrl_iomux_recalced0; _j0++) {
            bank[_i0].drvdata->ctrl->iomux_recalced->num = ((-2 * (next_i()%2)) + 1) * next_i();
        bank[_i0].drvdata->ctrl->iomux_recalced->pin = ((-2 * (next_i()%2)) + 1) * next_i();
        bank[_i0].drvdata->ctrl->iomux_recalced->reg = ((-2 * (next_i()%2)) + 1) * next_i();
        bank[_i0].drvdata->ctrl->iomux_recalced->mask = ((-2 * (next_i()%2)) + 1) * next_i();
        bank[_i0].drvdata->ctrl->iomux_recalced->bit = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
