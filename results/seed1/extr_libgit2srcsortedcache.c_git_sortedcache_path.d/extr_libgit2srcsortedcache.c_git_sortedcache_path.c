...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sc0; _i0++) {
              int _len_sc__i0__path0 = 1;
          sc[_i0].path = (const char *) malloc(_len_sc__i0__path0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_sc__i0__path0; _j0++) {
            sc[_i0].path[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = git_sortedcache_path(sc);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
