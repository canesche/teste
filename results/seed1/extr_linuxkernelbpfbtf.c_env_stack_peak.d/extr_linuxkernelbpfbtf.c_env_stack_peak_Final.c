...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          env[_i0].stack = (const struct resolve_vertex *) malloc(_len_env__i0__stack0*sizeof(const struct resolve_vertex));
          for(int _j0 = 0; _j0 < _len_env__i0__stack0; _j0++) {
              }
          }
          const struct resolve_vertex * benchRet = env_stack_peak(env);
