...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          net.input = (float *) malloc(_len_net_input0*sizeof(float));
          for(int _j0 = 0; _j0 < _len_net_input0; _j0++) {
            net.input[_j0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
