...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vq[_i0].priv_data = (struct zr364xx_camera *) malloc(_len_vq__i0__priv_data0*sizeof(struct zr364xx_camera));
          for(int _j0 = 0; _j0 < _len_vq__i0__priv_data0; _j0++) {
            vq[_i0].priv_data->width = ((-2 * (next_i()%2)) + 1) * next_i();
        vq[_i0].priv_data->height = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_vq__i0__priv_data_fmt0 = 1;
          vq[_i0].priv_data->fmt = (struct TYPE_2__ *) malloc(_len_vq__i0__priv_data_fmt0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_vq__i0__priv_data_fmt0; _j0++) {
            vq[_i0].priv_data->fmt->depth = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_count0 = 1;
          ...
          int benchRet = buffer_setup(vq,count,size);
          printf("%d\n", benchRet); 
