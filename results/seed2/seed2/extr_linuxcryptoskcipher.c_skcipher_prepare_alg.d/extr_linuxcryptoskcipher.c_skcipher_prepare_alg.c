...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_alg0 = 1;
          struct skcipher_alg * alg = (struct skcipher_alg *) malloc(_len_alg0*sizeof(struct skcipher_alg));
          for(int _i0 = 0; _i0 < _len_alg0; _i0++) {
            alg[_i0].ivsize = ((-2 * (next_i()%2)) + 1) * next_i();
        alg[_i0].chunksize = ((-2 * (next_i()%2)) + 1) * next_i();
        alg[_i0].walksize = ((-2 * (next_i()%2)) + 1) * next_i();
        alg[_i0].base.cra_blocksize = ((-2 * (next_i()%2)) + 1) * next_i();
        alg[_i0].base.cra_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = skcipher_prepare_alg(alg);
          printf("%d\n", benchRet); 
          free(alg);
