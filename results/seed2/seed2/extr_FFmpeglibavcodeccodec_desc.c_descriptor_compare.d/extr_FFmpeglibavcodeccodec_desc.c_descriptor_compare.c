...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_member0 = 1;
          const void * member = (const void *) malloc(_len_member0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_member0; _i0++) {
            member[_i0] = 0;
          }
          int benchRet = descriptor_compare(key,member);
          printf("%d\n", benchRet); 
          free(key);
          free(member);
