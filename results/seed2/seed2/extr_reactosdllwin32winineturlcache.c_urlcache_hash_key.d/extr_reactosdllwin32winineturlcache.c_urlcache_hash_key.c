...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_lpszKey0 = 1;
          int * lpszKey = (int *) malloc(_len_lpszKey0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_lpszKey0; _i0++) {
            lpszKey[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = urlcache_hash_key(lpszKey);
          printf("%d\n", benchRet); 
          free(lpszKey);
