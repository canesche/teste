...
__attribute__((used)) static inline uint32_t read_IRQreg_idr(struct openpic *opp, int n_IRQ)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_opp__i0__src0; _j0++) {
            opp[_i0].src->idr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = read_IRQreg_idr(opp,n_IRQ);
          printf("%d\n", benchRet); 
