...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_pair0 = 1;
          struct TYPE_3__ * pair = (struct TYPE_3__ *) malloc(_len_pair0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_pair0; _i0++) {
            pair[_i0].pair_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * data;
          int benchRet = find_pair_id_helper(idx,pair,data);
          printf("%d\n", benchRet); 
          free(pair);
