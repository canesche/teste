...
__attribute__((used)) static int snd_rme96_control_spdif_mask_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = snd_rme96_control_spdif_mask_get(kcontrol,ucontrol);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(ucontrol);
