...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        sb[_i0].sb_cc = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_xsb0 = 1;
          struct xsockbuf * xsb = (struct xsockbuf *) malloc(_len_xsb0*sizeof(struct xsockbuf));
          for(int _i0 = 0; _i0 < _len_xsb0; _i0++) {
            xsb[_i0].sb_timeo = ((-2 * (next_i()%2)) + 1) * next_i();
        xsb[_i0].sb_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        xsb[_i0].sb_lowat = ((-2 * (next_i()%2)) + 1) * next_i();
        xsb[_i0].sb_mbmax = ((-2 * (next_i()%2)) + 1) * next_i();
        xsb[_i0].sb_mbcnt = ((-2 * (next_i()%2)) + 1) * next_i();
        xsb[_i0].sb_hiwat = ((-2 * (next_i()%2)) + 1) * next_i();
        xsb[_i0].sb_cc = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          sbtoxsockbuf(sb,xsb);
          free(sb);
          free(xsb);
