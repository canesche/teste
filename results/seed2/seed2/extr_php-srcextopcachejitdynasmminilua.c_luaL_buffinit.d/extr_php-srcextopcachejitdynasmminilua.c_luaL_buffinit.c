...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_B0; _i0++) {
            B[_i0].lvl = ((-2 * (next_i()%2)) + 1) * next_i();
        B[_i0].buffer = ((-2 * (next_i()%2)) + 1) * next_i();
        B[_i0].p = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_B__i0__L0 = 1;
          B[_i0].L = (int *) malloc(_len_B__i0__L0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_B__i0__L0; _j0++) {
            B[_i0].L[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          luaL_buffinit(L,B);
          free(L);
