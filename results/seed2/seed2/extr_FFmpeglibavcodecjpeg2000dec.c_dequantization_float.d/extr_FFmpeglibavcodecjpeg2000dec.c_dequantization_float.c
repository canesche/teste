...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_comp0; _i0++) {
              int _len_comp__i0__f_data0 = 1;
          comp[_i0].f_data = (float *) malloc(_len_comp__i0__f_data0*sizeof(float));
          for(int _j0 = 0; _j0 < _len_comp__i0__f_data0; _j0++) {
            comp[_i0].f_data[_j0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
        ...
        t1[_i0].stride = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_band0; _i0++) {
            band[_i0].f_stepsize = ((-2 * (next_i()%2)) + 1) * next_i();
          }
