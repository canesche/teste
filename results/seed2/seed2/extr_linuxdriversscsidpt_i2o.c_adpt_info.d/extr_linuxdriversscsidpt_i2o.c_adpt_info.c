...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_host0; _i0++) {
              int _len_host__i0__hostdata0 = 1;
          host[_i0].hostdata = (long *) malloc(_len_host__i0__hostdata0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_host__i0__hostdata0; _j0++) {
            host[_i0].hostdata[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = adpt_info(host);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          for(int _aux = 0; _aux < _len_host0; _aux++) {
          free(host[_aux].hostdata);
          }
          free(host);
