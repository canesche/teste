...
__attribute__((used)) static void ZSTD_compressBlock_btopt2_extDict(ZSTD_CCtx *ctx, const void *src, size_t srcSize)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ZSTD_compressBlock_btopt2_extDict(ctx,src,srcSize);
          free(ctx);
          free(src);
