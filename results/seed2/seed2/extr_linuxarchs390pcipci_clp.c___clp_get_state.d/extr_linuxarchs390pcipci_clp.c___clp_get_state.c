...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_entry0 = 1;
          struct clp_fh_list_entry * entry = (struct clp_fh_list_entry *) malloc(_len_entry0*sizeof(struct clp_fh_list_entry));
          for(int _i0 = 0; _i0 < _len_entry0; _i0++) {
            entry[_i0].fid = ((-2 * (next_i()%2)) + 1) * next_i();
        entry[_i0].config_state = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * data;
          __clp_get_state(entry,data);
          free(entry);
