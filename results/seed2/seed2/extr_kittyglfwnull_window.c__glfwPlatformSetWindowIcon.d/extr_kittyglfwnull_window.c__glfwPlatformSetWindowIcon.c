...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_images0 = 1;
          const int * images = (const int *) malloc(_len_images0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_images0; _i0++) {
            images[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
