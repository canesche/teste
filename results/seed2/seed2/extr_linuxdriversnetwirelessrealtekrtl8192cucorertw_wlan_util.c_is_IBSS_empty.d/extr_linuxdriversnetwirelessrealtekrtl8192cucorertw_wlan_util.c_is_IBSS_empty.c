...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_5__ * padapter = (struct TYPE_5__ *) malloc(_len_padapter0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_padapter0; _i0++) {
              int _len_padapter__i0__mlmeextpriv_mlmext_info_FW_sta_info0 = 1;
          padapter[_i0].mlmeextpriv.mlmext_info.FW_sta_info = (struct TYPE_4__ *) malloc(_len_padapter__i0__mlmeextpriv_mlmext_info_FW_sta_info0*sizeof(struct TYPE_4__));
          ...
          int benchRet = is_IBSS_empty(padapter);
          printf("%d\n", benchRet); 
          free(padapter);
