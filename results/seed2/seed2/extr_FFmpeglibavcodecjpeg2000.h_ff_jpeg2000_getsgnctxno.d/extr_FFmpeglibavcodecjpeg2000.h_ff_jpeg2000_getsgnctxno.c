...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int flag = 100;
          int _len_xorbit0 = 1;
          int * xorbit = (int *) malloc(_len_xorbit0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_xorbit0; _i0++) {
            xorbit[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ff_jpeg2000_getsgnctxno(flag,xorbit);
          printf("%d\n", benchRet); 
          free(xorbit);
