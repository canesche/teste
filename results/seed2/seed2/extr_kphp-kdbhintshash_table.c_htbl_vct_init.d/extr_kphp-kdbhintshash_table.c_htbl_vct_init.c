...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_table0; _i0++) {
              int _len_table__i0__h0 = 1;
          table[_i0].h = (int *) malloc(_len_table__i0__h0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_table__i0__h0; _j0++) {
            table[_i0].h[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
