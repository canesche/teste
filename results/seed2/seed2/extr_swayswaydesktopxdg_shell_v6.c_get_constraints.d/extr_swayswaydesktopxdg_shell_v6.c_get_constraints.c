...
/* Type definitions */
struct wlr_xdg_toplevel_v6_state {double min_width; double max_width; double min_height; double max_height; } ;
struct sway_view {TYPE_2__* wlr_xdg_surface_v6; } ;
struct TYPE_4__ {TYPE_1__* toplevel; } ;
struct TYPE_3__ {struct wlr_xdg_toplevel_v6_state current; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          view[_i0].wlr_xdg_surface_v6 = (struct TYPE_4__ *) malloc(_len_view__i0__wlr_xdg_surface_v60*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_view__i0__wlr_xdg_surface_v60; _j0++) {
              int _len_view__i0__wlr_xdg_surface_v6_toplevel0 = 1;
          view[_i0].wlr_xdg_surface_v6->toplevel = (struct TYPE_3__ *) malloc(_len_view__i0__wlr_xdg_surface_v6_toplevel0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_view__i0__wlr_xdg_surface_v6_toplevel0; _j0++) {
            view[_i0].wlr_xdg_surface_v6->toplevel->current.min_width = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        view[_i0].wlr_xdg_surface_v6->toplevel->current.max_width = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        view[_i0].wlr_xdg_surface_v6->toplevel->current.min_height = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
        view[_i0].wlr_xdg_surface_v6->toplevel->current.max_height = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          }
          }
