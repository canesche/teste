...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          substream[_i0].runtime = (struct TYPE_3__ *) malloc(_len_substream__i0__runtime0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime0; _j0++) {
              int _len_substream__i0__runtime_private_data0 = 1;
          substream[_i0].runtime->private_data = (int *) malloc(_len_substream__i0__runtime_private_data0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime_private_data0; _j0++) {
            substream[_i0].runtime->private_data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = snd_vortex_pcm_close(substream);
          printf("%d\n", benchRet); 
