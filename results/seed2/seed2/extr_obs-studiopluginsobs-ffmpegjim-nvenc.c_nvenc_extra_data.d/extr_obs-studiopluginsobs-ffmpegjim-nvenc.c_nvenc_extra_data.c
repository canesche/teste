...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_header0; _i0++) {
            int _len_header1 = 1;
            header[_i0] = (int *) malloc(_len_header1*sizeof(int));
            for(int _i1 = 0; _i1 < _len_header1; _i1++) {
              header[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int _len_size0 = 1;
          ...
          int benchRet = nvenc_extra_data(data,header,size);
          printf("%d\n", benchRet); 
          for(int i1 = 0; i1 < _len_header0; i1++) {
            int _len_header1 = 1;
              free(header[i1]);
          }
          free(header);
