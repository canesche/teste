...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int shift = 100;
          int _len_bbsrc0 = 1;
          const int * bbsrc = (const int *) malloc(_len_bbsrc0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_bbsrc0; _i0++) {
            bbsrc[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_oosrc0 = 1;
          const int * oosrc = (const int *) malloc(_len_oosrc0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_oosrc0; _i0++) {
            oosrc[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_mmsrc0 = 1;
          ...
          maskedmerge16(bbsrc,oosrc,mmsrc,ddst,blinesize,olinesize,mlinesize,dlinesize,w,h,half,shift);
          free(bbsrc);
          free(oosrc);
          free(mmsrc);
          free(ddst);
    ...
    case 1:
    {
          ...
          int half = 255;
          int shift = 255;
          int _len_bbsrc0 = 65025;
          const int * bbsrc = (const int *) malloc(_len_bbsrc0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_bbsrc0; _i0++) {
            bbsrc[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_oosrc0 = 65025;
          const int * oosrc = (const int *) malloc(_len_oosrc0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_oosrc0; _i0++) {
            oosrc[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
