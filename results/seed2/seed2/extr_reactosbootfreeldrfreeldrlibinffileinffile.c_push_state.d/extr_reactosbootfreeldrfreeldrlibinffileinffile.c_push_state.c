...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_parser0; _i0++) {
              int _len_parser__i0__stack0 = 1;
          parser[_i0].stack = (int *) malloc(_len_parser__i0__stack0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_parser__i0__stack0; _j0++) {
            parser[_i0].stack[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        parser[_i0].stack_pos = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          push_state(parser,state);
          for(int _aux = 0; _aux < _len_parser0; _aux++) {
          free(parser[_aux].stack);
          }
          free(parser);
