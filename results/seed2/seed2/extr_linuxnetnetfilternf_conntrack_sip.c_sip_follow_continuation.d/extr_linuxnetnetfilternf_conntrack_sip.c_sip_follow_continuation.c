...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_dptr0 = 1;
          const char * dptr = (const char *) malloc(_len_dptr0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_dptr0; _i0++) {
            dptr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_limit0 = 1;
          const char * limit = (const char *) malloc(_len_limit0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_limit0; _i0++) {
            limit[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          const char * benchRet = sip_follow_continuation(dptr,limit);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          free(dptr);
          free(limit);
