...
__attribute__((used)) static int dummy_encoding_lexer_compatibility_checker(const zend_encoding *encoding)
{
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = dummy_encoding_lexer_compatibility_checker(encoding);
          printf("%d\n", benchRet); 
          free(encoding);
