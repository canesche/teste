...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_distances0 = 1;
          int * distances = (int *) malloc(_len_distances0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_distances0; _i0++) {
            distances[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = GetMatchesSpec1(lenLimit,curMatch,pos,cur,son,_cyclicBufferPos,_cyclicBufferSize,cutValue,distances,maxLen);
          printf("%d\n", (*benchRet)); 
          free(cur);
          free(son);
          free(distances);
