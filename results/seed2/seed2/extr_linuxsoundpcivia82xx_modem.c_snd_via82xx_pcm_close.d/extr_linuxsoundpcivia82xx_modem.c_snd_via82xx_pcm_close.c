...
/* Type definitions */
struct viadev {int /*<<< orphan*/ * substream; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          substream[_i0].runtime->private_data = (struct viadev *) malloc(_len_substream__i0__runtime_private_data0*sizeof(struct viadev));
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime_private_data0; _j0++) {
              int _len_substream__i0__runtime_private_data_substream0 = 1;
          substream[_i0].runtime->private_data->substream = (int *) malloc(_len_substream__i0__runtime_private_data_substream0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_substream__i0__runtime_private_data_substream0; _j0++) {
            substream[_i0].runtime->private_data->substream[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          int benchRet = snd_via82xx_pcm_close(substream);
          printf("%d\n", benchRet); 
