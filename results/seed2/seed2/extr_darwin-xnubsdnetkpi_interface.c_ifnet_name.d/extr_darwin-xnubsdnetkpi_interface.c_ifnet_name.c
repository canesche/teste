...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_interface0; _i0++) {
              int _len_interface__i0__if_name0 = 1;
          interface[_i0].if_name = (const char *) malloc(_len_interface__i0__if_name0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_interface__i0__if_name0; _j0++) {
            interface[_i0].if_name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = ifnet_name(interface);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          for(int _aux = 0; _aux < _len_interface0; _aux++) {
          free(interface[_aux].if_name);
          }
          free(interface);
