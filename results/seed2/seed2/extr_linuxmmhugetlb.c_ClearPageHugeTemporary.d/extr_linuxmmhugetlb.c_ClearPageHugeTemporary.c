...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_page0; _i0++) {
              int _len_page__i0__mapping0 = 1;
          page[_i0].mapping = (int *) malloc(_len_page__i0__mapping0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_page__i0__mapping0; _j0++) {
            page[_i0].mapping[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ClearPageHugeTemporary(page);
          for(int _aux = 0; _aux < _len_page0; _aux++) {
          free(page[_aux].mapping);
          }
          free(page);
