...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_card0 = 1;
          struct sfax_hw * card = (struct sfax_hw *) malloc(_len_card0*sizeof(struct sfax_hw));
          for(int _i0 = 0; _i0 < _len_card0; _i0++) {
              int _len_card__i0__isar_ch0 = 1;
          card[_i0].isar.ch = (struct TYPE_9__ *) malloc(_len_card__i0__isar_ch0*sizeof(struct TYPE_9__));
          for(int _j0 = 0; _j0 < _len_card__i0__isar_ch0; _j0++) {
              }
          }
          _set_debug(card);
          free(card);
