...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_msg0; _i0++) {
              int _len_msg__i0__security0 = 1;
          msg[_i0].security = (int *) malloc(_len_msg__i0__security0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_msg__i0__security0; _j0++) {
            msg[_i0].security[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          smack_msg_msg_free_security(msg);
          for(int _aux = 0; _aux < _len_msg0; _aux++) {
          free(msg[_aux].security);
          }
          free(msg);
