...
__attribute__((used)) static void seatHandleName(void* data,
                           struct wl_seat* seat,
                           const char* name)
{
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          void * data;
          int _len_seat0 = 1;
          struct wl_seat * seat = (struct wl_seat *) malloc(_len_seat0*sizeof(struct wl_seat));
          for(int _i0 = 0; _i0 < _len_seat0; _i0++) {
            seat[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_name0 = 1;
