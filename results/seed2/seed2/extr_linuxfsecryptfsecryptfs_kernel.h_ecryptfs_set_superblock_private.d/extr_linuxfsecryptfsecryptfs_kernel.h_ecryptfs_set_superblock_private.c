...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          sb[_i0].s_fs_info = (struct ecryptfs_sb_info *) malloc(_len_sb__i0__s_fs_info0*sizeof(struct ecryptfs_sb_info));
          for(int _j0 = 0; _j0 < _len_sb__i0__s_fs_info0; _j0++) {
            sb[_i0].s_fs_info->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_sb_info0 = 1;
          struct ecryptfs_sb_info * sb_info = (struct ecryptfs_sb_info *) malloc(_len_sb_info0*sizeof(struct ecryptfs_sb_info));
          for(int _i0 = 0; _i0 < _len_sb_info0; _i0++) {
            sb_info[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ecryptfs_set_superblock_private(sb,sb_info);
