...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_starget0 = 1;
          struct scsi_target * starget = (struct scsi_target *) malloc(_len_starget0*sizeof(struct scsi_target));
          for(int _i0 = 0; _i0 < _len_starget0; _i0++) {
            starget[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          mptsas_set_starget(phy_info,starget);
