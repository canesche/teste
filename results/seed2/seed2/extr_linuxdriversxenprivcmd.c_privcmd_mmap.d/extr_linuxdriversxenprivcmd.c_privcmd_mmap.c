...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vma[_i0].vm_private_data = (int *) malloc(_len_vma__i0__vm_private_data0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_vma__i0__vm_private_data0; _j0++) {
            vma[_i0].vm_private_data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          int benchRet = privcmd_mmap(file,vma);
          printf("%d\n", benchRet); 
          free(file);
