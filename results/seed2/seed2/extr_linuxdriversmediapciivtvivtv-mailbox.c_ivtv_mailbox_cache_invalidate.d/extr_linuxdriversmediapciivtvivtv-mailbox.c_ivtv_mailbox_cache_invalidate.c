...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_itv0; _i0++) {
              int _len_itv__i0__api_cache0 = 1;
          itv[_i0].api_cache = (struct TYPE_2__ *) malloc(_len_itv__i0__api_cache0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_itv__i0__api_cache0; _j0++) {
            itv[_i0].api_cache->last_jiffies = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ivtv_mailbox_cache_invalidate(itv);
          for(int _aux = 0; _aux < _len_itv0; _aux++) {
          free(itv[_aux].api_cache);
          }
          free(itv);
