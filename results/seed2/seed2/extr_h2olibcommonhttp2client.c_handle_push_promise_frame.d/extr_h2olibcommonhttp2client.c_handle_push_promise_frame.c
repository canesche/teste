...
__attribute__((used)) static int handle_push_promise_frame(struct st_h2o_http2client_conn_t *conn, h2o_http2_frame_t *frame, const char **err_desc)
{
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_conn0 = 1;
          struct st_h2o_http2client_conn_t * conn = (struct st_h2o_http2client_conn_t *) malloc(_len_conn0*sizeof(struct st_h2o_http2client_conn_t));
          ...
          int benchRet = handle_push_promise_frame(conn,frame,err_desc);
          printf("%d\n", benchRet); 
          free(conn);
          free(frame);
