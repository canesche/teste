...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          func[_i0].card = (struct TYPE_2__ *) malloc(_len_func__i0__card0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_func__i0__card0; _j0++) {
              int _len_func__i0__card_host0 = 1;
          func[_i0].card->host = (struct mmc_host *) malloc(_len_func__i0__card_host0*sizeof(struct mmc_host));
          for(int _j0 = 0; _j0 < _len_func__i0__card_host0; _j0++) {
            func[_i0].card->host->pm_caps = ((-2 * (next_i()%2)) + 1) * next_i();
        func[_i0].card->host->pm_flags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = sdio_set_host_pm_flags(func,flags);
          printf("%d\n", benchRet); 
