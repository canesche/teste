...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          crtc[_i0].dev = (struct TYPE_2__ *) malloc(_len_crtc__i0__dev0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_crtc__i0__dev0; _j0++) {
            crtc[_i0].dev->dev_private = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct ltdc_device * benchRet = crtc_to_ltdc(crtc);
          printf("%d\n", (*benchRet).dummy);
