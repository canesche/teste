...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int IntermediateFrequency = 100;
          int _len_state0 = 1;
          struct drxd_state * state = (struct drxd_state *) malloc(_len_state0*sizeof(struct drxd_state));
          for(int _i0 = 0; _i0 < _len_state0; _i0++) {
            state[_i0].app_env_default = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].app_env_diversity = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_EcOcRegOcModeLop = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].chip_adr = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].intermediate_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].expected_sys_clock_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].sys_clock_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].osc_clock_freq = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].enable_parallel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].hi_cfg_timing_div = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].hi_cfg_bridge_delay = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_FeAgRegAgAgcSio = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].m_FeAgRegAgPwd = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].config.clock = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].config.demod_address = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].config.insert_rs_byte = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].insert_rs_byte = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].tuner_mirrors = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].type_A = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].PGA = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].drxd_state = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].cscd_state = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].osc_clock_deviation = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_state__i0__m_HiI2cPatch0 = 1;
          state[_i0].m_HiI2cPatch = (int *) malloc(_len_state__i0__m_HiI2cPatch0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_state__i0__m_HiI2cPatch0; _j0++) {
            state[_i0].m_HiI2cPatch[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        state[_i0].noise_cal.cpOpt = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].noise_cal.cpNexpOfs = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].noise_cal.tdCal2k = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].noise_cal.tdCal8k = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.R1 = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.R2 = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.R3 = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.outputLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.settleLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.minOutputLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.maxOutputLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].rf_agc_cfg.speed = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.outputLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.settleLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.minOutputLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.maxOutputLevel = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.speed = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.R1 = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.R2 = ((-2 * (next_i()%2)) + 1) * next_i();
        state[_i0].if_agc_cfg.R3 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = CDRXD(state,IntermediateFrequency);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_state0; _aux++) {
          free(state[_aux].m_HiI2cPatch);
          }
          free(state);
