...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_priv0; _i0++) {
              int _len_priv__i0__ieee802110 = 1;
          priv[_i0].ieee80211 = (struct TYPE_4__ *) malloc(_len_priv__i0__ieee802110*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_priv__i0__ieee802110; _j0++) {
            priv[_i0].ieee80211->LinkDetectInfo.SlotNum = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_priv__i0__ieee80211_LinkDetectInfo_RxDataNum0 = 1;
          priv[_i0].ieee80211->LinkDetectInfo.RxDataNum = (long *) malloc(_len_priv__i0__ieee80211_LinkDetectInfo_RxDataNum0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_priv__i0__ieee80211_LinkDetectInfo_RxDataNum0; _j0++) {
            priv[_i0].ieee80211->LinkDetectInfo.RxDataNum[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_priv__i0__ieee80211_LinkDetectInfo_RxBcnNum0 = 1;
          priv[_i0].ieee80211->LinkDetectInfo.RxBcnNum = (long *) malloc(_len_priv__i0__ieee80211_LinkDetectInfo_RxBcnNum0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_priv__i0__ieee80211_LinkDetectInfo_RxBcnNum0; _j0++) {
            priv[_i0].ieee80211->LinkDetectInfo.RxBcnNum[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        priv[_i0].ieee80211->LinkDetectInfo.NumRecvDataInPeriod = ((-2 * (next_i()%2)) + 1) * next_i();
        priv[_i0].ieee80211->LinkDetectInfo.NumRecvBcnInPeriod = ((-2 * (next_i()%2)) + 1) * next_i();
        priv[_i0].ieee80211->LinkDetectInfo.SlotIndex = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
