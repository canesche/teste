...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_self0; _i0++) {
            self[_i0].finished = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_self__i0__iter0 = 1;
          self[_i0].iter = (int *) malloc(_len_self__i0__iter0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_self__i0__iter0; _j0++) {
            self[_i0].iter[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = npyiter_finished_get(self);
          printf("%d\n", (*benchRet)); 
