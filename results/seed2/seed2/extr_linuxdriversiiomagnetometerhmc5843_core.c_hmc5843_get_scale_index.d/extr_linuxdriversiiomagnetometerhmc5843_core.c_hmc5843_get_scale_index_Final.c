...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_data__i0__variant0; _j0++) {
            data[_i0].variant->n_regval_to_nanoscale = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_data__i0__variant_regval_to_nanoscale0 = 1;
          data[_i0].variant->regval_to_nanoscale = (int *) malloc(_len_data__i0__variant_regval_to_nanoscale0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_data__i0__variant_regval_to_nanoscale0; _j0++) {
            data[_i0].variant->regval_to_nanoscale[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = hmc5843_get_scale_index(data,val,val2);
          printf("%d\n", benchRet); 
