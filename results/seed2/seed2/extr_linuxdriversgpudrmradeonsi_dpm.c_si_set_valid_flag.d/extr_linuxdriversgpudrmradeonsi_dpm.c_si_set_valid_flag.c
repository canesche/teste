...
__attribute__((used)) static void si_set_valid_flag(struct si_mc_reg_table *table)
{
	u8 i, j;
...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_table0 = 1;
          struct si_mc_reg_table * table = (struct si_mc_reg_table *) malloc(_len_table0*sizeof(struct si_mc_reg_table));
          for(int _i0 = 0; _i0 < _len_table0; _i0++) {
            table[_i0].last = ((-2 * (next_i()%2)) + 1) * next_i();
        table[_i0].num_entries = ((-2 * (next_i()%2)) + 1) * next_i();
        table[_i0].valid_flag = ((-2 * (next_i()%2)) + 1) * next_i();
