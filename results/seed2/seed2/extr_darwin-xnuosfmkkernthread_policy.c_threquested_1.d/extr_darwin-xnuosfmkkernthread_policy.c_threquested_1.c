...
struct TYPE_4__ {int /*<<< orphan*/  requested_policy; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_thread0; _i0++) {
              int _len_thread__i0__task0 = 1;
          thread[_i0].task = (struct TYPE_4__ *) malloc(_len_thread__i0__task0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_thread__i0__task0; _j0++) {
            thread[_i0].task->requested_policy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          unsigned long benchRet = threquested_1(thread);
          printf("%lu\n", benchRet); 
          for(int _aux = 0; _aux < _len_thread0; _aux++) {
          free(thread[_aux].task);
          }
          free(thread);
