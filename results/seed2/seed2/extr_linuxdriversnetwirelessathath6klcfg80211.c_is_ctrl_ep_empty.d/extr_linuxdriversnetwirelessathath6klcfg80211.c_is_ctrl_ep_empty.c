...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ar0; _i0++) {
            ar[_i0].ctrl_ep = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_ar__i0__tx_pending0 = 1;
          ar[_i0].tx_pending = (int *) malloc(_len_ar__i0__tx_pending0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ar__i0__tx_pending0; _j0++) {
            ar[_i0].tx_pending[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = is_ctrl_ep_empty(ar);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_ar0; _aux++) {
          free(ar[_aux].tx_pending);
          }
          free(ar);
