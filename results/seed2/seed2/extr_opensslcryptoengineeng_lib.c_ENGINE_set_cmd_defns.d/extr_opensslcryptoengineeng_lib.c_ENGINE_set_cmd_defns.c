...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          e[_i0].cmd_defns = (const int *) malloc(_len_e__i0__cmd_defns0*sizeof(const int));
          for(int _j0 = 0; _j0 < _len_e__i0__cmd_defns0; _j0++) {
            e[_i0].cmd_defns[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_defns0 = 1;
          const int * defns = (const int *) malloc(_len_defns0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_defns0; _i0++) {
            defns[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = ENGINE_set_cmd_defns(e,defns);
          printf("%d\n", benchRet); 
