...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_c0 = 1;
          struct ieee80211_chanctx_conf * c = (struct ieee80211_chanctx_conf *) malloc(_len_c0*sizeof(struct ieee80211_chanctx_conf));
          for(int _i0 = 0; _i0 < _len_c0; _i0++) {
            c[_i0].drv_priv = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          hwsim_clear_chanctx_magic(c);
          free(c);
