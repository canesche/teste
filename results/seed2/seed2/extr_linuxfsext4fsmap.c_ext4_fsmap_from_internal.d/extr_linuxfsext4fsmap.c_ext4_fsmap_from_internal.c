...
struct fsmap {int fmr_physical; int fmr_length; scalar_t__* fmr_reserved; scalar_t__ fmr_offset; int /*<<< orphan*/  fmr_owner; int /*<<< orphan*/  fmr_flags; int /*<<< orphan*/  fmr_device; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_dest0 = 1;
          struct fsmap * dest = (struct fsmap *) malloc(_len_dest0*sizeof(struct fsmap));
          for(int _i0 = 0; _i0 < _len_dest0; _i0++) {
            dest[_i0].fmr_physical = ((-2 * (next_i()%2)) + 1) * next_i();
        dest[_i0].fmr_length = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_dest__i0__fmr_reserved0 = 1;
          dest[_i0].fmr_reserved = (long *) malloc(_len_dest__i0__fmr_reserved0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_dest__i0__fmr_reserved0; _j0++) {
            dest[_i0].fmr_reserved[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        dest[_i0].fmr_offset = ((-2 * (next_i()%2)) + 1) * next_i();
        dest[_i0].fmr_owner = ((-2 * (next_i()%2)) + 1) * next_i();
        dest[_i0].fmr_flags = ((-2 * (next_i()%2)) + 1) * next_i();
        dest[_i0].fmr_device = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_src0 = 1;
          struct ext4_fsmap * src = (struct ext4_fsmap *) malloc(_len_src0*sizeof(struct ext4_fsmap));
        ...
        src[_i0].fmr_device = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          ext4_fsmap_from_internal(sb,dest,src);
          free(sb);
          for(int _aux = 0; _aux < _len_dest0; _aux++) {
          free(dest[_aux].fmr_reserved);
          }
          free(dest);
          free(src);
