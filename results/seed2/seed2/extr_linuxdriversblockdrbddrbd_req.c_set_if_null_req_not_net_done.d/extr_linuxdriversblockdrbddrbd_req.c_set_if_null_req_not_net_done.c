...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_peer_device__i0__connection0; _j0++) {
              int _len_peer_device__i0__connection_req_not_net_done0 = 1;
          peer_device[_i0].connection->req_not_net_done = (struct drbd_request *) malloc(_len_peer_device__i0__connection_req_not_net_done0*sizeof(struct drbd_request));
          for(int _j0 = 0; _j0 < _len_peer_device__i0__connection_req_not_net_done0; _j0++) {
            peer_device[_i0].connection->req_not_net_done->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_req0 = 1;
