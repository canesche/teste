...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_tapaddr0 = 1;
          char * tapaddr = (char *) malloc(_len_tapaddr0*sizeof(char));
          for(int _i0 = 0; _i0 < _len_tapaddr0; _i0++) {
            tapaddr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int * benchRet = OpenEth(name,local,tapmode,tapaddr);
          printf("%d\n", (*benchRet)); 
          free(name);
          free(tapaddr);
