...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_e0; _i0++) {
            e[_i0].offset = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_e__i0__freemask0 = 1;
          e[_i0].freemask = (int *) malloc(_len_e__i0__freemask0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_e__i0__freemask0; _j0++) {
            e[_i0].freemask[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          blockend(e);
          for(int _aux = 0; _aux < _len_e0; _aux++) {
          free(e[_aux].freemask);
          }
          free(e);
