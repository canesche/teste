...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          s[_i0].s_bdev = (struct block_device *) malloc(_len_s__i0__s_bdev0*sizeof(struct block_device));
          for(int _j0 = 0; _j0 < _len_s__i0__s_bdev0; _j0++) {
            s[_i0].s_bdev->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          void * ptr;
          int benchRet = test_gfs2_super(s,ptr);
          printf("%d\n", benchRet); 
