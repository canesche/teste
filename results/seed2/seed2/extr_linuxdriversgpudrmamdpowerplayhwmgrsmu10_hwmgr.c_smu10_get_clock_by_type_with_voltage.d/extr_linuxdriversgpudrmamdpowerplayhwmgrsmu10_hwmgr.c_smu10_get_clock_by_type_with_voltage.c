...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          clocks[_i0].data = (struct TYPE_3__ *) malloc(_len_clocks__i0__data0*sizeof(struct TYPE_3__));
        ...
        clocks[_i0].data->voltage_in_mv = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = smu10_get_clock_by_type_with_voltage(hwmgr,type,clocks);
          printf("%d\n", benchRet); 
          free(hwmgr);
