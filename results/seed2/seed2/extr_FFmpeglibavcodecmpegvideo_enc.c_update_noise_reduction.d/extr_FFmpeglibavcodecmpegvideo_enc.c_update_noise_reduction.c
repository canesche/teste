...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          s[_i0].dct_offset = (int **) malloc(_len_s__i0__dct_offset0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_s__i0__dct_offset0; _j0++) {
            int _len_s__i0__dct_offset1 = 1;
            s[_i0].dct_offset[_j0] = (int *) malloc(_len_s__i0__dct_offset1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_s__i0__dct_offset1; _j1++) {
              s[_i0].dct_offset[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
        s[_i0].noise_reduction = ((-2 * (next_i()%2)) + 1) * next_i();
          }
