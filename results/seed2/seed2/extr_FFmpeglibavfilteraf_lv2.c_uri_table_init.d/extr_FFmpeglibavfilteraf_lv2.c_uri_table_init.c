...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_table0; _i0++) {
            table[_i0].n_uris = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_table__i0__uris0 = 1;
          table[_i0].uris = (int *) malloc(_len_table__i0__uris0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_table__i0__uris0; _j0++) {
            table[_i0].uris[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          uri_table_init(table);
          for(int _aux = 0; _aux < _len_table0; _aux++) {
          free(table[_aux].uris);
          }
          free(table);
