...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_regs0; _i0++) {
              int _len_regs__i0__regs0 = 1;
          regs[_i0].regs = (unsigned long *) malloc(_len_regs__i0__regs0*sizeof(unsigned long));
          for(int _j0 = 0; _j0 < _len_regs__i0__regs0; _j0++) {
            regs[_i0].regs[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
