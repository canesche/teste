...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hso_dev0; _i0++) {
              int _len_hso_dev__i0__port_data_dev_net0 = 1;
          hso_dev[_i0].port_data.dev_net = (struct hso_net *) malloc(_len_hso_dev__i0__port_data_dev_net0*sizeof(struct hso_net));
          for(int _j0 = 0; _j0 < _len_hso_dev__i0__port_data_dev_net0; _j0++) {
            hso_dev[_i0].port_data.dev_net->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct hso_net * benchRet = dev2net(hso_dev);
          printf("%d\n", (*benchRet).dummy);
          free(hso_dev);
