...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_hba0; _i0++) {
            hba[_i0].cid_que.cid_q_cons_idx = ((-2 * (next_i()%2)) + 1) * next_i();
        hba[_i0].cid_que.cid_q_max_idx = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_hba__i0__cid_que_cid_que0 = 1;
          hba[_i0].cid_que.cid_que = (int *) malloc(_len_hba__i0__cid_que_cid_que0*sizeof(int));
        ...
        hba[_i0].cid_que.cid_free_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = bnx2i_alloc_iscsi_cid(hba);
          printf("%d\n", benchRet); 
          free(hba);
