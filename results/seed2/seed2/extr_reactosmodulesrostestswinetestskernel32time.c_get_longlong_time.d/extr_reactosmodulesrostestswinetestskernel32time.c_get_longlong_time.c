...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_time0 = 1;
          struct TYPE_7__ * time = (struct TYPE_7__ *) malloc(_len_time0*sizeof(struct TYPE_7__));
          for(int _i0 = 0; _i0 < _len_time0; _i0++) {
            time[_i0].dwHighDateTime = ((-2 * (next_i()%2)) + 1) * next_i();
        time[_i0].dwLowDateTime = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = get_longlong_time(time);
          printf("%d\n", benchRet); 
          free(time);
