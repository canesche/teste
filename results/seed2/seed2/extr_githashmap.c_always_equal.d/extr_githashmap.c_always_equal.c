...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_unused10 = 1;
          const void * unused1 = (const void *) malloc(_len_unused10*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_unused10; _i0++) {
            unused1[_i0] = 0;
          }
          int _len_unused20 = 1;
          const void * unused2 = (const void *) malloc(_len_unused20*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_unused20; _i0++) {
            unused2[_i0] = 0;
          }
          int _len_unused_keydata0 = 1;
          const void * unused_keydata = (const void *) malloc(_len_unused_keydata0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_unused_keydata0; _i0++) {
            unused_keydata[_i0] = 0;
          }
          int benchRet = always_equal(unused_cmp_data,unused1,unused2,unused_keydata);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          ...
          int _len_unused_keydata0 = 65025;
          const void * unused_keydata = (const void *) malloc(_len_unused_keydata0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_unused_keydata0; _i0++) {
            unused_keydata[_i0] = 0;
          }
