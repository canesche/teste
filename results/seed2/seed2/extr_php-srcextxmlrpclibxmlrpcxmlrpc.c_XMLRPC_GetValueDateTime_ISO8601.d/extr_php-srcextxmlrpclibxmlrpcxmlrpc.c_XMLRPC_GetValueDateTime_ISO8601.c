...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_value__i0__str_str0 = 1;
          value[_i0].str.str = (const char *) malloc(_len_value__i0__str_str0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_value__i0__str_str0; _j0++) {
            value[_i0].str.str[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = XMLRPC_GetValueDateTime_ISO8601(value);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          free(value);
