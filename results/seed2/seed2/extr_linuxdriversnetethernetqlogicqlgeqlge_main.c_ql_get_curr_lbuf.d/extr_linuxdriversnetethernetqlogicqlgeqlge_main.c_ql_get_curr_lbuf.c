...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rx_ring0; _i0++) {
            rx_ring[_i0].lbq_curr_idx = ((-2 * (next_i()%2)) + 1) * next_i();
        rx_ring[_i0].lbq_len = ((-2 * (next_i()%2)) + 1) * next_i();
        rx_ring[_i0].lbq_free_cnt = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_rx_ring__i0__lbq0 = 1;
          rx_ring[_i0].lbq = (struct bq_desc *) malloc(_len_rx_ring__i0__lbq0*sizeof(struct bq_desc));
          for(int _j0 = 0; _j0 < _len_rx_ring__i0__lbq0; _j0++) {
            rx_ring[_i0].lbq->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct bq_desc * benchRet = ql_get_curr_lbuf(rx_ring);
          printf("%d\n", (*benchRet).dummy);
          for(int _aux = 0; _aux < _len_rx_ring0; _aux++) {
          free(rx_ring[_aux].lbq);
          }
          free(rx_ring);
