...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_f0; _i0++) {
            f[_i0].height = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_f__i0__linesize0 = 1;
          f[_i0].linesize = (int *) malloc(_len_f__i0__linesize0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_f__i0__linesize0; _j0++) {
            f[_i0].linesize[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_f__i0__data0 = 1;
          f[_i0].data = (int **) malloc(_len_f__i0__data0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_f__i0__data0; _j0++) {
            int _len_f__i0__data1 = 1;
            f[_i0].data[_j0] = (int *) malloc(_len_f__i0__data1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_f__i0__data1; _j1++) {
              f[_i0].data[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          flip_swap_frame(f);
          for(int _aux = 0; _aux < _len_f0; _aux++) {
          free(f[_aux].linesize);
          }
          for(int _aux = 0; _aux < _len_f0; _aux++) {
          free(*(f[_aux].data));
        free(f[_aux].data);
