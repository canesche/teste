...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned int manf = 100;
          unsigned int prod = 100;
          const struct softing_platform_data * benchRet = softingcs_find_platform_data(manf,prod);
    ...
    case 1:
    {
          unsigned int manf = 255;
          unsigned int prod = 255;
          const struct softing_platform_data * benchRet = softingcs_find_platform_data(manf,prod);
    ...
    case 2:
    {
          unsigned int manf = 10;
          unsigned int prod = 10;
          const struct softing_platform_data * benchRet = softingcs_find_platform_data(manf,prod);
