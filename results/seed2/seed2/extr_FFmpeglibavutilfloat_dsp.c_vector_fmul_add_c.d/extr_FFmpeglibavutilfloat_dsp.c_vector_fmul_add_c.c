...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_src20 = 1;
          const float * src2 = (const float *) malloc(_len_src20*sizeof(const float));
          for(int _i0 = 0; _i0 < _len_src20; _i0++) {
            src2[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          vector_fmul_add_c(dst,src0,src1,src2,len);
          free(dst);
          free(src0);
          free(src1);
          free(src2);
