...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_rx_ring0 = 1;
          struct ixgbe_ring * rx_ring = (struct ixgbe_ring *) malloc(_len_rx_ring0*sizeof(struct ixgbe_ring));
        ...
        rx_ring[_i0].count = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          rx_ring[_i0].rx_buffer_info = (struct ixgbe_rx_buffer *) malloc(_len_rx_ring__i0__rx_buffer_info0*sizeof(struct ixgbe_rx_buffer));
        ...
        rx_ring[_i0].rx_buffer_info->dma = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          struct ixgbe_rx_buffer * old_buff = (struct ixgbe_rx_buffer *) malloc(_len_old_buff0*sizeof(struct ixgbe_rx_buffer));
        ...
        old_buff[_i0].dma = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          ixgbe_reuse_rx_page(rx_ring,old_buff);
