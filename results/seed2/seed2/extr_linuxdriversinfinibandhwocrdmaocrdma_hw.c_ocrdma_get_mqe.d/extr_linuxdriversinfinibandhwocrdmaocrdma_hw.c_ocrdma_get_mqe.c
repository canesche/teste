...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_dev__i0__mq_sq_va0 = 1;
          dev[_i0].mq.sq.va = (struct ocrdma_mqe *) malloc(_len_dev__i0__mq_sq_va0*sizeof(struct ocrdma_mqe));
          for(int _j0 = 0; _j0 < _len_dev__i0__mq_sq_va0; _j0++) {
            dev[_i0].mq.sq.va->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct ocrdma_mqe * benchRet = ocrdma_get_mqe(dev);
          printf("%d\n", (*benchRet).dummy);
          free(dev);
