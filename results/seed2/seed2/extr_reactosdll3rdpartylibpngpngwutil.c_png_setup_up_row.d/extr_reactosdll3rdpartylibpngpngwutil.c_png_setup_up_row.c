...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          png_ptr[_i0].try_row = (unsigned int *) malloc(_len_png_ptr__i0__try_row0*sizeof(unsigned int));
          ...
          png_ptr[_i0].row_buf = (unsigned int *) malloc(_len_png_ptr__i0__row_buf0*sizeof(unsigned int));
          ...
          png_ptr[_i0].prev_row = (unsigned int *) malloc(_len_png_ptr__i0__prev_row0*sizeof(unsigned int));
          for(int _j0 = 0; _j0 < _len_png_ptr__i0__prev_row0; _j0++) {
            png_ptr[_i0].prev_row[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          unsigned long benchRet = png_setup_up_row(png_ptr,row_bytes,lmins);
          printf("%lu\n", benchRet); 
