...
__attribute__((used)) static u8 *_ios_cred(struct ore_io_state *ios, unsigned index)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ios__i0__oc_comps0; _j0++) {
              int _len_ios__i0__oc_comps_cred0 = 1;
          ios[_i0].oc->comps->cred = (int *) malloc(_len_ios__i0__oc_comps_cred0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ios__i0__oc_comps_cred0; _j0++) {
            ios[_i0].oc->comps->cred[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          int * benchRet = _ios_cred(ios,index);
          printf("%d\n", (*benchRet)); 
