...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          hs[_i0].dimensions = (struct TYPE_6__ *) malloc(_len_hs__i0__dimensions0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_hs__i0__dimensions0; _j0++) {
            hs[_i0].dimensions->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct TYPE_6__ * benchRet = ts_hyperspace_get_dimension(hs,type,n);
          printf("%ld\n", (*benchRet).type);
