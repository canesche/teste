...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dispc__i0__feat0; _j0++) {
            dispc[_i0].feat->num_features = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_dispc__i0__feat_features0 = 1;
          dispc[_i0].feat->features = (int *) malloc(_len_dispc__i0__feat_features0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dispc__i0__feat_features0; _j0++) {
            dispc[_i0].feat->features[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = dispc_has_feature(dispc,id);
          printf("%d\n", benchRet); 
