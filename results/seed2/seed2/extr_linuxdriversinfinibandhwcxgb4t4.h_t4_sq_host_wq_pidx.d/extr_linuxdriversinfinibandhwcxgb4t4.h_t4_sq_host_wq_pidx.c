...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_wq__i0__sq_queue0 = 1;
          wq[_i0].sq.queue = (struct TYPE_5__ *) malloc(_len_wq__i0__sq_queue0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_wq__i0__sq_queue0; _j0++) {
            wq[_i0].sq.queue->status.host_wq_pidx = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = t4_sq_host_wq_pidx(wq);
          printf("%d\n", benchRet); 
          free(wq);
