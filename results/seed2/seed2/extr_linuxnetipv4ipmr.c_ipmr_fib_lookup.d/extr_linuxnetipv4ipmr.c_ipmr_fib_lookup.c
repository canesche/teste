...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_flp40 = 1;
          struct flowi4 * flp4 = (struct flowi4 *) malloc(_len_flp40*sizeof(struct flowi4));
          for(int _i0 = 0; _i0 < _len_flp40; _i0++) {
            flp4[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_mrt0 = 1;
          ...
          int benchRet = ipmr_fib_lookup(net,flp4,mrt);
          printf("%d\n", benchRet); 
          free(net);
          free(flp4);
