...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_hdspm__i0__mixer_ch0; _j0++) {
              int _len_hdspm__i0__mixer_ch_pb0 = 1;
          hdspm[_i0].mixer->ch->pb = (int *) malloc(_len_hdspm__i0__mixer_ch_pb0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_hdspm__i0__mixer_ch_pb0; _j0++) {
            hdspm[_i0].mixer->ch->pb[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          int benchRet = hdspm_read_pb_gain(hdspm,chan,pb);
          printf("%d\n", benchRet); 
