...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        s[_i0].f_code = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_s__i0__rc_context_entry0 = 1;
          s[_i0].rc_context.entry = (struct TYPE_5__ *) malloc(_len_s__i0__rc_context_entry0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_s__i0__rc_context_entry0; _j0++) {
            s[_i0].rc_context.entry->b_code = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].rc_context.entry->f_code = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
