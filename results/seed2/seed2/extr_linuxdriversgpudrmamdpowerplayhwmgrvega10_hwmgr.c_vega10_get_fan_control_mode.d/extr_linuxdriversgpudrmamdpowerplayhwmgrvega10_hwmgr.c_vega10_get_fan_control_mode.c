...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_hwmgr__i0__backend0; _j0++) {
              int _len_hwmgr__i0__backend_smu_features0 = 1;
          hwmgr[_i0].backend->smu_features = (struct TYPE_2__ *) malloc(_len_hwmgr__i0__backend_smu_features0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_hwmgr__i0__backend_smu_features0; _j0++) {
            hwmgr[_i0].backend->smu_features->enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = vega10_get_fan_control_mode(hwmgr);
          printf("%d\n", benchRet); 
