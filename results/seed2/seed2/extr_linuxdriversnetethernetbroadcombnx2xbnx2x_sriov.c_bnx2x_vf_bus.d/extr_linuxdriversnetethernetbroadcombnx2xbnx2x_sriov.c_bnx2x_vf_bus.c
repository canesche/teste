...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          bp[_i0].vfdb = (struct TYPE_3__ *) malloc(_len_bp__i0__vfdb0*sizeof(struct TYPE_3__));
        ...
        bp[_i0].vfdb->sriov.stride = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_bp__i0__pdev_bus0 = 1;
          bp[_i0].pdev->bus = (struct TYPE_4__ *) malloc(_len_bp__i0__pdev_bus0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_bp__i0__pdev_bus0; _j0++) {
            bp[_i0].pdev->bus->number = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = bnx2x_vf_bus(bp,vfid);
          printf("%d\n", benchRet); 
