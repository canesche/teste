...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned int buf_count = 100;
          unsigned int max_entry_count = 100;
          int benchRet = bad_buf_count(buf_count,max_entry_count);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          unsigned int buf_count = 255;
          unsigned int max_entry_count = 255;
          int benchRet = bad_buf_count(buf_count,max_entry_count);
          printf("%d\n", benchRet); 
    ...
    case 2:
    {
          unsigned int buf_count = 10;
          unsigned int max_entry_count = 10;
          int benchRet = bad_buf_count(buf_count,max_entry_count);
          printf("%d\n", benchRet); 
