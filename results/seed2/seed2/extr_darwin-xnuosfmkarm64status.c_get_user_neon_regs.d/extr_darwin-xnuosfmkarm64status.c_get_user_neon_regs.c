...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_thread0; _i0++) {
              int _len_thread__i0__machine_uNeon0 = 1;
          thread[_i0].machine.uNeon = (int *) malloc(_len_thread__i0__machine_uNeon0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_thread__i0__machine_uNeon0; _j0++) {
            thread[_i0].machine.uNeon[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = get_user_neon_regs(thread);
          printf("%d\n", (*benchRet)); 
          free(thread);
