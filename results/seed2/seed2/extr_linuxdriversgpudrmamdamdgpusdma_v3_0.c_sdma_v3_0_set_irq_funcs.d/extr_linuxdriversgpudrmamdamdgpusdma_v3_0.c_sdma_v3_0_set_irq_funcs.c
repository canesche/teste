...
/* Variables and functions */
 ...
 int /*<<< orphan*/  sdma_v3_0_illegal_inst_irq_funcs ; 
 int /*<<< orphan*/  sdma_v3_0_trap_irq_funcs ; 

__attribute__((used)) static void sdma_v3_0_set_irq_funcs(struct amdgpu_device *adev)
{
