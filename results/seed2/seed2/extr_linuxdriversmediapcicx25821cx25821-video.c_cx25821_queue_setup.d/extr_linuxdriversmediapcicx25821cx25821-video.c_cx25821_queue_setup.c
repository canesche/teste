...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          q[_i0].drv_priv = (struct cx25821_channel *) malloc(_len_q__i0__drv_priv0*sizeof(struct cx25821_channel));
          for(int _j0 = 0; _j0 < _len_q__i0__drv_priv0; _j0++) {
            q[_i0].drv_priv->width = ((-2 * (next_i()%2)) + 1) * next_i();
        q[_i0].drv_priv->height = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_q__i0__drv_priv_fmt0 = 1;
          q[_i0].drv_priv->fmt = (struct TYPE_2__ *) malloc(_len_q__i0__drv_priv_fmt0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_q__i0__drv_priv_fmt0; _j0++) {
            q[_i0].drv_priv->fmt->depth = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          ...
          int benchRet = cx25821_queue_setup(q,num_buffers,num_planes,sizes,alloc_devs);
          printf("%d\n", benchRet); 
