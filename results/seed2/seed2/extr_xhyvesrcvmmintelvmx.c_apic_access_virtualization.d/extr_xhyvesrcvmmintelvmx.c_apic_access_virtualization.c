...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vmx0; _i0++) {
              int _len_vmx__i0__cap0 = 1;
          vmx[_i0].cap = (struct TYPE_2__ *) malloc(_len_vmx__i0__cap0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_vmx__i0__cap0; _j0++) {
            vmx[_i0].cap->proc_ctls2 = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = apic_access_virtualization(vmx,vcpuid);
          printf("%d\n", benchRet); 
