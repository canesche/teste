...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ * assembly = (struct TYPE_3__ *) malloc(_len_assembly0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_assembly0; _i0++) {
              int _len_assembly__i0__data0 = 1;
          assembly[_i0].data = (int *) malloc(_len_assembly__i0__data0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_assembly__i0__data0; _j0++) {
            assembly[_i0].data[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = assembly_data_offset(assembly,offset);
          printf("%d\n", (*benchRet)); 
          for(int _aux = 0; _aux < _len_assembly0; _aux++) {
          free(assembly[_aux].data);
          }
          free(assembly);
