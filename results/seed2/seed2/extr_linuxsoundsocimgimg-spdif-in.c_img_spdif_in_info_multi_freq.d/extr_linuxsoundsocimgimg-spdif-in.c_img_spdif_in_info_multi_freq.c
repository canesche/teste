...
/* Variables and functions */
 int /*<<< orphan*/  IMG_SPDIF_IN_NUM_ACLKGEN ; 
 int /*<<< orphan*/  LONG_MAX ; 
 int /*<<< orphan*/  SNDRV_CTL_ELEM_TYPE_INTEGER ; 

__attribute__((used)) static int img_spdif_in_info_multi_freq(struct snd_kcontrol *kcontrol,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        uinfo[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = img_spdif_in_info_multi_freq(kcontrol,uinfo);
          printf("%d\n", benchRet); 
          free(kcontrol);
          free(uinfo);
