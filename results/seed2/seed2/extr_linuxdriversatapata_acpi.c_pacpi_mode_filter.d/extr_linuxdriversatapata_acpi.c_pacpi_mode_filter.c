...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_adev__i0__link_ap0; _j0++) {
              int _len_adev__i0__link_ap_private_data0 = 1;
          adev[_i0].link->ap->private_data = (struct pata_acpi *) malloc(_len_adev__i0__link_ap_private_data0*sizeof(struct pata_acpi));
          for(int _j0 = 0; _j0 < _len_adev__i0__link_ap_private_data0; _j0++) {
              int _len_adev__i0__link_ap_private_data_mask0 = 1;
          adev[_i0].link->ap->private_data->mask = (unsigned long *) malloc(_len_adev__i0__link_ap_private_data_mask0*sizeof(unsigned long));
          for(int _j0 = 0; _j0 < _len_adev__i0__link_ap_private_data_mask0; _j0++) {
            adev[_i0].link->ap->private_data->mask[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          }
          unsigned long benchRet = pacpi_mode_filter(adev,mask);
          printf("%lu\n", benchRet); 
