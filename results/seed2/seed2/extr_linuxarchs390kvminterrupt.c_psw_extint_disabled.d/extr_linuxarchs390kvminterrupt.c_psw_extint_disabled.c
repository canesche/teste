...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vcpu[_i0].arch.sie_block = (struct TYPE_5__ *) malloc(_len_vcpu__i0__arch_sie_block0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_vcpu__i0__arch_sie_block0; _j0++) {
            vcpu[_i0].arch.sie_block->gpsw.mask = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = psw_extint_disabled(vcpu);
          printf("%d\n", benchRet); 
          free(vcpu);
