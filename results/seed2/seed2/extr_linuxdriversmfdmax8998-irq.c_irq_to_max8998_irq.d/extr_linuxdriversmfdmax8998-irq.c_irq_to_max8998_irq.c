...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_max89980 = 1;
          struct max8998_dev * max8998 = (struct max8998_dev *) malloc(_len_max89980*sizeof(struct max8998_dev));
          for(int _i0 = 0; _i0 < _len_max89980; _i0++) {
            max8998[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_data0 = 1;
          ...
          struct max8998_irq_data * benchRet = irq_to_max8998_irq(max8998,data);
          printf("%d\n", (*benchRet).dummy);
          free(max8998);
          free(data);
