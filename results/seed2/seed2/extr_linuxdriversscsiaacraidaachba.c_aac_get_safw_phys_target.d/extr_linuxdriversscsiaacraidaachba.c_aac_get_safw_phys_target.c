...
__attribute__((used)) static inline u32 aac_get_safw_phys_target(struct aac_dev *dev, int lun)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dev__i0__safw_phys_luns_lun0; _j0++) {
              int _len_dev__i0__safw_phys_luns_lun_level20 = 1;
          dev[_i0].safw_phys_luns->lun->level2 = (int *) malloc(_len_dev__i0__safw_phys_luns_lun_level20*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dev__i0__safw_phys_luns_lun_level20; _j0++) {
            dev[_i0].safw_phys_luns->lun->level2[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          int benchRet = aac_get_safw_phys_target(dev,lun);
          printf("%d\n", benchRet); 
