...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_p0; _i0++) {
              int _len_p__i0__info0 = 1;
          p[_i0].info = (int *) malloc(_len_p__i0__info0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_p__i0__info0; _j0++) {
            p[_i0].info[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        p[_i0].length = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = getChannel(p);
          printf("%lu\n", benchRet); 
