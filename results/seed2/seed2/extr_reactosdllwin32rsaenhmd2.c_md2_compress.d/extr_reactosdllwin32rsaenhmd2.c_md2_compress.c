...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_md20; _i0++) {
              int _len_md2__i0__X0 = 1;
          md2[_i0].X = (int *) malloc(_len_md2__i0__X0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_md2__i0__X0; _j0++) {
            md2[_i0].X[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_md2__i0__buf0 = 1;
          md2[_i0].buf = (int *) malloc(_len_md2__i0__buf0*sizeof(int));
