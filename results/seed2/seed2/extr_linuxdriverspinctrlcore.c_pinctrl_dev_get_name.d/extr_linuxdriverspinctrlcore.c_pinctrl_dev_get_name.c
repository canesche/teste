...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_pctldev__i0__desc0; _j0++) {
              int _len_pctldev__i0__desc_name0 = 1;
          pctldev[_i0].desc->name = (const char *) malloc(_len_pctldev__i0__desc_name0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_pctldev__i0__desc_name0; _j0++) {
            pctldev[_i0].desc->name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          const char * benchRet = pinctrl_dev_get_name(pctldev);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
