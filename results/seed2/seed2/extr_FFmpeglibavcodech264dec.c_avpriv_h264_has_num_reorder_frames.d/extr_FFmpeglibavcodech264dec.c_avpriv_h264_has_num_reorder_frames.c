...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_avctx__i0__priv_data0; _j0++) {
              int _len_avctx__i0__priv_data_ps_sps0 = 1;
          avctx[_i0].priv_data->ps.sps = (struct TYPE_6__ *) malloc(_len_avctx__i0__priv_data_ps_sps0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_avctx__i0__priv_data_ps_sps0; _j0++) {
            avctx[_i0].priv_data->ps.sps->num_reorder_frames = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = avpriv_h264_has_num_reorder_frames(avctx);
          printf("%d\n", benchRet); 
