...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_5__ * pThisSwapChain = (struct TYPE_5__ *) malloc(_len_pThisSwapChain0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_pThisSwapChain0; _i0++) {
            pThisSwapChain[_i0].dwHeight = ((-2 * (next_i()%2)) + 1) * next_i();
        pThisSwapChain[_i0].dwWidth = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_pPresentationParameters0 = 1;
          struct TYPE_6__ * pPresentationParameters = (struct TYPE_6__ *) malloc(_len_pPresentationParameters0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_pPresentationParameters0; _i0++) {
            pPresentationParameters[_i0].BackBufferHeight = ((-2 * (next_i()%2)) + 1) * next_i();
        pPresentationParameters[_i0].BackBufferWidth = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = Direct3DSwapChain9_SetDisplayMode(pThisSwapChain,pPresentationParameters);
          printf("%d\n", benchRet); 
          free(pThisSwapChain);
