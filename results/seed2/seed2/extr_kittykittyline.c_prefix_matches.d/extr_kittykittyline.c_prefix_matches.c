...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long at = 100;
          unsigned long prefix_len = 100;
          int _len_self0 = 1;
          ...
          int benchRet = prefix_matches(self,at,prefix,prefix_len);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          unsigned long at = 255;
          unsigned long prefix_len = 255;
