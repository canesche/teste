...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          esw[_i0].offloads.vport_reps->rep_if = (struct TYPE_2__ *) malloc(_len_esw__i0__offloads_vport_reps_rep_if0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_esw__i0__offloads_vport_reps_rep_if0; _j0++) {
              }
          }
          }
          void * benchRet = mlx5_eswitch_get_uplink_priv(esw,rep_type);
          free(esw);
