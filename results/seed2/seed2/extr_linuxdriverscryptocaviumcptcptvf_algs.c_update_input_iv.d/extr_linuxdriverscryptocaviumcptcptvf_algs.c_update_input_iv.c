...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_req_info0; _i0++) {
            req_info[_i0].req.dlen = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_req_info__i0__in0 = 1;
          req_info[_i0].in = (struct TYPE_3__ *) malloc(_len_req_info__i0__in0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_req_info__i0__in0; _j0++) {
            req_info[_i0].in->size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_iv0 = 1;
          ...
          update_input_iv(req_info,iv,enc_iv_len,argcnt);
          for(int _aux = 0; _aux < _len_req_info0; _aux++) {
          free(req_info[_aux].in);
          }
          free(req_info);
          free(iv);
          free(argcnt);
