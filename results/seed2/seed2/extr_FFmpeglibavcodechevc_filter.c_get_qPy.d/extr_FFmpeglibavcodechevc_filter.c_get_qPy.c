...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_s0; _i0++) {
              int _len_s__i0__qp_y_tab0 = 1;
          s[_i0].qp_y_tab = (int *) malloc(_len_s__i0__qp_y_tab0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_s__i0__qp_y_tab0; _j0++) {
            s[_i0].qp_y_tab[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          ...
          for(int _j0 = 0; _j0 < _len_s__i0__ps_sps0; _j0++) {
            s[_i0].ps.sps->log2_min_cb_size = ((-2 * (next_i()%2)) + 1) * next_i();
        s[_i0].ps.sps->min_cb_width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = get_qPy(s,xC,yC);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_s0; _aux++) {
          free(s[_aux].qp_y_tab);
          }
          free(s);
