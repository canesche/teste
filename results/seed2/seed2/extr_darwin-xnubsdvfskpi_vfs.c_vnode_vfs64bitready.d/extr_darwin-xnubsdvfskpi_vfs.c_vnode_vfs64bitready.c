...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_vp0 = 1;
          struct TYPE_6__ * vp = (struct TYPE_6__ *) malloc(_len_vp0*sizeof(struct TYPE_6__));
          for(int _i0 = 0; _i0 < _len_vp0; _i0++) {
              int _len_vp__i0__v_mount0 = 1;
          vp[_i0].v_mount = (struct TYPE_7__ *) malloc(_len_vp__i0__v_mount0*sizeof(struct TYPE_7__));
          for(int _j0 = 0; _j0 < _len_vp__i0__v_mount0; _j0++) {
              int _len_vp__i0__v_mount_mnt_vtable0 = 1;
          vp[_i0].v_mount->mnt_vtable = (struct TYPE_5__ *) malloc(_len_vp__i0__v_mount_mnt_vtable0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_vp__i0__v_mount_mnt_vtable0; _j0++) {
            vp[_i0].v_mount->mnt_vtable->vfc_vfsflags = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = vnode_vfs64bitready(vp);
          printf("%d\n", benchRet); 
