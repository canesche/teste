...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vp0; _i0++) {
              int _len_vp__i0__v_name0 = 1;
          vp[_i0].v_name = (char *) malloc(_len_vp__i0__v_name0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_vp__i0__v_name0; _j0++) {
            vp[_i0].v_name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_name0 = 1;
