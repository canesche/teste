...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          void * type;
          int _len_res_len0 = 1;
          int * res_len = (int *) malloc(_len_res_len0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_res_len0; _i0++) {
            res_len[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          get_onemethod_name_len(type,res_len);
          free(res_len);
