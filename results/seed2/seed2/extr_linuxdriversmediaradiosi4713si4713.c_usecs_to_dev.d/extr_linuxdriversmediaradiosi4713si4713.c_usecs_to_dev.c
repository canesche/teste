...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long usecs = 100;
          int size = 100;
          int _len_array0 = 1;
          unsigned long const* array = (unsigned long const*) malloc(_len_array0*sizeof(unsigned long const));
          for(int _i0 = 0; _i0 < _len_array0; _i0++) {
            array[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = usecs_to_dev(usecs,array,size);
          printf("%d\n", benchRet); 
          free(array);
