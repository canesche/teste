...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct TYPE_3__ * metafile = (struct TYPE_3__ *) malloc(_len_metafile0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_metafile0; _i0++) {
            metafile[_i0].next_object_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = METAFILE_AddObjectId(metafile);
          printf("%d\n", benchRet); 
          free(metafile);
