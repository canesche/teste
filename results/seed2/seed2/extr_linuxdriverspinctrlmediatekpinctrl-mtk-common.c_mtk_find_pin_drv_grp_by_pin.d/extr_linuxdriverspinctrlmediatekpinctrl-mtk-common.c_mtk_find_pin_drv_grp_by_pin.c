...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_pctl__i0__devdata0; _j0++) {
            pctl[_i0].devdata->n_pin_drv_grps = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_pctl__i0__devdata_pin_drv_grp0 = 1;
          pctl[_i0].devdata->pin_drv_grp = (struct mtk_pin_drv_grp *) malloc(_len_pctl__i0__devdata_pin_drv_grp0*sizeof(struct mtk_pin_drv_grp));
          for(int _j0 = 0; _j0 < _len_pctl__i0__devdata_pin_drv_grp0; _j0++) {
            pctl[_i0].devdata->pin_drv_grp->pin = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          const struct mtk_pin_drv_grp * benchRet = mtk_find_pin_drv_grp_by_pin(pctl,pin);
