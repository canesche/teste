...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_key0; _i0++) {
              int _len_key__i0__str0 = 1;
          key[_i0].str = (char *) malloc(_len_key__i0__str0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_key__i0__str0; _j0++) {
            key[_i0].str[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = hash_str_lookup(key);
          printf("%d\n", benchRet); 
