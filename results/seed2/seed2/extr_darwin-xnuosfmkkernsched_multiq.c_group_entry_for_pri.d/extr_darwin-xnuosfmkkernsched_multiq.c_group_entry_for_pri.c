...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long pri = 100;
          int _len_group0 = 1;
          struct TYPE_3__ * group = (struct TYPE_3__ *) malloc(_len_group0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_group0; _i0++) {
              int _len_group__i0__entries0 = 1;
          group[_i0].entries = (int *) malloc(_len_group__i0__entries0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_group__i0__entries0; _j0++) {
            group[_i0].entries[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int * benchRet = group_entry_for_pri(group,pri);
          printf("%d\n", (*benchRet)); 
          for(int _aux = 0; _aux < _len_group0; _aux++) {
          free(group[_aux].entries);
          }
          free(group);
