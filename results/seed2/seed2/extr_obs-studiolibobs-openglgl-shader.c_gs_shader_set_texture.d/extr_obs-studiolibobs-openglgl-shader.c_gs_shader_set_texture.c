...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_param0; _i0++) {
              int _len_param__i0__texture0 = 1;
          param[_i0].texture = (int *) malloc(_len_param__i0__texture0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_param__i0__texture0; _j0++) {
            param[_i0].texture[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_val0 = 1;
          ...
          gs_shader_set_texture(param,val);
          for(int _aux = 0; _aux < _len_param0; _aux++) {
          free(param[_aux].texture);
          }
          free(param);
          free(val);
