...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ds__i0__priv0; _j0++) {
              int _len_ds__i0__priv_info0 = 1;
          ds[_i0].priv->info = (struct TYPE_2__ *) malloc(_len_ds__i0__priv_info0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_ds__i0__priv_info0; _j0++) {
            ds[_i0].priv->info->tag_protocol = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          enum dsa_tag_protocol benchRet = mv88e6xxx_get_tag_protocol(ds,port);
