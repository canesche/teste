...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_mgr0 = 1;
          struct omap_overlay_manager * mgr = (struct omap_overlay_manager *) malloc(_len_mgr0*sizeof(struct omap_overlay_manager));
          for(int _i0 = 0; _i0 < _len_mgr0; _i0++) {
            mgr[_i0].id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct mgr_priv_data * benchRet = get_mgr_priv(mgr);
          printf("%d\n", (*benchRet).dummy);
          free(mgr);
