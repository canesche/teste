...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vec[_i0].slices = (int **) malloc(_len_vec__i0__slices0*sizeof(int *));
          for(int _j0 = 0; _j0 < _len_vec__i0__slices0; _j0++) {
            int _len_vec__i0__slices1 = 1;
            vec[_i0].slices[_j0] = (int *) malloc(_len_vec__i0__slices1*sizeof(int));
            for(int _j1 = 0; _j1 < _len_vec__i0__slices1; _j1++) {
              vec[_i0].slices[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          int * benchRet = ts_dimension_vec_get(vec,index);
          printf("%d\n", (*benchRet)); 
