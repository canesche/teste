...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_arminsn0; _i0++) {
              int _len_arminsn__i0__buf0 = 1;
          arminsn[_i0].buf = (const int *) malloc(_len_arminsn__i0__buf0*sizeof(const int));
          for(int _j0 = 0; _j0 < _len_arminsn__i0__buf0; _j0++) {
            arminsn[_i0].buf[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_buf0 = 1;
