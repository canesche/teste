...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_phydev0; _i0++) {
              int _len_phydev__i0__c45_ids_device_ids0 = 1;
          phydev[_i0].c45_ids.device_ids = (long *) malloc(_len_phydev__i0__c45_ids_device_ids0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_phydev__i0__c45_ids_device_ids0; _j0++) {
            phydev[_i0].c45_ids.device_ids[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = teranetics_match_phy_device(phydev);
          printf("%d\n", benchRet); 
          free(phydev);
