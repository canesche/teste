...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_hash2_ptr0 = 1;
          unsigned int * hash2_ptr = (unsigned int *) malloc(_len_hash2_ptr0*sizeof(unsigned int));
          for(int _i0 = 0; _i0 < _len_hash2_ptr0; _i0++) {
            hash2_ptr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned int benchRet = stb_hash2(str,hash2_ptr);
          printf("%u\n", benchRet); 
          free(str);
          free(hash2_ptr);
