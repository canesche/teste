...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_vf0; _i0++) {
            vf[_i0].pci_func = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_vf__i0__vp0 = 1;
          vf[_i0].vp = (struct TYPE_4__ *) malloc(_len_vf__i0__vp0*sizeof(struct TYPE_4__));
          ...
          int benchRet = qlcnic_sriov_validate_get_nic_info(vf,cmd);
          printf("%d\n", benchRet); 
