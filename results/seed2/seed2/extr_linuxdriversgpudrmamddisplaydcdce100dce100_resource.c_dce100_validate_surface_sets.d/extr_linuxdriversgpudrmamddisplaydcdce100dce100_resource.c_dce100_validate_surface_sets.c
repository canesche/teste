...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          context[_i0].stream_status = (struct TYPE_4__ *) malloc(_len_context__i0__stream_status0*sizeof(struct TYPE_4__));
          ...
          context[_i0].stream_status->plane_states = (struct TYPE_3__ **) malloc(_len_context__i0__stream_status_plane_states0*sizeof(struct TYPE_3__ *));
          for(int _j0 = 0; _j0 < _len_context__i0__stream_status_plane_states0; _j0++) {
            int _len_context__i0__stream_status_plane_states1 = 1;
            context[_i0].stream_status->plane_states[_j0] = (struct TYPE_3__ *) malloc(_len_context__i0__stream_status_plane_states1*sizeof(struct TYPE_3__));
          ...
          int benchRet = dce100_validate_surface_sets(context);
          printf("%d\n", benchRet); 
