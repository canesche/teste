...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dst0; _i0++) {
              int _len_dst__i0__cpu_dp0 = 1;
          dst[_i0].cpu_dp = (int *) malloc(_len_dst__i0__cpu_dp0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dst__i0__cpu_dp0; _j0++) {
            dst[_i0].cpu_dp[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          dsa_tree_teardown_default_cpu(dst);
          for(int _aux = 0; _aux < _len_dst0; _aux++) {
          free(dst[_aux].cpu_dp);
          }
          free(dst);
