...
__attribute__((used)) static struct tps6586x_platform_data *tps6586x_parse_dt(struct i2c_client *client)
{
	return NULL;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct tps6586x_platform_data * benchRet = tps6586x_parse_dt(client);
          printf("%d\n", (*benchRet).dummy);
          free(client);
