...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_header0 = 1;
          struct rbd_image_header * header = (struct rbd_image_header *) malloc(_len_header0*sizeof(struct rbd_image_header));
          for(int _i0 = 0; _i0 < _len_header0; _i0++) {
            header[_i0].obj_order = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned int benchRet = rbd_obj_bytes(header);
          printf("%u\n", benchRet); 
          free(header);
