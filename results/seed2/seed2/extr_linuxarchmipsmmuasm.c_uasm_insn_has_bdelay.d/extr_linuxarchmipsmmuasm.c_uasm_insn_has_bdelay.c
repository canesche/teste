...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_rel0; _i0++) {
            rel[_i0].lab = ((-2 * (next_i()%2)) + 1) * next_i();
        rel[_i0].type = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_rel__i0__addr0 = 1;
          rel[_i0].addr = (int *) malloc(_len_rel__i0__addr0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_rel__i0__addr0; _j0++) {
            rel[_i0].addr[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_addr0 = 1;
          ...
          int benchRet = uasm_insn_has_bdelay(rel,addr);
          printf("%d\n", benchRet); 
