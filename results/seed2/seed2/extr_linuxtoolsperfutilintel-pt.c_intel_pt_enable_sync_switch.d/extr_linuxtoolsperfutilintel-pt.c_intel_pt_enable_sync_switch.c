...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pt0; _i0++) {
            pt[_i0].sync_switch = ((-2 * (next_i()%2)) + 1) * next_i();
        pt[_i0].queues.nr_queues = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_pt__i0__queues_queue_array0 = 1;
          pt[_i0].queues.queue_array = (struct auxtrace_queue *) malloc(_len_pt__i0__queues_queue_array0*sizeof(struct auxtrace_queue));
          ...
          for(int _j0 = 0; _j0 < _len_pt__i0__queues_queue_array_priv0; _j0++) {
            pt[_i0].queues.queue_array->priv->sync_switch = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
