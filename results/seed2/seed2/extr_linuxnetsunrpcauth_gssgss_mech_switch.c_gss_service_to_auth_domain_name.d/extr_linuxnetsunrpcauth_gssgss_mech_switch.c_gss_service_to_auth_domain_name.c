...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_gm__i0__gm_pfs_auth_domain_name0 = 1;
          gm[_i0].gm_pfs->auth_domain_name = (char *) malloc(_len_gm__i0__gm_pfs_auth_domain_name0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_gm__i0__gm_pfs_auth_domain_name0; _j0++) {
            gm[_i0].gm_pfs->auth_domain_name[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          char * benchRet = gss_service_to_auth_domain_name(gm,service);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
