...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dqm__i0__dev0; _j0++) {
              int _len_dqm__i0__dev_device_info0 = 1;
          dqm[_i0].dev->device_info = (struct TYPE_3__ *) malloc(_len_dqm__i0__dev_device_info0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_dqm__i0__dev_device_info0; _j0++) {
            dqm[_i0].dev->device_info->num_sdma_engines = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          unsigned int benchRet = get_num_sdma_engines(dqm);
          printf("%u\n", benchRet); 
