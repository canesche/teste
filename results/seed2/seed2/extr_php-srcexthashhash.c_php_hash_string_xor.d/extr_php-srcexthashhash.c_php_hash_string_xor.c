...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_xor_with0 = 1;
          const unsigned char * xor_with = (const unsigned char *) malloc(_len_xor_with0*sizeof(const unsigned char));
          for(int _i0 = 0; _i0 < _len_xor_with0; _i0++) {
            xor_with[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          php_hash_string_xor(out,in,xor_with,length);
          free(out);
          free(in);
          free(xor_with);
