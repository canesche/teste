...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          cpe[_i0].ch->band_type = (int *) malloc(_len_cpe__i0__ch_band_type0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_cpe__i0__ch_band_type0; _j0++) {
            cpe[_i0].ch->band_type[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cpe__i0__ch_is_ener0 = 1;
          cpe[_i0].ch->is_ener = (float *) malloc(_len_cpe__i0__ch_is_ener0*sizeof(float));
          for(int _j0 = 0; _j0 < _len_cpe__i0__ch_is_ener0; _j0++) {
            cpe[_i0].ch->is_ener[_j0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          int _len_cpe__i0__ch_coeffs0 = 1;
          cpe[_i0].ch->coeffs = (int *) malloc(_len_cpe__i0__ch_coeffs0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_cpe__i0__ch_coeffs0; _j0++) {
            cpe[_i0].ch->coeffs[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        ...
        cpe[_i0].ch->ics.num_swb = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          cpe[_i0].ms_mask = (long *) malloc(_len_cpe__i0__ms_mask0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_cpe__i0__ms_mask0; _j0++) {
            cpe[_i0].ms_mask[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cpe__i0__is_mask0 = 1;
          cpe[_i0].is_mask = (int *) malloc(_len_cpe__i0__is_mask0*sizeof(int));
