...
__attribute__((used)) static int vega10_trim_single_dpm_states(struct pp_hwmgr *hwmgr,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        dpm_table[_i0].dpm_levels->enabled = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = vega10_trim_single_dpm_states(hwmgr,dpm_table,low_limit,high_limit);
          printf("%d\n", benchRet); 
          free(hwmgr);
