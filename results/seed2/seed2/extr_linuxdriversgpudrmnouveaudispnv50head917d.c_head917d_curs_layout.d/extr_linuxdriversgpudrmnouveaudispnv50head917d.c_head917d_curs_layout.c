...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          asyw[_i0].state.fb = (struct TYPE_4__ *) malloc(_len_asyw__i0__state_fb0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_asyw__i0__state_fb0; _j0++) {
            asyw[_i0].state.fb->width = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_asyh0 = 1;
          ...
          int benchRet = head917d_curs_layout(head,asyw,asyh);
          printf("%d\n", benchRet); 
          free(head);
          free(asyw);
          free(asyh);
