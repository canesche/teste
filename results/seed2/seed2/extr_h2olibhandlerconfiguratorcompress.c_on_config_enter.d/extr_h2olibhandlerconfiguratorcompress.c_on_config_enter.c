...
struct compress_configurator_t {int /*<<< orphan*/ * vars; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int _len_configurator0 = 1;
          int * configurator = (int *) malloc(_len_configurator0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_configurator0; _i0++) {
            configurator[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ctx0 = 1;
          ...
          int benchRet = on_config_enter(configurator,ctx,node);
          printf("%d\n", benchRet); 
          free(configurator);
          free(ctx);
          free(node);
