...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_str10 = 1;
          const int * str1 = (const int *) malloc(_len_str10*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_str10; _i0++) {
            str1[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_str20 = 1;
          const int * str2 = (const int *) malloc(_len_str20*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_str20; _i0++) {
            str2[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = xmlStrcmp(str1,str2);
          printf("%d\n", benchRet); 
          free(str1);
          free(str2);
