...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          mlxsw_sp[_i0].sb = (struct TYPE_2__ *) malloc(_len_mlxsw_sp__i0__sb0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_mlxsw_sp__i0__sb0; _j0++) {
              int _len_mlxsw_sp__i0__sb_prs0 = 1;
          mlxsw_sp[_i0].sb->prs = (struct mlxsw_sp_sb_pr **) malloc(_len_mlxsw_sp__i0__sb_prs0*sizeof(struct mlxsw_sp_sb_pr *));
          for(int _j0 = 0; _j0 < _len_mlxsw_sp__i0__sb_prs0; _j0++) {
            int _len_mlxsw_sp__i0__sb_prs1 = 1;
            mlxsw_sp[_i0].sb->prs[_j0] = (struct mlxsw_sp_sb_pr *) malloc(_len_mlxsw_sp__i0__sb_prs1*sizeof(struct mlxsw_sp_sb_pr));
            for(int _j1 = 0; _j1 < _len_mlxsw_sp__i0__sb_prs1; _j1++) {
              mlxsw_sp[_i0].sb->prs[_j0]->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          }
          struct mlxsw_sp_sb_pr * benchRet = mlxsw_sp_sb_pr_get(mlxsw_sp,pool,dir);
          printf("%d\n", (*benchRet).dummy);
