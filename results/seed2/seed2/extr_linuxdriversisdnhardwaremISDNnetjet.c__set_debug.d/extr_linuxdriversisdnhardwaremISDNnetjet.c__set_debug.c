...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_card0 = 1;
          struct tiger_hw * card = (struct tiger_hw *) malloc(_len_card0*sizeof(struct tiger_hw));
          for(int _i0 = 0; _i0 < _len_card0; _i0++) {
              int _len_card__i0__bc0 = 1;
          card[_i0].bc = (struct TYPE_8__ *) malloc(_len_card__i0__bc0*sizeof(struct TYPE_8__));
          for(int _j0 = 0; _j0 < _len_card__i0__bc0; _j0++) {
              }
          }
          _set_debug(card);
