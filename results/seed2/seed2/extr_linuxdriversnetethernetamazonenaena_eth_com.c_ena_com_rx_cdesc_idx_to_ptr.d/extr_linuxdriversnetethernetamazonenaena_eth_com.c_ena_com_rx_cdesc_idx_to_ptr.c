...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_io_cq0; _i0++) {
            io_cq[_i0].q_depth = ((-2 * (next_i()%2)) + 1) * next_i();
        io_cq[_i0].cdesc_entry_size_in_bytes = ((-2 * (next_i()%2)) + 1) * next_i();
        io_cq[_i0].cdesc_addr.virt_addr = ((-2 * (next_i()%2)) + 1) * next_i();
          }
