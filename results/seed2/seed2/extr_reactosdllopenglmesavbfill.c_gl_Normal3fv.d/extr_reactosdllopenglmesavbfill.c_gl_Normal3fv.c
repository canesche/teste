...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          ctx[_i0].VB = (struct TYPE_5__ *) malloc(_len_ctx__i0__VB0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_ctx__i0__VB0; _j0++) {
            ctx[_i0].VB->MonoNormal = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_ctx__i0__Current_Normal0 = 1;
          ctx[_i0].Current.Normal = (int *) malloc(_len_ctx__i0__Current_Normal0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ctx__i0__Current_Normal0; _j0++) {
            ctx[_i0].Current.Normal[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_n0 = 1;
