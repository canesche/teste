...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_core_if0; _i0++) {
              int _len_core_if__i0__pcd_cb0 = 1;
          core_if[_i0].pcd_cb = (struct TYPE_6__ *) malloc(_len_core_if__i0__pcd_cb0*sizeof(struct TYPE_6__));
          for(int _j0 = 0; _j0 < _len_core_if__i0__pcd_cb0; _j0++) {
              }
          }
          int _len_cb0 = 1;
          ...
          void * p;
          dwc_otg_cil_register_pcd_callbacks(core_if,cb,p);
          for(int _aux = 0; _aux < _len_core_if0; _aux++) {
          free(core_if[_aux].pcd_cb);
          }
          free(core_if);
          free(cb);
