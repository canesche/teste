...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_dcode0; _i0++) {
              int _len_dcode__i0__buf0 = 1;
          dcode[_i0].buf = (unsigned char *) malloc(_len_dcode__i0__buf0*sizeof(unsigned char));
          for(int _j0 = 0; _j0 < _len_dcode__i0__buf0; _j0++) {
            dcode[_i0].buf[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = codabar_checksum(dcode,n);
          printf("%d\n", benchRet); 
