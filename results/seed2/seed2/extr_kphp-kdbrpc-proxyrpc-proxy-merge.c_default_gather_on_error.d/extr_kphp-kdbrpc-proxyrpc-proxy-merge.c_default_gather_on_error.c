...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_G0; _i0++) {
              int _len_G__i0__List0 = 1;
          G[_i0].List = (struct TYPE_2__ *) malloc(_len_G__i0__List0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_G__i0__List0; _j0++) {
            G[_i0].List->bytes = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
