...
__attribute__((used)) static unsigned long of_bus_sbus_get_flags(const u32 *addr, unsigned long flags)
{
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long benchRet = of_bus_sbus_get_flags(addr,flags);
          printf("%lu\n", benchRet); 
          free(addr);
