...
/* Type definitions */
struct TYPE_3__ {size_t rend; size_t rpos; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        f[_i0].rpos = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int _len_sizep0 = 1;
          unsigned long * sizep = (unsigned long *) malloc(_len_sizep0*sizeof(unsigned long));
          for(int _i0 = 0; _i0 < _len_sizep0; _i0++) {
            sizep[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          const char * benchRet = __freadptr(f,sizep);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          free(f);
          free(sizep);
