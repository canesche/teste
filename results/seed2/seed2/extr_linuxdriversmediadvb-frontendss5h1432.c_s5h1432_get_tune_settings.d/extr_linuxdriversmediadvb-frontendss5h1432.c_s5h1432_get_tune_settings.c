...
__attribute__((used)) static int s5h1432_get_tune_settings(struct dvb_frontend *fe,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_tune0; _i0++) {
            tune[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = s5h1432_get_tune_settings(fe,tune);
          printf("%d\n", benchRet); 
          free(fe);
          free(tune);
