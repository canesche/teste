...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          et[_i0].et_object = (struct ocfs2_dx_root_block *) malloc(_len_et__i0__et_object0*sizeof(struct ocfs2_dx_root_block));
          for(int _j0 = 0; _j0 < _len_et__i0__et_object0; _j0++) {
            et[_i0].et_object->dr_list = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ocfs2_dx_root_fill_root_el(et);
