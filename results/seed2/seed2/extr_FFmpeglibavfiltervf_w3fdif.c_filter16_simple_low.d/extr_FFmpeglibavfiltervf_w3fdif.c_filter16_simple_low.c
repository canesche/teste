...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_in_lines_cur80 = 2;
          int ** in_lines_cur8 = (int **) malloc(_len_in_lines_cur80*sizeof(int *));
          for(int _i0 = 0; _i0 < _len_in_lines_cur80; _i0++) {
            int _len_in_lines_cur81 = 1;
            in_lines_cur8[_i0] = (int *) malloc(_len_in_lines_cur81*sizeof(int));
            for(int _i1 = 0; _i1 < _len_in_lines_cur81; _i1++) {
              in_lines_cur8[_i0][_i1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          int _len_coef0 = 1;
          ...
          filter16_simple_low(work_line,in_lines_cur8,coef,linesize);
          free(work_line);
          for(int i1 = 0; i1 < _len_in_lines_cur80; i1++) {
            int _len_in_lines_cur81 = 1;
              free(in_lines_cur8[i1]);
          }
          free(in_lines_cur8);
          free(coef);
