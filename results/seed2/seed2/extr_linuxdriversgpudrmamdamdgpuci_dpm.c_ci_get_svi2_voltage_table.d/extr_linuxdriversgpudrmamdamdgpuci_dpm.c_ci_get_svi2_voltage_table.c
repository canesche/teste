...
__attribute__((used)) static int ci_get_svi2_voltage_table(struct amdgpu_device *adev,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          struct amdgpu_clock_voltage_dependency_table * voltage_dependency_table = (struct amdgpu_clock_voltage_dependency_table *) malloc(_len_voltage_dependency_table0*sizeof(struct amdgpu_clock_voltage_dependency_table));
        ...
        voltage_table[_i0].mask_low = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = ci_get_svi2_voltage_table(adev,voltage_dependency_table,voltage_table);
          printf("%d\n", benchRet); 
          free(adev);
