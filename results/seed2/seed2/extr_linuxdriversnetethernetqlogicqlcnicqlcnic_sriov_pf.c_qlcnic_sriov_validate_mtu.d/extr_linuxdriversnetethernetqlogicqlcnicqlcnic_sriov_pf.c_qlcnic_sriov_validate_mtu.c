...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_adapter__i0__ahw0; _j0++) {
            adapter[_i0].ahw->max_mtu = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_vf0 = 1;
          ...
          for(int _i0 = 0; _i0 < _len_vf0; _i0++) {
            vf[_i0].rx_ctx_id = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_cmd0 = 1;
          ...
          cmd[_i0].req.arg = (long *) malloc(_len_cmd__i0__req_arg0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_cmd__i0__req_arg0; _j0++) {
            cmd[_i0].req.arg[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = qlcnic_sriov_validate_mtu(adapter,vf,cmd);
          printf("%d\n", benchRet); 
