...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          enum dm_uevent_type event_type = 0;
          unsigned int nr_valid_paths = 100;
          int _len_ti0 = 1;
          ...
          dm_path_uevent(event_type,ti,path,nr_valid_paths);
          free(ti);
          free(path);
    ...
    {
          enum dm_uevent_type event_type = 0;
          unsigned int nr_valid_paths = 255;
          int _len_ti0 = 65025;
          struct dm_target * ti = (struct dm_target *) malloc(_len_ti0*sizeof(struct dm_target));
          for(int _i0 = 0; _i0 < _len_ti0; _i0++) {
            ti[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
    ...
    {
          enum dm_uevent_type event_type = 0;
          unsigned int nr_valid_paths = 10;
          int _len_ti0 = 100;
          struct dm_target * ti = (struct dm_target *) malloc(_len_ti0*sizeof(struct dm_target));
          for(int _i0 = 0; _i0 < _len_ti0; _i0++) {
            ti[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
