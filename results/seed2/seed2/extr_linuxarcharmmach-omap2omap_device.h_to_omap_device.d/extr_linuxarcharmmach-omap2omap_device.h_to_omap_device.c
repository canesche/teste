...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_pdev0; _i0++) {
              int _len_pdev__i0__archdata_od0 = 1;
          pdev[_i0].archdata.od = (struct omap_device *) malloc(_len_pdev__i0__archdata_od0*sizeof(struct omap_device));
          for(int _j0 = 0; _j0 < _len_pdev__i0__archdata_od0; _j0++) {
            pdev[_i0].archdata.od->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct omap_device * benchRet = to_omap_device(pdev);
          printf("%d\n", (*benchRet).dummy);
          free(pdev);
