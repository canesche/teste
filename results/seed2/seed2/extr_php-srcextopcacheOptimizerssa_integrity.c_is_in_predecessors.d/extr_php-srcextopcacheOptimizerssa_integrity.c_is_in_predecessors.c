...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int check = 100;
          int _len_cfg0 = 1;
          struct TYPE_5__ * cfg = (struct TYPE_5__ *) malloc(_len_cfg0*sizeof(struct TYPE_5__));
          for(int _i0 = 0; _i0 < _len_cfg0; _i0++) {
              int _len_cfg__i0__predecessors0 = 1;
          cfg[_i0].predecessors = (int *) malloc(_len_cfg__i0__predecessors0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_cfg__i0__predecessors0; _j0++) {
            cfg[_i0].predecessors[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_block0 = 1;
          struct TYPE_6__ * block = (struct TYPE_6__ *) malloc(_len_block0*sizeof(struct TYPE_6__));
        ...
        block[_i0].predecessors_count = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          int benchRet = is_in_predecessors(cfg,block,check);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_cfg0; _aux++) {
          free(cfg[_aux].predecessors);
          }
          free(cfg);
          free(block);
