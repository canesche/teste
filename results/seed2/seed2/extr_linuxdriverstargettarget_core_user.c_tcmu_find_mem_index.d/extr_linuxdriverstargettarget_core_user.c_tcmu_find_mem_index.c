...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vma[_i0].vm_private_data = (struct tcmu_dev *) malloc(_len_vma__i0__vm_private_data0*sizeof(struct tcmu_dev));
          for(int _j0 = 0; _j0 < _len_vma__i0__vm_private_data0; _j0++) {
              int _len_vma__i0__vm_private_data_uio_info_mem0 = 1;
          vma[_i0].vm_private_data->uio_info.mem = (struct TYPE_2__ *) malloc(_len_vma__i0__vm_private_data_uio_info_mem0*sizeof(struct TYPE_2__));
          for(int _j0 = 0; _j0 < _len_vma__i0__vm_private_data_uio_info_mem0; _j0++) {
            vma[_i0].vm_private_data->uio_info.mem->size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = tcmu_find_mem_index(vma);
          printf("%d\n", benchRet); 
