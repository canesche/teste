...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_parser0; _i0++) {
              int _len_parser__i0__end0 = 1;
          parser[_i0].end = (const long *) malloc(_len_parser__i0__end0*sizeof(const long));
          for(int _j0 = 0; _j0 < _len_parser__i0__end0; _j0++) {
            parser[_i0].end[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_ptr0 = 1;
          const long * ptr = (const long *) malloc(_len_ptr0*sizeof(const long));
          for(int _i0 = 0; _i0 < _len_ptr0; _i0++) {
            ptr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = is_eof(parser,ptr);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_parser0; _aux++) {
          free(parser[_aux].end);
          }
          free(parser);
          free(ptr);
