...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData0; _j0++) {
              int _len_phost__i0__pActiveClass_pData_unit0 = 1;
          phost[_i0].pActiveClass->pData->unit = (struct TYPE_7__ *) malloc(_len_phost__i0__pActiveClass_pData_unit0*sizeof(struct TYPE_7__));
          for(int _j0 = 0; _j0 < _len_phost__i0__pActiveClass_pData_unit0; _j0++) {
            phost[_i0].pActiveClass->pData->unit->error = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
          unsigned long benchRet = USBH_MSC_UnitIsReady(phost,lun);
          printf("%lu\n", benchRet); 
