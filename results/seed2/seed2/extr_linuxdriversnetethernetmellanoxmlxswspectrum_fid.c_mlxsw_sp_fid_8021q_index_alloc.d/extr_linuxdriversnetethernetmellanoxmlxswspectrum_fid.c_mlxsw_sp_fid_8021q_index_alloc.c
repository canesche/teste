...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fid[_i0].fid_family = (struct mlxsw_sp_fid_family *) malloc(_len_fid__i0__fid_family0*sizeof(struct mlxsw_sp_fid_family));
          for(int _j0 = 0; _j0 < _len_fid__i0__fid_family0; _j0++) {
            fid[_i0].fid_family->start_index = ((-2 * (next_i()%2)) + 1) * next_i();
        fid[_i0].fid_family->end_index = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_arg0 = 1;
          ...
          int benchRet = mlxsw_sp_fid_8021q_index_alloc(fid,arg,p_fid_index);
          printf("%d\n", benchRet); 
