...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          connector[_i0].dev->dev_private = (struct amdgpu_device *) malloc(_len_connector__i0__dev_dev_private0*sizeof(struct amdgpu_device));
          for(int _j0 = 0; _j0 < _len_connector__i0__dev_dev_private0; _j0++) {
            connector[_i0].dev->dev_private->clock.max_pixel_clock = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_mode0 = 1;
          ...
          enum drm_mode_status benchRet = amdgpu_connector_vga_mode_valid(connector,mode);
