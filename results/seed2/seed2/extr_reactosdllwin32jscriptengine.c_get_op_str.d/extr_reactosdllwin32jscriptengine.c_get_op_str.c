...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_ctx__i0__call_ctx_bytecode_instrs_u_arg0; _j0++) {
              int _len_ctx__i0__call_ctx_bytecode_instrs_u_arg_str0 = 1;
          ctx[_i0].call_ctx->bytecode->instrs->u.arg->str = (int *) malloc(_len_ctx__i0__call_ctx_bytecode_instrs_u_arg_str0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_ctx__i0__call_ctx_bytecode_instrs_u_arg_str0; _j0++) {
            ctx[_i0].call_ctx->bytecode->instrs->u.arg->str[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          }
