...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        pin[_i0].rx_bit = ((-2 * (next_i()%2)) + 1) * next_i();
          int _len_pin__i0__rx_msg_msg0 = 1;
          pin[_i0].rx_msg.msg = (unsigned long *) malloc(_len_pin__i0__rx_msg_msg0*sizeof(unsigned long));
          for(int _j0 = 0; _j0 < _len_pin__i0__rx_msg_msg0; _j0++) {
            pin[_i0].rx_msg.msg[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          unsigned long benchRet = cec_pin_rx_error_inj(pin);
          printf("%lu\n", benchRet); 
