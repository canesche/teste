...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          long length = 100;
          int _len_bi0 = 1;
          struct e1000_rx_buffer * bi = (struct e1000_rx_buffer *) malloc(_len_bi0*sizeof(struct e1000_rx_buffer));
          for(int _i0 = 0; _i0 < _len_bi0; _i0++) {
              int _len_bi__i0__rxbuf_page0 = 1;
          bi[_i0].rxbuf.page = (int *) malloc(_len_bi__i0__rxbuf_page0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_bi__i0__rxbuf_page0; _j0++) {
            bi[_i0].rxbuf.page[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_skb0 = 1;
          struct sk_buff * skb = (struct sk_buff *) malloc(_len_skb0*sizeof(struct sk_buff));
          for(int _i0 = 0; _i0 < _len_skb0; _i0++) {
            skb[_i0].truesize = ((-2 * (next_i()%2)) + 1) * next_i();
        skb[_i0].data_len = ((-2 * (next_i()%2)) + 1) * next_i();
        skb[_i0].len = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          e1000_consume_page(bi,skb,length);
          free(bi);
          free(skb);
