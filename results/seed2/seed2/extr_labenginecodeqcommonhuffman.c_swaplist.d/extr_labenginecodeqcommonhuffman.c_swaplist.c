...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          struct TYPE_4__ * aux_node1[10000];
          struct TYPE_4__ * node1 = _allocate_node1(10000, aux_node1);
          struct TYPE_4__ * aux_node2[10000];
          struct TYPE_4__ * node2 = _allocate_node2(10000, aux_node2);
          swaplist(node1,node2);
          _delete_node1(aux_node1, 10000);
          _delete_node2(aux_node2, 10000);
