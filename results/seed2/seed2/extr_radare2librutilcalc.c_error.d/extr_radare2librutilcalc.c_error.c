...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_nc0; _i0++) {
              int _len_nc__i0__calc_err0 = 1;
          nc[_i0].calc_err = (const char *) malloc(_len_nc__i0__calc_err0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_nc__i0__calc_err0; _j0++) {
            nc[_i0].calc_err[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        nc[_i0].errors = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_s0 = 1;
