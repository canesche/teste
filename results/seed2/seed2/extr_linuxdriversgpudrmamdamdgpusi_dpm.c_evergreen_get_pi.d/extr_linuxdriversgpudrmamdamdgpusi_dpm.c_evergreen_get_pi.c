...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          adev[_i0].pm.dpm.priv = (struct evergreen_power_info *) malloc(_len_adev__i0__pm_dpm_priv0*sizeof(struct evergreen_power_info));
          for(int _j0 = 0; _j0 < _len_adev__i0__pm_dpm_priv0; _j0++) {
            adev[_i0].pm.dpm.priv->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          struct evergreen_power_info * benchRet = evergreen_get_pi(adev);
          printf("%d\n", (*benchRet).dummy);
          free(adev);
