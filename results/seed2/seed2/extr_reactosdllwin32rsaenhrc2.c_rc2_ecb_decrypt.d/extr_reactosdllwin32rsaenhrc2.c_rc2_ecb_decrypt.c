...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_cipher0 = 1;
          const unsigned char * cipher = (const unsigned char *) malloc(_len_cipher0*sizeof(const unsigned char));
          for(int _i0 = 0; _i0 < _len_cipher0; _i0++) {
            cipher[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_plain0 = 1;
          unsigned char * plain = (unsigned char *) malloc(_len_plain0*sizeof(unsigned char));
          ...
          rc2_ecb_decrypt(cipher,plain,rc2);
          free(cipher);
          free(plain);
