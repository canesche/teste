...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_tb0 = 1;
          struct trace_buffer * tb = (struct trace_buffer *) malloc(_len_tb0*sizeof(struct trace_buffer));
          for(int _i0 = 0; _i0 < _len_tb0; _i0++) {
            tb[_i0].size = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * p;
          int benchRet = trace_check_bounds(tb,p);
          printf("%d\n", benchRet); 
          free(tb);
