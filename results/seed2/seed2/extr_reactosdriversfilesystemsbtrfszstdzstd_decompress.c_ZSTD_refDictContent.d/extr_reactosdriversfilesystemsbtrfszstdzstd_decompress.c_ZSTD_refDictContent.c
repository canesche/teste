...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dctx[_i0].dictEnd = (const char *) malloc(_len_dctx__i0__dictEnd0*sizeof(const char));
          ...
          dctx[_i0].previousDstEnd = (const char *) malloc(_len_dctx__i0__previousDstEnd0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_dctx__i0__previousDstEnd0; _j0++) {
            dctx[_i0].previousDstEnd[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dctx__i0__virtualStart0 = 1;
          dctx[_i0].virtualStart = (const char *) malloc(_len_dctx__i0__virtualStart0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_dctx__i0__virtualStart0; _j0++) {
            dctx[_i0].virtualStart[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_dctx__i0__prefixStart0 = 1;
          dctx[_i0].prefixStart = (const void *) malloc(_len_dctx__i0__prefixStart0*sizeof(const void));
          for(int _j0 = 0; _j0 < _len_dctx__i0__prefixStart0; _j0++) {
            dctx[_i0].prefixStart[_j0] = 0;
          }
          }
          int _len_dict0 = 1;
          ...
          unsigned long benchRet = ZSTD_refDictContent(dctx,dict,dictSize);
          printf("%lu\n", benchRet); 
