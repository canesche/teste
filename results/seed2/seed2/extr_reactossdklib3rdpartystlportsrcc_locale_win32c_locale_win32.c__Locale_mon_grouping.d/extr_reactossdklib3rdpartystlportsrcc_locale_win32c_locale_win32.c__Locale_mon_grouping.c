...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_lmon0; _i0++) {
              int _len_lmon__i0__grouping0 = 1;
          lmon[_i0].grouping = (const char *) malloc(_len_lmon__i0__grouping0*sizeof(const char));
          for(int _j0 = 0; _j0 < _len_lmon__i0__grouping0; _j0++) {
            lmon[_i0].grouping[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          const char * benchRet = _Locale_mon_grouping(lmon);
          printf("%c\n", ((*benchRet) %26) + 'a'); 
          for(int _aux = 0; _aux < _len_lmon0; _aux++) {
          free(lmon[_aux].grouping);
          }
          free(lmon);
