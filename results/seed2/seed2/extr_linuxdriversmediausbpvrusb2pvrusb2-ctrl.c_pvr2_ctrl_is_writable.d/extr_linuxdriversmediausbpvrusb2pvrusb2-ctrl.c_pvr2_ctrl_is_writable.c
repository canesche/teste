...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_cptr__i0__info0; _j0++) {
              int _len_cptr__i0__info_set_value0 = 1;
          cptr[_i0].info->set_value = (int *) malloc(_len_cptr__i0__info_set_value0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_cptr__i0__info_set_value0; _j0++) {
            cptr[_i0].info->set_value[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = pvr2_ctrl_is_writable(cptr);
          printf("%d\n", benchRet); 
