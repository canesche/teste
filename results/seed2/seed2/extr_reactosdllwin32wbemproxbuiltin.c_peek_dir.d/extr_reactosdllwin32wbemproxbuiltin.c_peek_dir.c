...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          dirstack[_i0].dirs = (const int **) malloc(_len_dirstack__i0__dirs0*sizeof(const int *));
          for(int _j0 = 0; _j0 < _len_dirstack__i0__dirs0; _j0++) {
            int _len_dirstack__i0__dirs1 = 1;
            dirstack[_i0].dirs[_j0] = (const int *) malloc(_len_dirstack__i0__dirs1*sizeof(const int));
            for(int _j1 = 0; _j1 < _len_dirstack__i0__dirs1; _j1++) {
              dirstack[_i0].dirs[_j0][_j1] = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          const int * benchRet = peek_dir(dirstack);
          printf("%d\n", (*benchRet)); 
