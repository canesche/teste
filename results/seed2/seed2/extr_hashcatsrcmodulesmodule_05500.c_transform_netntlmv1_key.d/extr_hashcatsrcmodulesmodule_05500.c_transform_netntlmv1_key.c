...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_nthash0 = 1;
          const int * nthash = (const int *) malloc(_len_nthash0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_nthash0; _i0++) {
            nthash[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_key0 = 1;
          ...
          transform_netntlmv1_key(nthash,key);
          free(nthash);
          free(key);
