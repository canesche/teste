...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          h[_i0].data = (long ***) malloc(_len_h__i0__data0*sizeof(long **));
          for(int _j0 = 0; _j0 < _len_h__i0__data0; _j0++) {
            int _len_h__i0__data1 = 1;
            h[_i0].data[_j0] = (long **) malloc(_len_h__i0__data1*sizeof(long *));
            for(int _j1 = 0; _j1 < _len_h__i0__data1; _j1++) {
              int _len_h__i0__data2 = 1;
              h[_i0].data[_j0][_j1] = (long *) malloc(_len_h__i0__data2*sizeof(long));
          ...
          unsigned int benchRet = histogram_count(h,r_min,r_max,g_min,g_max,b_min,b_max);
          printf("%u\n", benchRet); 
