...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_clen_p0 = 1;
          unsigned long long * clen_p = (unsigned long long *) malloc(_len_clen_p0*sizeof(unsigned long long));
          for(int _i0 = 0; _i0 < _len_clen_p0; _i0++) {
            clen_p[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_m0 = 1;
          ...
          int benchRet = crypto_aead_aes256gcm_encrypt_afternm(c,clen_p,m,mlen,ad,adlen,nsec,npub,ctx_);
          printf("%d\n", benchRet); 
          free(c);
          free(clen_p);
          free(m);
