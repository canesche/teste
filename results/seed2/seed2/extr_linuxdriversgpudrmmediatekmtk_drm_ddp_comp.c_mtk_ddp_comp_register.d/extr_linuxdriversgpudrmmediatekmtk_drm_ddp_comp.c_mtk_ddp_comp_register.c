...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          drm[_i0].dev_private->ddp_comp = (struct mtk_ddp_comp **) malloc(_len_drm__i0__dev_private_ddp_comp0*sizeof(struct mtk_ddp_comp *));
          for(int _j0 = 0; _j0 < _len_drm__i0__dev_private_ddp_comp0; _j0++) {
            int _len_drm__i0__dev_private_ddp_comp1 = 1;
            drm[_i0].dev_private->ddp_comp[_j0] = (struct mtk_ddp_comp *) malloc(_len_drm__i0__dev_private_ddp_comp1*sizeof(struct mtk_ddp_comp));
            for(int _j1 = 0; _j1 < _len_drm__i0__dev_private_ddp_comp1; _j1++) {
              drm[_i0].dev_private->ddp_comp[_j0]->id = ((-2 * (next_i()%2)) + 1) * next_i();
            }
          }
          }
          }
          ...
          int benchRet = mtk_ddp_comp_register(drm,comp);
          printf("%d\n", benchRet); 
