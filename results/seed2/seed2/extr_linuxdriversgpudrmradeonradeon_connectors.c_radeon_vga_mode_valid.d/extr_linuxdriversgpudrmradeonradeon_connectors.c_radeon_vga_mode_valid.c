...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          connector[_i0].dev->dev_private = (struct radeon_device *) malloc(_len_connector__i0__dev_dev_private0*sizeof(struct radeon_device));
          ...
          enum drm_mode_status benchRet = radeon_vga_mode_valid(connector,mode);
