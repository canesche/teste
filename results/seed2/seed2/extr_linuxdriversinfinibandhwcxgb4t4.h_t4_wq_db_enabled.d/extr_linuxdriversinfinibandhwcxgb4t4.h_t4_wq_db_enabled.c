...
struct TYPE_4__ {int /*<<< orphan*/  db_off; } ;
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_wq__i0__rq_queue0 = 1;
          wq[_i0].rq.queue = (struct TYPE_5__ *) malloc(_len_wq__i0__rq_queue0*sizeof(struct TYPE_5__));
          for(int _j0 = 0; _j0 < _len_wq__i0__rq_queue0; _j0++) {
            wq[_i0].rq.queue->status.db_off = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = t4_wq_db_enabled(wq);
          printf("%d\n", benchRet); 
          free(wq);
