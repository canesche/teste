...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_queue0; _i0++) {
              int _len_queue__i0__head_tqh_first0 = 1;
          queue[_i0].head.tqh_first = (int *) malloc(_len_queue__i0__head_tqh_first0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_queue__i0__head_tqh_first0; _j0++) {
            queue[_i0].head.tqh_first[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int benchRet = emptyEventQueue(queue);
          printf("%d\n", benchRet); 
          free(queue);
