...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_vblwait0 = 1;
          union drm_wait_vblank * vblwait = (union drm_wait_vblank *) malloc(_len_vblwait0*sizeof(union drm_wait_vblank));
          for(int _i0 = 0; _i0 < _len_vblwait0; _i0++) {
            vblwait[_i0] = 0;
          }
          int benchRet = drm_wait_vblank_is_query(vblwait);
          printf("%d\n", benchRet); 
          free(vblwait);
