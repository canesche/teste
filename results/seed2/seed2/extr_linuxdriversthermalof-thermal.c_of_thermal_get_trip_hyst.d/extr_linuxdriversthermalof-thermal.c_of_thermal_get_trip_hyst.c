...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_tz__i0__devdata_trips0; _j0++) {
            tz[_i0].devdata->trips->hysteresis = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_hyst0 = 1;
          int * hyst = (int *) malloc(_len_hyst0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_hyst0; _i0++) {
            hyst[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = of_thermal_get_trip_hyst(tz,trip,hyst);
          printf("%d\n", benchRet); 
