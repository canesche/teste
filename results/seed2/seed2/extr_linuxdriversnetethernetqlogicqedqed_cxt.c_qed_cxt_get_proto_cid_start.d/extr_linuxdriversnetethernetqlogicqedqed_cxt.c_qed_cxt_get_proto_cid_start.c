...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_p_hwfn__i0__p_cxt_mngr0; _j0++) {
              int _len_p_hwfn__i0__p_cxt_mngr_acquired0 = 1;
          p_hwfn[_i0].p_cxt_mngr->acquired = (struct TYPE_3__ *) malloc(_len_p_hwfn__i0__p_cxt_mngr_acquired0*sizeof(struct TYPE_3__));
          for(int _j0 = 0; _j0 < _len_p_hwfn__i0__p_cxt_mngr_acquired0; _j0++) {
            p_hwfn[_i0].p_cxt_mngr->acquired->start_cid = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int benchRet = qed_cxt_get_proto_cid_start(p_hwfn,type);
          printf("%d\n", benchRet); 
