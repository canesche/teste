...
__attribute__((used)) static void tb_buffer_sanity_check(struct super_block *sb,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_descr0 = 1;
          const char * descr = (const char *) malloc(_len_descr0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_descr0; _i0++) {
            descr[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          tb_buffer_sanity_check(sb,bh,descr,level);
          free(sb);
          free(bh);
          free(descr);
