...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_flag0 = 1;
          struct TYPE_3__ * flag = (struct TYPE_3__ *) malloc(_len_flag0*sizeof(struct TYPE_3__));
          for(int _i0 = 0; _i0 < _len_flag0; _i0++) {
            flag[_i0].offset = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * user;
          int benchRet = find_flag_after(flag,user);
          printf("%d\n", benchRet); 
          free(flag);
