...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_pa0 = 1;
          const void * pa = (const void *) malloc(_len_pa0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_pa0; _i0++) {
            pa[_i0] = 0;
          }
          int _len_pb0 = 1;
          const void * pb = (const void *) malloc(_len_pb0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_pb0; _i0++) {
            pb[_i0] = 0;
          }
          int benchRet = compare_seekpoint(pa,pb);
          printf("%d\n", benchRet); 
          free(pa);
          free(pb);
