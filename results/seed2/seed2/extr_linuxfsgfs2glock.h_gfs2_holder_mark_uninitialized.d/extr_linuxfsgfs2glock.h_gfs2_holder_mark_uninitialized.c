...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_gh0; _i0++) {
              int _len_gh__i0__gh_gl0 = 1;
          gh[_i0].gh_gl = (int *) malloc(_len_gh__i0__gh_gl0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_gh__i0__gh_gl0; _j0++) {
            gh[_i0].gh_gl[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          gfs2_holder_mark_uninitialized(gh);
          for(int _aux = 0; _aux < _len_gh0; _aux++) {
          free(gh[_aux].gh_gl);
          }
          free(gh);
