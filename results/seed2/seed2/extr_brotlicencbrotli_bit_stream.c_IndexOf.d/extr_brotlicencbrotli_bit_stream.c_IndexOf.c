...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          unsigned long v_size = 100;
          const long value = 100;
          int _len_v0 = 1;
          const long * v = (const long *) malloc(_len_v0*sizeof(const long));
          for(int _i0 = 0; _i0 < _len_v0; _i0++) {
            v[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          unsigned long benchRet = IndexOf(v,v_size,value);
          printf("%lu\n", benchRet); 
          free(v);
