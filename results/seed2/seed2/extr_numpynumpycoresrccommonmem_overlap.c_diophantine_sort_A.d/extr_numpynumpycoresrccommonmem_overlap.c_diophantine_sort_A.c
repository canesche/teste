...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_xp0 = 1;
          const void * xp = (const void *) malloc(_len_xp0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_xp0; _i0++) {
            xp[_i0] = 0;
          }
          int _len_yp0 = 1;
          const void * yp = (const void *) malloc(_len_yp0*sizeof(const void));
          for(int _i0 = 0; _i0 < _len_yp0; _i0++) {
            yp[_i0] = 0;
          }
          int benchRet = diophantine_sort_A(xp,yp);
          printf("%d\n", benchRet); 
          free(xp);
          free(yp);
