...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_old0 = 1;
          const long * old = (const long *) malloc(_len_old0*sizeof(const long));
          for(int _i0 = 0; _i0 < _len_old0; _i0++) {
            old[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_new0 = 1;
          const long * new = (const long *) malloc(_len_new0*sizeof(const long));
          for(int _i0 = 0; _i0 < _len_new0; _i0++) {
            new[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = var_inter(old,new);
          printf("%d\n", benchRet); 
          free(old);
          free(new);
