...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int ccfg = 100;
          int _len_ds0 = 1;
          struct zx_dma_desc_sw * ds = (struct zx_dma_desc_sw *) malloc(_len_ds0*sizeof(struct zx_dma_desc_sw));
          ...
          for(int _j0 = 0; _j0 < _len_ds__i0__desc_hw0; _j0++) {
            ds[_i0].desc_hw->src_x = ((-2 * (next_i()%2)) + 1) * next_i();
        ds[_i0].desc_hw->ctr = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        ds[_i0].desc_hw_lli = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          void * dst;
          void * src;
          zx_dma_fill_desc(ds,dst,src,len,num,ccfg);
