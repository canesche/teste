...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          unsigned long StartPage = 100;
          unsigned long PageCount = 100;
          int MemoryType = 100;
          int benchRet = MmAllocatePagesInLookupTable(PageLookupTable,StartPage,PageCount,MemoryType);
          printf("%d\n", benchRet); 
    ...
    case 1:
    {
          ...
          unsigned long StartPage = 255;
          unsigned long PageCount = 255;
          int MemoryType = 255;
          int benchRet = MmAllocatePagesInLookupTable(PageLookupTable,StartPage,PageCount,MemoryType);
          printf("%d\n", benchRet); 
    ...
    case 2:
    {
          ...
          unsigned long StartPage = 10;
          unsigned long PageCount = 10;
          int MemoryType = 10;
          int benchRet = MmAllocatePagesInLookupTable(PageLookupTable,StartPage,PageCount,MemoryType);
          printf("%d\n", benchRet); 
