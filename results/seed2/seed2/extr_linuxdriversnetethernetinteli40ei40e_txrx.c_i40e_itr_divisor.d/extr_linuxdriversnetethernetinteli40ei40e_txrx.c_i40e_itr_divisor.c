...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_q_vector0; _i0++) {
              int _len_q_vector__i0__vsi0 = 1;
          q_vector[_i0].vsi = (struct TYPE_10__ *) malloc(_len_q_vector__i0__vsi0*sizeof(struct TYPE_10__));
          for(int _j0 = 0; _j0 < _len_q_vector__i0__vsi0; _j0++) {
              int _len_q_vector__i0__vsi_back0 = 1;
          q_vector[_i0].vsi->back = (struct TYPE_9__ *) malloc(_len_q_vector__i0__vsi_back0*sizeof(struct TYPE_9__));
          for(int _j0 = 0; _j0 < _len_q_vector__i0__vsi_back0; _j0++) {
            q_vector[_i0].vsi->back->hw.phy.link_info.link_speed = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
