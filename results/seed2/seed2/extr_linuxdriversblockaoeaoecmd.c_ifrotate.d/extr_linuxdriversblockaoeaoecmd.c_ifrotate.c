...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_t0; _i0++) {
              int _len_t__i0__ifp0 = 1;
          t[_i0].ifp = (struct aoeif *) malloc(_len_t__i0__ifp0*sizeof(struct aoeif));
          for(int _j0 = 0; _j0 < _len_t__i0__ifp0; _j0++) {
              int _len_t__i0__ifp_nd0 = 1;
          t[_i0].ifp->nd = (int *) malloc(_len_t__i0__ifp_nd0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_t__i0__ifp_nd0; _j0++) {
            t[_i0].ifp->nd[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          ...
          t[_i0].ifs->nd = (int *) malloc(_len_t__i0__ifs_nd0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_t__i0__ifs_nd0; _j0++) {
            t[_i0].ifs->nd[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          struct aoeif * benchRet = ifrotate(t);
