...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_tfm0 = 1;
          struct crypto_rng * tfm = (struct crypto_rng *) malloc(_len_tfm0*sizeof(struct crypto_rng));
          for(int _i0 = 0; _i0 < _len_tfm0; _i0++) {
            tfm[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_seed0 = 1;
          const int * seed = (const int *) malloc(_len_seed0*sizeof(const int));
          for(int _i0 = 0; _i0 < _len_seed0; _i0++) {
            seed[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = jent_kcapi_reset(tfm,seed,slen);
          printf("%d\n", benchRet); 
          free(tfm);
          free(seed);
