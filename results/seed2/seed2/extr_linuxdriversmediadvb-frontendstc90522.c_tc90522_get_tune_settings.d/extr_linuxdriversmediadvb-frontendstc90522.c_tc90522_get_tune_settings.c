...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_fe0; _i0++) {
              int _len_fe__i0__ops_delsys0 = 1;
          fe[_i0].ops.delsys = (long *) malloc(_len_fe__i0__ops_delsys0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_fe__i0__ops_delsys0; _j0++) {
            fe[_i0].ops.delsys[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
        ...
        settings[_i0].step_size = ((-2 * (next_i()%2)) + 1) * next_i();
        settings[_i0].max_drift = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = tc90522_get_tune_settings(fe,settings);
          printf("%d\n", benchRet); 
          free(fe);
          free(settings);
