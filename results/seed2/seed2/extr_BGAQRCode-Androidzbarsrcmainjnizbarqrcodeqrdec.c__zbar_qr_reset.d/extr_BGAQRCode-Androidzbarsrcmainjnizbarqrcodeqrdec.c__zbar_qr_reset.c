...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_reader0; _i0++) {
              int _len_reader__i0__finder_lines0 = 1;
          reader[_i0].finder_lines = (struct TYPE_4__ *) malloc(_len_reader__i0__finder_lines0*sizeof(struct TYPE_4__));
          for(int _j0 = 0; _j0 < _len_reader__i0__finder_lines0; _j0++) {
            reader[_i0].finder_lines->nlines = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          _zbar_qr_reset(reader);
          for(int _aux = 0; _aux < _len_reader0; _aux++) {
          free(reader[_aux].finder_lines);
          }
          free(reader);
