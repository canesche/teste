...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_tzdev__i0__devdata_trips0; _j0++) {
            tzdev[_i0].devdata->trips->type = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_p_type0 = 1;
          enum thermal_trip_type * p_type = (enum thermal_trip_type *) malloc(_len_p_type0*sizeof(enum thermal_trip_type));
          for(int _i0 = 0; _i0 < _len_p_type0; _i0++) {
            p_type[_i0] = 0;
          }
          int benchRet = mlxsw_thermal_get_trip_type(tzdev,trip,p_type);
          printf("%d\n", benchRet); 
