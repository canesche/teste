...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_host__i0__default_ctx_task0 = 1;
          host[_i0].default_ctx.task = (struct task_struct *) malloc(_len_host__i0__default_ctx_task0*sizeof(struct task_struct));
          for(int _j0 = 0; _j0 < _len_host__i0__default_ctx_task0; _j0++) {
            host[_i0].default_ctx.task->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          int _len_ctx0 = 1;
