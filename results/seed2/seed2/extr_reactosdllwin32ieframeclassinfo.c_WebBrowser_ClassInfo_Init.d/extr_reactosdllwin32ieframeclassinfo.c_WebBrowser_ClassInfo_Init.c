...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_This0; _i0++) {
              int _len_This__i0__IProvideClassInfo2_iface_lpVtbl0 = 1;
          This[_i0].IProvideClassInfo2_iface.lpVtbl = (int *) malloc(_len_This__i0__IProvideClassInfo2_iface_lpVtbl0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_This__i0__IProvideClassInfo2_iface_lpVtbl0; _j0++) {
            This[_i0].IProvideClassInfo2_iface.lpVtbl[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          WebBrowser_ClassInfo_Init(This);
          free(This);
