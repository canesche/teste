...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_p_temp0 = 1;
          int * p_temp = (int *) malloc(_len_p_temp0*sizeof(int));
          for(int _i0 = 0; _i0 < _len_p_temp0; _i0++) {
            p_temp[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = mlxsw_thermal_get_trip_temp(tzdev,trip,p_temp);
          printf("%d\n", benchRet); 
