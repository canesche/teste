...
int main(int argc, char *argv[]) {
    ...
    {
          int _len_root0 = 1;
          struct ctl_table_root * root = (struct ctl_table_root *) malloc(_len_root0*sizeof(struct ctl_table_root));
          for(int _i0 = 0; _i0 < _len_root0; _i0++) {
            root[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          struct ctl_table_set * benchRet = net_ctl_header_lookup(root);
          printf("%d\n", (*benchRet).dummy);
          free(root);
