...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_sq_thresh0; _i0++) {
              int _len_sq_thresh__i0__lower_threshold0 = 1;
          sq_thresh[_i0].lower_threshold = (long *) malloc(_len_sq_thresh__i0__lower_threshold0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_sq_thresh__i0__lower_threshold0; _j0++) {
            sq_thresh[_i0].lower_threshold[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          long benchRet = ath6kl_wmi_get_lower_threshold(rssi,sq_thresh,size);
          printf("%ld\n", benchRet); 
          for(int _aux = 0; _aux < _len_sq_thresh0; _aux++) {
          free(sq_thresh[_aux].lower_threshold);
          }
          free(sq_thresh);
