...
__attribute__((used)) static void clear_empty_dir(struct ctl_dir *dir)
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _j0 = 0; _j0 < _len_dir__i0__header_ctl_table0; _j0++) {
              int _len_dir__i0__header_ctl_table_child0 = 1;
          dir[_i0].header.ctl_table->child = (int *) malloc(_len_dir__i0__header_ctl_table_child0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_dir__i0__header_ctl_table_child0; _j0++) {
            dir[_i0].header.ctl_table->child[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          clear_empty_dir(dir);
