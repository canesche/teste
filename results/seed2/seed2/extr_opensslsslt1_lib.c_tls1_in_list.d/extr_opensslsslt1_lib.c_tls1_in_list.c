...
int main(int argc, char *argv[]) {
    ...
    {
          const long id = 100;
          unsigned long listlen = 100;
          int _len_list0 = 1;
          const long * list = (const long *) malloc(_len_list0*sizeof(const long));
          for(int _i0 = 0; _i0 < _len_list0; _i0++) {
            list[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = tls1_in_list(id,list,listlen);
          printf("%d\n", benchRet); 
          free(list);
