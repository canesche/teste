...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_stream0; _i0++) {
              int _len_stream__i0__demuxer0 = 1;
          stream[_i0].demuxer = (char *) malloc(_len_stream__i0__demuxer0*sizeof(char));
          for(int _j0 = 0; _j0 < _len_stream__i0__demuxer0; _j0++) {
            stream[_i0].demuxer[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        stream[_i0].close = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = tv_stream_open(stream);
          printf("%d\n", benchRet); 
          for(int _aux = 0; _aux < _len_stream0; _aux++) {
          free(stream[_aux].demuxer);
          }
          free(stream);
