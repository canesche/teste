...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
        ...
        frag_index[_i0].item->nb_stream_info = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          frag_index[_i0].item->stream_info = (int *) malloc(_len_frag_index__i0__item_stream_info0*sizeof(int));
          for(int _j0 = 0; _j0 < _len_frag_index__i0__item_stream_info0; _j0++) {
            frag_index[_i0].item->stream_info[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int * benchRet = get_current_frag_stream_info(frag_index);
          printf("%d\n", (*benchRet)); 
