...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          fe[_i0].demodulator_priv = (struct dib3000mc_state *) malloc(_len_fe__i0__demodulator_priv0*sizeof(struct dib3000mc_state));
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv0; _j0++) {
              int _len_fe__i0__demodulator_priv_cfg0 = 1;
          fe[_i0].demodulator_priv->cfg = (struct dib3000mc_config *) malloc(_len_fe__i0__demodulator_priv_cfg0*sizeof(struct dib3000mc_config));
          for(int _j0 = 0; _j0 < _len_fe__i0__demodulator_priv_cfg0; _j0++) {
            fe[_i0].demodulator_priv->cfg->dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          }
          }
          int _len_cfg0 = 1;
          struct dib3000mc_config * cfg = (struct dib3000mc_config *) malloc(_len_cfg0*sizeof(struct dib3000mc_config));
          for(int _i0 = 0; _i0 < _len_cfg0; _i0++) {
            cfg[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          dib3000mc_set_config(fe,cfg);
