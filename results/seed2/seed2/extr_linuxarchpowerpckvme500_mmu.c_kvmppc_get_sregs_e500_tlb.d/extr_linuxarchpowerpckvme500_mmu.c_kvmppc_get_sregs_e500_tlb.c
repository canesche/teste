...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          vcpu[_i0].arch.tlbcfg = (long *) malloc(_len_vcpu__i0__arch_tlbcfg0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_vcpu__i0__arch_tlbcfg0; _j0++) {
            vcpu[_i0].arch.tlbcfg[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        vcpu[_i0].arch.mmucfg = ((-2 * (next_i()%2)) + 1) * next_i();
        ...
        vcpu[_i0].arch.shared->mas0 = ((-2 * (next_i()%2)) + 1) * next_i();
          ...
          for(int _i0 = 0; _i0 < _len_sregs0; _i0++) {
              int _len_sregs__i0__u_e_tlbcfg0 = 1;
          sregs[_i0].u.e.tlbcfg = (long *) malloc(_len_sregs__i0__u_e_tlbcfg0*sizeof(long));
          for(int _j0 = 0; _j0 < _len_sregs__i0__u_e_tlbcfg0; _j0++) {
            sregs[_i0].u.e.tlbcfg[_j0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
        sregs[_i0].u.e.mmucfg = ((-2 * (next_i()%2)) + 1) * next_i();
