...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_inbuf0 = 1;
          const float * inbuf = (const float *) malloc(_len_inbuf0*sizeof(const float));
          for(int _i0 = 0; _i0 < _len_inbuf0; _i0++) {
            inbuf[_i0] = ((-2.0 * (next_i()%2)) + 1.0) * (-16777216.000000 + (float) next_f() / (((float) 16777215.000000/(16777215.000000 - -16777216.000000))));
          }
          bandwidth_expansion(coeff,inbuf,gamma);
          free(coeff);
          free(inbuf);
