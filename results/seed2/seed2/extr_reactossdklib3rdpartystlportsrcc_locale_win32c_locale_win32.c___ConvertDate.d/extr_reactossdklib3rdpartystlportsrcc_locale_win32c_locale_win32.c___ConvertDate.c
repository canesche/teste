...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          int buf_size = 100;
          int _len_NTDate0 = 1;
          const char * NTDate = (const char *) malloc(_len_NTDate0*sizeof(const char));
          for(int _i0 = 0; _i0 < _len_NTDate0; _i0++) {
            NTDate[_i0] = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int _len_buffer0 = 1;
          ...
          int benchRet = __ConvertDate(NTDate,buffer,buf_size);
          printf("%d\n", benchRet); 
          free(NTDate);
          free(buffer);
