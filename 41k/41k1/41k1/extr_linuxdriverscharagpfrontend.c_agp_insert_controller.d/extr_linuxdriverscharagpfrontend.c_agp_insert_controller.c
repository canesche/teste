...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          struct agp_controller * aux_controller[10000];
          struct agp_controller * controller = _allocate_controller(10000, aux_controller);
          int benchRet = agp_insert_controller(controller);
          printf("%d\n", benchRet); 
          _delete_controller(aux_controller, 10000);
