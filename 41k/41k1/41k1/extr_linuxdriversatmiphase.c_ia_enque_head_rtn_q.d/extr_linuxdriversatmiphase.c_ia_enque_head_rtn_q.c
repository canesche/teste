...
int main(int argc, char *argv[]) {
    ...
    case 3:
    {
          struct TYPE_4__ * aux_que[10000];
          struct TYPE_4__ * que = _allocate_que(10000, aux_que);
          struct TYPE_4__ * aux_data[10000];
          struct TYPE_4__ * data = _allocate_data(10000, aux_data);
          ia_enque_head_rtn_q(que,data);
          _delete_que(aux_que, 10000);
