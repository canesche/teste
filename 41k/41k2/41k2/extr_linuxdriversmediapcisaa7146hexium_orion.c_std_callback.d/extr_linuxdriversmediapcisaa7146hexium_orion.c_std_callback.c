...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int _len_std0 = 1;
          struct saa7146_standard * std = (struct saa7146_standard *) malloc(_len_std0*sizeof(struct saa7146_standard));
          for(int _i0 = 0; _i0 < _len_std0; _i0++) {
            std[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = std_callback(dev,std);
          printf("%d\n", benchRet); 
          free(dev);
          free(std);
