...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          void * priv;
          int _len_tcam0 = 1;
          struct mlxsw_sp_acl_tcam * tcam = (struct mlxsw_sp_acl_tcam *) malloc(_len_tcam0*sizeof(struct mlxsw_sp_acl_tcam));
          for(int _i0 = 0; _i0 < _len_tcam0; _i0++) {
            tcam[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          int benchRet = mlxsw_sp1_acl_tcam_init(mlxsw_sp,priv,tcam);
          printf("%d\n", benchRet); 
          free(mlxsw_sp);
          free(tcam);
