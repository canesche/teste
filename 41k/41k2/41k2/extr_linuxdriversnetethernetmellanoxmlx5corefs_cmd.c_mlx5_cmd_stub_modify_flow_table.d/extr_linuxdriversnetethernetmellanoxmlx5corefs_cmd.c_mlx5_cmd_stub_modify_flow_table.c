...
__attribute__((used)) static int mlx5_cmd_stub_modify_flow_table(struct mlx5_core_dev *dev,
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          int benchRet = mlx5_cmd_stub_modify_flow_table(dev,ft,next_ft);
          printf("%d\n", benchRet); 
          free(dev);
          free(ft);
          free(next_ft);
