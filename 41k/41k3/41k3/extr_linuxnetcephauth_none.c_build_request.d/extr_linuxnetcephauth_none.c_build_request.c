...
__attribute__((used)) static int build_request(struct ceph_auth_client *ac, void *buf, void *end)
{
	return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    case 0:
    {
          ...
          for(int _i0 = 0; _i0 < _len_ac0; _i0++) {
            ac[_i0].dummy = ((-2 * (next_i()%2)) + 1) * next_i();
          }
          void * buf;
          void * end;
          int benchRet = build_request(ac,buf,end);
          printf("%d\n", benchRet); 
          free(ac);
